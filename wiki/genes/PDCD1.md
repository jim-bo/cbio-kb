...
- PDCD1 (PD-1) expression on tumor-infiltrating lymphocytes is elevated in PBRM1-mutant ccRCC tumors with high immune cell infiltration, supporting use as an immunotherapy biomarker [PMID:40834854](../papers/40834854.md)
...
- PD-1 expression is a defining marker of the immune-active [HCC](../cancer_types/HCC.md) class; expression not predictive of response to [nivolumab](../drugs/nivolumab.md) or [pembrolizumab](../drugs/pembrolizumab.md) in [HCC](../cancer_types/HCC.md) trials; anti-PD-1 has FDA accelerated approval in [HCC](../cancer_types/HCC.md) [PMID:30061739](../papers/30061739.md)
- PD-1 upregulated on T cells in non-keratinizing [NPC](../cancer_types/NPC.md) due to chronic EBV antigen exposure; multiple anti-PD-1 mAbs approved or investigational in [NPC](../cancer_types/NPC.md) ([toripalimab](../drugs/toripalimab.md), [tislelizumab](../drugs/tislelizumab.md), [penpulimab](../drugs/penpulimab.md), [pembrolizumab](../drugs/pembrolizumab.md), [nivolumab](../drugs/nivolumab.md), [sintilimab](../drugs/sintilimab.md), [serplulimab](../drugs/serplulimab.md), [tagitanlimab](../drugs/tagitanlimab.md)) [PMID:41002550](../papers/41002550.md)
- PD-1 immune checkpoint whose blockade efficacy in biliary tract cancer is modulated by gut microbiota composition; Bacteroidetes enrichment improves anti-PD-1 outcomes while Proteobacteria dominance reduces [sintilimab](../drugs/sintilimab.md)+[anlotinib](../drugs/anlotinib.md) efficacy [PMID:41018102](../papers/41018102.md)
...
- PDCD1 (PD-1) expression measured alongside [CD274](../genes/CD274.md) (PD-L1) in 684 never-smoker lung adenocarcinomas; combined [CD274](../genes/CD274.md)+PDCD1 R²=0.093 for ICB response (TIDE score), much lower than subtype-augmented R²=0.25, demonstrating that transcriptomic subtype adds predictive value beyond immune checkpoint markers [PMID:40970133](../papers/40970133.md)
...
- Head and neck squamous cell carcinoma ([HNSC](../cancer_types/HNSC.md)) — target of [nivolumab](../drugs/nivolumab.md); PD-1+Ki-67+[CD4](../genes/CD4.md)+ T-cell surge at week 2–4 paradoxically trended with worse PFS in 51-patient reirradiation trial, unlike in lung cancer and melanoma. [PMID:38780927](../papers/38780927.md)

## Co-occurrence and mutual exclusivity

- Expressed jointly with [CD274](../genes/CD274.md), [CTLA4](../genes/CTLA4.md), [FOXP3](../genes/FOXP3.md), [IDO1](../genes/IDO1.md) and Th1/cytotoxic genes in the ICR-high hot subtype [PMID:37202560](../papers/37202560.md).
- Co-expression with [MKI67](../genes/MKI67.md) on [CD4](../genes/CD4.md)+ T cells defines pharmacodynamic readout; co-assessed with [FOXP3](../genes/FOXP3.md)+ and [CD8A](../genes/CD8A.md)+ T-cell subsets in flow cytometry panel in HNSCC reirradiation trial. [PMID:38780927](../papers/38780927.md)

## Therapeutic relevance

- ICR correlates with immunotherapy response in other tumor types per the authors, but predictive utility of PDCD1 expression for immune checkpoint blockade in colon cancer was not directly tested [PMID:37202560](../papers/37202560.md).
- In the ROBIN METEOR cervix cancer Project 1, CRT does not significantly upregulate the PD-1 (PDCD1)/PDL-1 axis in tumor cells; in the GenRad HNSCC MCT (NCT03521570), re-irradiation plus PD-1 inhibition ([nivolumab](../drugs/nivolumab.md)) was effective in recurrent/second primary HNSCC, and shorter progression-free survival was associated with a 1.5-fold increase in PD1+Ki67+[CD4](../genes/CD4.md)+ T cells from baseline to week 2 or 4 of treatment [PMID:41941260](../papers/41941260.md).
- Nivolumab (anti-PD-1, anti-PDCD1) combined with IMRT reirradiation in recurrent/second primary HNSCC (NCT03521570, n=51): 1-year PFS 61.7% (95% CI 49.2%–77.4%), rejecting null of <43.8% (P = .002). Grade ≥3 treatment-related AEs in 11.8%; no grade 5 events. [PMID:38780927](../papers/38780927.md)

## Open questions

- Whether ICR-high [COAD](../cancer_types/COAD.md) patients benefit preferentially from PD-1 blockade is untested in this cohort [PMID:37202560](../papers/37202560.md).

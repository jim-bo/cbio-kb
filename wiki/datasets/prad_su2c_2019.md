...
- Referenced for [USP10](../genes/USP10.md) deep deletion frequency (~10%) in metastatic castration-resistant prostate cancer, used to contextualize the therapeutic vulnerability of the [USP10](../genes/USP10.md)–[TRMT10A](../genes/TRMT10A.md) axis [PMID:41071892](../papers/41071892.md)
- Used (SU2C/PCF Dream Team 2019, n=266 polyA RNA-seq samples) for cross-cohort correlation of the [NOL10](../genes/NOL10.md) cell-cycle signature (CCS) with the clinical cell-cycle-progression (CCP) score, and for combined [NOL10](../genes/NOL10.md)+[USF1](../genes/USF1.md) ROC survival analyses [PMID:41062477](../papers/41062477.md).

...
BRCA2 is a critical homologous recombination DNA repair factor. Germline and somatic BRCA2 mutations are among the most well-characterized cancer predisposition alterations, particularly for ovarian, breast, pancreatic, and prostate cancers. In the corpus, BRCA2 alterations appear across [HGSOC](../cancer_types/HGSOC.md) precursors, endometrial carcinoma, anaplastic thyroid carcinoma, [HCC](../cancer_types/HCC.md), cervical cancer, and prostate cancer.

## Alterations observed in the corpus

- Germline BRCA2 mutations in 12 of 44 [HGSOC](../cancer_types/HGSOC.md) patients in a multimodal spatial profiling study of fallopian tube precursor lesions; BRCA2 deletion in one paired sample was detected by cfDNA exclusive of tissue sequencing [PMID:39386723](../papers/39386723.md).
- BRCA2 deleted in 33.6% of anaplastic thyroid carcinoma (ATC), 13.6% of co-differentiated thyroid cancer (co-DTC), and 4.5% of papillary thyroid cancer (PTC); deletion associated with better survival in ATC (multi-omic landscape study, n=87 specimens) [PMID:38412093](../papers/38412093.md).
- BRCA2 alterations detected in 4% of advanced [HCC](../cancer_types/HCC.md) patients by cfDNA profiling (MSK-ACCESS, 51 patients); combined BRCA1/2 in 8%; one sample showed cfDNA-exclusive BRCA2 alteration [PMID:37769223](../papers/37769223.md).
...
- Germline pathogenic BRCA2 alterations in 3.7% of [PAAD](../cancer_types/PAAD.md); strong selection for biallelic LOH in carriers; BRCA2 alterations associated with longer first-line OS (HR_adj = 0.66, P = 0.038); all 10 long-PARPi-responder BRCA2 tumors had biallelic inactivation in a 2,336-tumor PDAC genomic cohort [PMID:39753968](../papers/39753968.md).
...
- Rare germline/somatic pathogenic mutation (n=2 combined with [BRCA1](../genes/BRCA1.md), level 2B actionable) identified in cholangiocarcinoma ([chol_msk_2018](../datasets/chol_msk_2018.md)) [PMID:29848569](../papers/29848569.md)
...
- Splicing-region germline variants found in 4 of 90 recurrent/metastatic adenoid cystic carcinoma cases alongside [BRCA1](../genes/BRCA1.md); all monoallelic with no LOH — clinical relevance unclear pending validation [PMID:31483290](../papers/31483290.md)
...
- [OVT](../cancer_types/OVT.md) — Germline BRCA2 mutations in [HGSOC](../cancer_types/HGSOC.md); HRD via BRCA1/2 is the primary PARP inhibitor vulnerability [PMID:39386723](../papers/39386723.md).
- [THPA](../cancer_types/THPA.md) — BRCA2 deletion in 33.6% of ATC; paradoxically associated with better ATC survival [PMID:38412093](../papers/38412093.md).
- [HCC](../cancer_types/HCC.md) — BRCA2 detected by cfDNA in 4% of advanced [HCC](../cancer_types/HCC.md); actionable (OncoKB level) [PMID:37769223](../papers/37769223.md).
...
- Neuroblastoma ([NBL](../cancer_types/NBL.md)) — BRCA2 over-expression marks the high-risk undifferentiated nC3 cluster at single-nuclei resolution; significance confirmed at FDR < 0.01 [PMID:34493726](../papers/34493726.md).
...
- BRCA2 alterations are actionable across cancer types; PARP inhibitors and platinum are established strategies for HRD-associated malignancies [PMID:37769223](../papers/37769223.md).
- In ATC, BRCA2 deletions alongside [ATM](../genes/ATM.md) and [BRCA1](../genes/BRCA1.md) alterations rationalize PARP inhibitor trials; the counterintuitive association of BRCA2 deletion with better ATC survival may reflect HRD-mediated mutational burden or immune stimulation [PMID:38412093](../papers/38412093.md).
- In MSI-H/dMMR prostate cancer, elevated BRCA1/2 mutation rates likely represent passenger events; lower PARP inhibitor responses than expected have been reported in this population [PMID:38949888](../papers/38949888.md).

## Open questions

- The mechanistic basis for BRCA2 deletion being associated with better survival in ATC (vs. the typical adverse implications of HRD) is unexplained and requires functional investigation [PMID:38412093](../papers/38412093.md).
- Whether BRCA2 deletions in ATC confer platinum or PARP inhibitor sensitivity is not directly tested in the corpus [PMID:38412093](../papers/38412093.md).

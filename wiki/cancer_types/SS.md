...
- Whole-exome sequencing of 25 Sézary syndrome cases yielded a median of 39 non-synonymous somatic mutations/sample (range 1–182) and a median of 21 copy-number alterations/sample (range 0–56) [PMID:26551667](../papers/26551667.md).
- Recurrent chromosomal deletions: [TP53](../genes/TP53.md) 17p13.1 (13/25; 52%), [PTEN](../genes/PTEN.md) 10q23.3 (5/25; 20%), [DNMT3A](../genes/DNMT3A.md) 2p23.3 (5/25; 20%, including 2 homozygous), [CDKN1B](../genes/CDKN1B.md) 12p13.1 (5/25; 20%), [RB1](../genes/RB1.md) 13q14.2 (4/25; 16%); recurrent gains at 8q (13/25; 52%) and chromosome 7 (5/25; 20%) [PMID:26551667](../papers/26551667.md).
...
- SS (n=10) was genomically distinct with the fewest SCNAs and mutations of any histology; all 10 cases carried SS18-SSX1 or SS18-SSX2 t(X;18) fusions; iCluster placed all SS in C4 (high [FGFR3](../genes/FGFR3.md), miR-183, PDE4A promoter methylation, partial/complete 3p loss in 5/10 cases) [PMID:29100075](../papers/29100075.md)
- Synovial sarcoma (SS) was enrolled in MAPPYACTS (sarcomas 37% of 787 patients); WES + RNA-seq profiling identified actionable alterations in 69% of patients across all tumor types in the trial [PMID:35292802](../papers/35292802.md)

## Subtypes

- Sézary syndrome and mycosis fungoides constitute the two dominant CTCL subtypes in the da Silva Almeida et al. cohort; Sézary syndrome has markedly higher CNA burden (median 21 vs 1) and is dominated by tumor suppressor deletions, whereas mycosis fungoides shows more MAPK1/STAT3 point mutations [PMID:26551667](../papers/26551667.md).

## Therapeutic landscape

- Broad CTCL cell-line sensitivity to [bortezomib](../drugs/bortezomib.md) and Mi-2 (NFκB inhibitor) across HH, HUT78, HUT102, SeAX lines regardless of genotype, reflecting convergent NFκB activation from multiple mutational routes ([CARD11](../genes/CARD11.md), [TNFRSF1B](../genes/TNFRSF1B.md), [PRKG1](../genes/PRKG1.md) LoF) [PMID:26551667](../papers/26551667.md).
- [tofacitinib](../drugs/tofacitinib.md) and [ruxolitinib](../drugs/ruxolitinib.md) (JAK inhibitors) selectively active in [JAK3](../genes/JAK3.md) p.Ala573Val-mutant HUT78; authors propose stratifying CTCL patients by JAK3/STAT3/SH2B3 genotype for JAK-inhibitor trials [PMID:26551667](../papers/26551667.md).
- MEK1/2 inhibition (U0126) and NFAT inhibition (FK506) showed only modest antitumor effects despite recurrent MAPK1/BRAF/PRKG1 mutations, suggesting combination strategies may be needed [PMID:26551667](../papers/26551667.md).

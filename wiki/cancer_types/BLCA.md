...
- Single case of [EWSR1](../genes/EWSR1.md)::[BEND2](../genes/BEND2.md) fusion sarcoma (small round cell) of the urinary bladder; initial misdiagnosis as Ewing sarcoma ([CD99](../genes/CD99.md)+, [EWSR1](../genes/EWSR1.md) FISH+) corrected by RNA-seq revealing [EWSR1](../genes/EWSR1.md) exon 10::[BEND2](../genes/BEND2.md) exon 2 in-frame fusion; [PTEN](../genes/PTEN.md) loss co-occurring on 10q deletion [PMID:41102727](../papers/41102727.md)
...
- MSK-IMPACT targeted sequencing of 105 nonmuscle invasive bladder cancer (NMIBC) tumors ([blca_nmibc_2017](../datasets/blca_nmibc_2017.md)) found [TERT](../genes/TERT.md) promoter mutations in 73% across all grade/stage groups; chromatin-modifying gene alterations in 69% ([KDM6A](../genes/KDM6A.md) 38%, [ARID1A](../genes/ARID1A.md) 21%); [ERBB2](../genes/ERBB2.md) and [FGFR3](../genes/FGFR3.md) alterations in 57% of high-grade NMIBC in a mutually exclusive pattern; DDR gene alterations in 30% of high-grade NMIBC; [ARID1A](../genes/ARID1A.md) mutations associated with 3.14-fold higher BCG-recurrence risk (HR=3.14, 95% CI 1.51-6.51, P=0.002). [PMID:28583311](../papers/28583311.md)
...
- Pan-cancer fusion study (9,624 TCGA samples) identified [FGFR3](../genes/FGFR3.md)–[TACC3](../genes/TACC3.md) in 2.0% of BLCA samples as a top recurrent intra-cancer fusion; [FGFR3](../genes/FGFR3.md) was annotated as a druggable target in BLCA across 15 cancer types [PMID:29617662](../papers/29617662.md)
...
- RNA-seq clustering of 100 upper-tract urothelial carcinomas identified five expression subtypes with distinct clinical outcomes; the standard MIBC consensus classifier labeled 89% of upper-tract tumors luminal-papillary but did not predict recurrence, and the immune-inflamed high-risk clusters showed the best immune checkpoint blockade responses [PMID:39550333](../papers/39550333.md).

...
unverified: true
tags: [hcc, statin, cholesterol, lipophilic, combination-therapy, ici]
...
Lovastatin is a lipophilic statin that inhibits [HMGCR](../genes/HMGCR.md) (HMG-CoA reductase), the rate-limiting enzyme of cholesterol biosynthesis. Being lipophilic, it penetrates tumor cells more readily than hydrophilic statins (pravastatin, rosuvastatin). Epidemiologic data associate lipophilic statins with a more pronounced reduction in HCC-related cancer mortality compared with hydrophilic statins. It is not FDA-approved as an anti-cancer agent.
...
- Not applicable (lovastatin is evaluated as a sensitizing agent in combination regimens).

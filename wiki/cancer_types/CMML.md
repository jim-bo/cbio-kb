...
Chronic Myelomonocytic Leukemia (CMML) is a clonal hematopoietic neoplasm with features of both myelodysplastic and myeloproliferative disorders. It sits under the MDS/MPN parent in OncoTree. [CALR](../genes/CALR.md) mutations have been rarely detected in CMML, in contrast to their strong association with BCR-ABL1-negative MPNs.
...
- CMML arose in PM [NSGCT](../cancer_types/NSGCT.md) patients as a clonally related hematologic malignancy sharing TP53/RAS-pathway mutations and i(12p) with the paired germ cell tumor; one patient progressed GCT → histiocytic sarcoma → CMML → [AML](../cancer_types/AML.md) within 18 months, all derived from a common TP53/PIK3CD precursor. [PMID:32897884](../papers/32897884.md)
...
- No CMML-specific drug data in the current corpus.

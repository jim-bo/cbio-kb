...
parent: SOC
tags: [ovarian, low-grade-serous, mapk, gynecologic]
...
- MSK-IMPACT targeted sequencing of 119 centrally pathology-reviewed LGSOC patients treated at MSK between 2015 and 2021 ([lgsoc_mapk_msk_2022](../datasets/lgsoc_mapk_msk_2022.md)); 92% FIGO III/IV, median age 48 years, 66% with germline testing. [PMID:35443055](../papers/35443055.md)
...
- MAPK pathway alteration is independently associated with improved overall survival (multivariate HR 2.5 for absence vs presence, p=0.019); platinum sensitivity also independently favorable (HR 0.4, p=0.005). [PMID:35443055](../papers/35443055.md)
- [binimetinib](../drugs/binimetinib.md) MEK inhibitor context: MSK experience of 4 patients on MEKi for recurrence (3 MAPK-altered); no progressions on drug but all discontinued for toxicity (median 6.7 months). [PMID:35443055](../papers/35443055.md)
- Sequential re-sequencing at recurrence may unmask actionable MAPK drivers absent at first sampling (2/5 cases without initial drivers acquired drivers at relapse). [PMID:35443055](../papers/35443055.md)

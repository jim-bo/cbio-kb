...
- Low-grade glioma (LGGNOS) was enrolled in MAPPYACTS; KIAA1549-BRAF fusions (n=10) were ready-for-routine-use and targetable by [dabrafenib](../drugs/dabrafenib.md); ROS1-GOPC fusions (n=2) were also actionable in low-grade glioma [PMID:35292802](../papers/35292802.md)

## Subtypes

- **LGG BRAFV600E** — MAPK + AKT pathway activated at protein level; MEK + mTOR combination strategy supported. [PMID:33242424](../papers/33242424.md)
- **LGG BRAFFusion** — PDGFRA-pathway phosphorylation; [PDGFRA](../genes/PDGFRA.md) inhibitor evaluation proposed. [PMID:33242424](../papers/33242424.md)
- **LGG BRAFWT-rich (C8)** — a proteomic cluster with distinct survival outcomes from BRAFV600E and BRAFFusion groups. [PMID:33242424](../papers/33242424.md)
- **Ganglio-rich LGG subgroup** — shares CDK5/GSK3B kinase-activity upregulation with [GNG](../cancer_types/GNG.md); Hot microenvironment cluster contains mixed LGG/HGG/ganglioglioma. [PMID:33242424](../papers/33242424.md)
- **[DLGGMAPK](../cancer_types/DLGGMAPK.md)** — see dedicated page [DLGGMAPK](../cancer_types/DLGGMAPK.md) for MAPK-pathway-altered diffuse LGG. [PMID:33242424](../papers/33242424.md)

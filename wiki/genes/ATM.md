...
- Somatic ATM mutations in 30% of aSCLC (n=20, MSKCC), significantly enriched vs. carcinoids (8%) and [SCLC](../cancer_types/SCLC.md) (3%); no pathogenic germline ATM variants detected; somatic ATM mutations are a candidate predisposing factor for chromothripsis (causality not demonstrated) [PMID:39185963](../papers/39185963.md).
- Germline pathogenic ATM alterations identified among 14% of consented CAC patients with germline alterations (colitis-associated colorectal cancer, n=73 sequenced); cancer susceptibility for germline ATM in this setting remains uncertain [PMID:36611031](../papers/36611031.md).

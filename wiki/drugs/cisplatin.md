...
- Platinum agent used as part of first-line [trastuzumab](../drugs/trastuzumab.md) + [pembrolizumab](../drugs/pembrolizumab.md) + fluoropyrimidine/platinum chemotherapy in NCT02954536; 37 HER2-positive metastatic esophagogastric cancer patients achieved 91% ORR and 27.2-month median [OS](../cancer_types/OS.md) [PMID:32437664](../papers/32437664.md).
- Standard component of the VIP chemotherapy regimen used in 15 patients with primary mediastinal [NSGCT](../cancer_types/NSGCT.md) ([NSGCT](../cancer_types/NSGCT.md)) and concomitant hematologic malignancy (median [OS](../cancer_types/OS.md) 6.3 months); shared [TP53](../genes/TP53.md) loss-of-heterozygosity in the ancestral GCT/hematologic-malignancy clone was proposed to explain the documented refractoriness to cisplatin-based therapy [PMID:32897884](../papers/32897884.md).

...
Single-institution MSK cohort of 1,421 urothelial carcinoma patients (1,507 tumors) profiled with [MSK-IMPACT](../methods/msk-impact-panel.md) tumor sequencing and, for a treated subcohort, serial [MSK-ACCESS](../methods/ACCESS129.md) cfDNA, assembled to characterize [FGFR2](../genes/FGFR2.md)/3 alterations and real-world [erdafitinib](../drugs/erdafitinib.md) outcomes ([PMID:37682528](../papers/37682528.md)).

## Composition

- Cancer types: [BLCA](../cancer_types/BLCA.md) and [UTUC](../cancer_types/UTUC.md) ([PMID:37682528](../papers/37682528.md)).
...
- Erdafitinib-treated subcohort: 32 metastatic patients treated 8/2019–7/2022, with serial cfDNA on 27 ([PMID:37682528](../papers/37682528.md)).

## Assays / panels (linked)

- [MSK-IMPACT](../methods/msk-impact-panel.md) — FDA-authorized targeted tumor panel ([PMID:37682528](../papers/37682528.md)).
- [MSK-ACCESS](../methods/ACCESS129.md) — 129-gene cfDNA assay, >15,000x, 0.1% VAF threshold ([PMID:37682528](../papers/37682528.md)).

## Papers using this cohort

- [PMID:37682528](../papers/37682528.md) — Guercio et al., Clin Cancer Res 2023.

## Notable findings derived from this cohort

- Oncogenic [FGFR3](../genes/FGFR3.md) alterations in 39% NMIBC, 14% MIBC, 43% localized [UTUC](../cancer_types/UTUC.md), 26% metastatic specimens ([PMID:37682528](../papers/37682528.md)).

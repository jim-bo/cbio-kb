...
- PIK3CA mutations co-occur with [ARID1A](../genes/ARID1A.md) loss in ovarian cancer, and PIK3CA-mutant cells show sensitivity to PI3K pathway inhibition in the context of BET bromodomain inhibition [PMID:41049615](../papers/41049615.md)
- PIK3CA mutation status was assessed in breast cancer samples undergoing whole-exome sequencing that identified [SF3B1](../genes/SF3B1.md) mutations and widespread splicing dysregulation [PMID:41055979](../papers/41055979.md)
...
- Missense mutations in helical domain (E542/E545, 40%) and kinase domain (H1047, 47%) in 27% of breast cancer samples (Broad WES, 103 tumors); activates PI3K pathway; mutually exclusive with [AKT1](../genes/AKT1.md) E17K [PMID:22722202](../papers/22722202.md)
...
- Mutations in 18% of non-hypermutated colorectal tumors; mutually exclusive with [PIK3R1](../genes/PIK3R1.md) and [PTEN](../genes/PTEN.md) loss in 276-tumor TCGA CRC cohort [PMID:22810696](../papers/22810696.md)
...
- PIK3CA — no mutations observed in [SCLC](../cancer_types/SCLC.md) (CLCGP, 29 tumors); notable negative finding [PMID:22941188](../papers/22941188.md)
- PIK3CA rare activating hotspot mutations identified in [SCLC](../cancer_types/SCLC.md) (JHU WES/WGS, 36 tumors) [PMID:22941189](../papers/22941189.md)
...
- E545K hotspot mutation almost exclusively Luminal A (25/27 cases); amplification in 49% of Basal-like tumors; mutations in 45% Luminal A, 39% HER2E, 29% Luminal B, 9% Basal-like across 510 TCGA breast tumors ([brca_tcga_pub](../datasets/brca_tcga_pub.md)); statistically significant mutual exclusivity with [PIK3R1](../genes/PIK3R1.md), [PTEN](../genes/PTEN.md), and [AKT1](../genes/AKT1.md) mutations (P=0.025) [PMID:23000897](../papers/23000897.md)
- Mutually exclusive with [PIK3R1](../genes/PIK3R1.md), [PTEN](../genes/PTEN.md), and [AKT1](../genes/AKT1.md) alterations in PDAC (ICGC, 142 tumors); PI3K pathway implicated via GISTIC2.0 copy-number analysis [PMID:23103869](../papers/23103869.md)
- PI3K pathway activation (elevated pERK, pmTOR, pS6) observed in both near haploid and low hypodiploid ALL; PI3K inhibitor GDC-0941 and dual PI3K/mTOR inhibitor BEZ235 substantially inhibited proliferation of all hypodiploid ALL tumors ex vivo ([all_stjude_2013](../datasets/all_stjude_2013.md), 124 pediatric cases) [PMID:23334668](../papers/23334668.md)
- Most frequently mutated actionable gene in [EAC](../cancer_types/EAC.md) (7/145 tumors); hotspot p.E545 cannot be generated by the adenine-to-adenine transversion mutational signature dominant in [EAC](../cancer_types/EAC.md) [PMID:23525077](../papers/23525077.md)
- Activating mutation and/or 3q copy gain; part of mitogenic pathway altered in 63% of oral squamous cell carcinoma (OSCC) tumors; mutually exclusive with [PIK3R1](../genes/PIK3R1.md) [PMID:23619168](../papers/23619168.md)
- Mutated in 71% of POLE-ultramutated and 42% of uterine serous endometrial tumors; mutually exclusive with [PIK3R1](../genes/PIK3R1.md) across all endometrial subgroups [PMID:23636398](../papers/23636398.md)
- Three missense mutations at COSMIC hotspots in 5% of [ACC](../cancer_types/ACC.md) cases; functional PI3K/AKT pathway activation confirmed (p-AKT/p-PRAS40 elevated); authors nominate FGF/IGF/PI3K axis as a candidate therapeutic vulnerability in [ACC](../cancer_types/ACC.md) [PMID:23685749](../papers/23685749.md)
- Canonical activating hotspot p.H1047L detected in [ACC](../cancer_types/ACC.md) exome sequencing (24-case cohort) [PMID:23778141](../papers/23778141.md)
...
- PI3K pathway alteration in intrahepatic cholangiocarcinoma ([IHCH](../cancer_types/IHCH.md)); part of the 22% PI3K pathway alteration rate in the discovery-screen cohort [PMID:24185509](../papers/24185509.md)
...
- PIK3CA is mutated in [ESCC](../cancer_types/ESCC.md) as part of the canonical genomic landscape cited in a review of oral microbiome associations with [ESCC](../cancer_types/ESCC.md) [PMID:41096729](../papers/41096729.md)
...
- PIK3CA is a PI3K/AKT pathway driver in [HCC](../cancer_types/HCC.md) identified by integrated genomic analysis [PMID:25369299](../papers/25369299.md)
- PI3K/AKT pathway activation implicated in [HCC](../cancer_types/HCC.md); PIK3CA mutations contribute to the oncogenic signaling landscape, and the pathway is reactivated downstream of [MET](../genes/MET.md) in the context of EGFR/MET resistance mechanisms [PMID:30061739](../papers/30061739.md)
...
- PIK3CA mutations in ~6% of intrahepatic cholangiocarcinoma (iCCA) and 3–7% of extrahepatic CCA (eCCA); approximately 6.8% in advanced cfDNA cohorts. [PMID:41008893](../papers/41008893.md)
...
- HDR-based introduction of H1047R into rat Pik3ca yielded predominantly benign fibroadenomas (8/10); combined Pik3caH1047R + Tp53Indel produced moderately differentiated invasive ductal carcinoma at 42-day median latency in a CRISPR rat mammary tumor platform [PMID:41000773](../papers/41000773.md)
...
- Significantly more frequently mutated in lung SqCC than lung ADC (p < 0.01, Fisher's exact); one of only six genes significantly mutated in both [NSCLC](../cancer_types/NSCLC.md) histologies (alongside [TP53](../genes/TP53.md), [RB1](../genes/RB1.md), [ARID1A](../genes/ARID1A.md), [CDKN2A](../genes/CDKN2A.md), [NF1](../genes/NF1.md)). PIK3CA p.E542K is a recurrent predicted neoepitope candidate for off-the-shelf vaccine design. [PMID:27158780](../papers/27158780.md)
- Most frequently mutated gene in the METABRIC 2,433-tumor breast cancer cohort (40.1% coding-mutation frequency); ER+ ONC=94%, ER- ONC=81%. Helical-domain (codons 542/545) and codon 345 hotspots enriched in ER+; kinase-domain codon 1047 enriched in ER-. Mutually exclusive with [AKT1](../genes/AKT1.md), [PIK3R1](../genes/PIK3R1.md), and [FOXO3](../genes/FOXO3.md). Prognostic in ER- disease (HR=1.4); prognostic in ER+ only within IntClusts 1, 2, and 9 (defined by 17q23, 11q13-14, and 8q24 amplifications). 45.2% of all tumors had a mutation in at least one Akt-pathway member. [PMID:27161491](../papers/27161491.md)
...
- PIK3CA mutated in 10% of recurrent/metastatic HPV-positive HNSCC (down from 36% in primary HPV+ tumors); 4 HNSCC and 1 [NPC](../cancer_types/NPC.md) and 1 [ACYC](../cancer_types/ACYC.md) patients enrolled on PI3K-inhibitor trials based on this alteration [PMID:27442865](../papers/27442865.md).
...
- N345K activating mutation in nephroblastomatosis (related to Wilms tumor, [WT](../cancer_types/WT.md)); PI3K/AKT/mTOR-inhibitor target; variant also supported diagnostic clarification in a pediatric precision-oncology cohort [PMID:28007021](../papers/28007021.md)
- PI3K-pathway activating alterations (alongside [PTEN](../genes/PTEN.md) and [PIK3R1](../genes/PIK3R1.md)) in 24% of ESCCs; all 4 ESCC3 tumours had PI3K-activating alterations in a multi-platform GEA genomic study [PMID:28052061](../papers/28052061.md)
- 17 [LUAD](../cancer_types/LUAD.md) patients with PIK3CA as highest-level driver; 25 [EGFR](../genes/EGFR.md)+PIK3CA co-mutations across the 860-patient MSK cohort; matched therapy uptake and benefit not specifically reported for PIK3CA-alone group [PMID:28336552](../papers/28336552.md)
- Recurrent low-VAF hotspot mutations in endometrial polyps (WGS, 23 polyps); part of a canonical [UCEC](../cancer_types/UCEC.md) driver landscape that includes [PIK3R1](../genes/PIK3R1.md), [PTEN](../genes/PTEN.md), [ERBB2](../genes/ERBB2.md), [PPP2R1A](../genes/PPP2R1A.md), and [FBXW7](../genes/FBXW7.md); supports treating polyps as potential precursor lesions [PMID:41137179](../papers/41137179.md)
- E365K and H1047R hotspot mutations in 2/19 (10.5%) of 1p/19q-codeleted anaplastic oligodendroglioma; OncoKB Level 3B; each hotspot observed in >20 principal tumor types in the MSK-IMPACT pan-cancer cohort, reflecting cross-lineage selection [PMID:28472509](../papers/28472509.md)
...
- PI3K/AKT/mTOR pathway activation (including PIK3CA) did NOT adversely affect benefit from [neratinib](../drugs/neratinib.md) in HER2-mutant solid tumors (p=0.753), contrasting with its negative-predictor role in HER2-amplified disease [PMID:29420467](../papers/29420467.md)
...
- Called as a [KIRC](../cancer_types/KIRC.md) SMG uniquely by MutSig2CV (not MuSiC2) in the MC3 pan-cancer open-access MAF, illustrating how caller choice and filtering stringency affect gene discovery [PMID:29596782](../papers/29596782.md).
- [SOX2](../genes/SOX2.md), PIK3CA, and [TERC](../genes/TERC.md) are chr_3q oncogenes invoked to explain the squamous chr_3q-gain signature; in the AALE experimental model, chr_3p-deleted clones rescued their proliferation defect by duplicating chromosome 3, thereby co-gaining the 3q arm containing PIK3CA [PMID:29622463](../papers/29622463.md).
- PIK3CA is one of the three most multiplatform-cluster-enriched drivers (with [TP53](../genes/TP53.md) and [KRAS](../genes/KRAS.md)) across TCGA pan-cancer; it drives [BRCA](../cancer_types/BRCA.md) mRNA/RPPA clusters and is mutually exclusive with [TP53](../genes/TP53.md) in several tumor types; PIK3CA/PTEN/AKT activation is enriched in ARID1A/PTEN/CTNNB1/PIK3CA cluster low-TP53 endometrial tumors [PMID:29625049](../papers/29625049.md)
- PIK3CA (with [PIK3CB](../genes/PIK3CB.md), [PIK3R1](../genes/PIK3R1.md), [PTEN](../genes/PTEN.md), [AKT1](../genes/AKT1.md)) drives the core PI3K pathway; PIK3CA activation and [PTEN](../genes/PTEN.md) inactivation dominate in head-and-neck, breast, GI, and gynecologic tumors; FGFR2/FGFR3 show exceptional co-occurrence with PI3K pathway alterations versus the typical mutual exclusivity between RTK and downstream RAS/PI3K [PMID:29625050](../papers/29625050.md)
...
- Single somatic mutation observed in 1/9 IMPACT341-sequenced hepatocellular adenomas (inflammatory I-HCA subtype), co-occurring with [HGF](../genes/HGF.md), [GNAS](../genes/GNAS.md), [FAT1](../genes/FAT1.md), and [KMT2D](../genes/KMT2D.md) mutations in the same tumor [PMID:30052636](../papers/30052636.md)
...
- PIK3CA mutated in 12% of gallbladder carcinoma tumors across a three-region cohort; entirely absent in Japanese patients; trend toward worse [OS](../cancer_types/OS.md) (P-adj=0.09); detected by MSK-IMPACT sequencing [PMID:30427539](../papers/30427539.md)
...
- PIK3CA oncogenic missense in <1% of advanced [HCC](../cancer_types/HCC.md); part of the PI3K-mTOR pathway actionability group (~15% of sorafenib-evaluable patients) associated with worse [sorafenib](../drugs/sorafenib.md) outcomes (PFS HR 3.8, [OS](../cancer_types/OS.md) HR 2.5) [PMID:30373752](../papers/30373752.md)
...
- PIK3CA profiled as part of the PI3K/mTOR pathway in metastatic panNET (80 patients, MSK-IMPACT [panet_msk_2018](../datasets/panet_msk_2018.md)); mTOR-pathway alterations occurred in 34/80 (43%) patients; PI3K pathway gene alterations did not predict [everolimus](../drugs/everolimus.md) response [PMID:30687805](../papers/30687805.md)
- PIK3CA is altered in 12% of mCRPC tumors; part of the broader PI3K-pathway alteration set (with [PIK3CB](../genes/PIK3CB.md) 4%, [PIK3R1](../genes/PIK3R1.md) 2.8%, [AKT1](../genes/AKT1.md) 0.9%); PI3K-pathway alteration was not associated with survival or time on ARSI [PMID:31061129](../papers/31061129.md)
- PIK3CA is among the recurrently mutated genes in [UTUC](../cancer_types/UTUC.md) (upper tract urothelial carcinoma) alongside [TP53](../genes/TP53.md), [KMT2D](../genes/KMT2D.md), [ARID1A](../genes/ARID1A.md), [KDM6A](../genes/KDM6A.md), [RB1](../genes/RB1.md), [ERCC2](../genes/ERCC2.md), and others at frequencies not significantly different from TCGA UCB [PMID:31278255](../papers/31278255.md)
- Hot-spot PIK3CA mutations in 8 MSK-IMPACT R/M [ACC](../cancer_types/ACC.md) cases; 6 were enrolled on PI3K-inhibitor basket trials ([taselisib](../drugs/taselisib.md) NCT01296555 or [alpelisib](../drugs/alpelisib.md) NCT01928459): 1/6 PR, 5/6 SD at 2 months, 5/6 had tumor-volume reduction (mean 18.8%), 4/6 achieved PR or SD >6 months [PMID:31483290](../papers/31483290.md).
- Recurrent hotspot activating mutations in helical/kinase domains in ~40–50% of ER+ tumors; in the [buparlisib](../drugs/buparlisib.md) + [letrozole](../drugs/letrozole.md) trial enriched in clinical-benefit patients; co-occurrence with [MAP3K1](../genes/MAP3K1.md) alterations associated with highest CBR (5/7, 71%); PIK3CA alone is suboptimal as a response predictor [PMID:31552290](../papers/31552290.md).
...
- Mutated in 41% of synchronous [DCIS](../cancer_types/DCIS.md) and 42% of IDC-NSTs (P>0.05); 9/12 mutations affected H1047R/L or E545D hotspots; completely absent (0%) in pure [DCIS](../cancer_types/DCIS.md) vs 41% in synchronous [DCIS](../cancer_types/DCIS.md), marking PIK3CA as one of the few features distinguishing synchronous from pure [DCIS](../cancer_types/DCIS.md) [PMID:32220886](../papers/32220886.md)
- Recurrent RTK/RAS/PI3K-pathway driver in [UTUC](../cancer_types/UTUC.md) (consistent with prior [UTUC](../cancer_types/UTUC.md) genomics); identified in MSK-IMPACT profiling of upper-tract urothelial carcinoma cohort and PDX models [PMID:32332851](../papers/32332851.md)
- Mutated at similar frequencies in sensitive (8/18, 44.4%) and resistant (18/41, 43.9%) HR+/HER2- [MBC](../cancer_types/MBC.md) biopsies — not a CDK4/6i resistance marker in this cohort [PMID:32404308](../papers/32404308.md)
- Mutated in 18% of refractory metastatic TNBC patients in the FUSCC cohort (n=69); MES-subtype TNBC patients with PI3K-AKT pathway mutations were enrolled in arm G ([everolimus](../drugs/everolimus.md) + [nab-paclitaxel](../drugs/nab-paclitaxel.md)), which achieved 50% ORR (1/2 evaluable). [PMID:32719455](../papers/32719455.md)
- Enriched in C-terminal [APC](../genes/APC.md) mutant MSS mCRC tumors vs N-terminal (28% vs 11%; p<0.01, q<0.1) in 430 patients; part of co-occurring mitogenic activation pattern associated with shorter OS/PFS. [PMID:32730818](../papers/32730818.md)
- Activating hotspot mutations (H1047R/L/Y kinase domain; E545K/A and E542K helical domain) in 88% of baseline-genotyped HR+ metastatic breast cancer patients (n=50) in the [alpelisib](../drugs/alpelisib.md) + AI phase I/II trial (NCT01870505); PIK3CA-WT tumors derived no clinical benefit (0/6); 70% of mutations were clonal. [PMID:32864625](../papers/32864625.md)
...
- Clonal hotspot mutations H1047R (JuP2) and E542K (JuP3) identified in 2/3 juvenile papillomatosis cases; JuP3 PIK3CA E542K mutation was shared by the coexisting JP, [DCIS](../cancer_types/DCIS.md), and IDC-NST components, supporting clonal origin. [PMID:33263939](../papers/33263939.md)
...
- Clonal hotspot mutations (e.g., H1047R) significantly enriched in TERT-altered metaplastic breast carcinomas (83% vs 13%; p=0.001); co-occurs with [TERT](../genes/TERT.md) promoter mutations [PMID:33863915](../papers/33863915.md)
- OncoKB level 1 alterations detected in plasma of breast cancer patients via cf-IMPACT, supporting [alpelisib](../drugs/alpelisib.md) eligibility; PIK3CA p.H1047R at very low VAF was a borderline false positive on orthogonal specificity testing [PMID:34059130](../papers/34059130.md)
...
- Mutated in 6.0% of [CSCC](../cancer_types/CSCC.md) tumors (PI3K pathway); co-occurs with [PTEN](../genes/PTEN.md) loss in cutaneous squamous cell carcinoma [PMID:34272401](../papers/34272401.md)
...
- Driver/timing observation in LCINS [LUAD](../cancer_types/LUAD.md): PIK3CA mutations occur after copy-number gain events, in contrast to [RBM10](../genes/RBM10.md) and [KRAS](../genes/KRAS.md) mutations which precede gain [PMID:34493867](../papers/34493867.md)
...
- Mutated in 11% of Chinese solid-tumor pan-cancer cohort ([pan_origimed_2020](../datasets/pan_origimed_2020.md), n=1015); canonical hotspots (C420R, E542K, E545A/D/G/K, H1047L/R/Y, Q546E/R) actionable to [alpelisib](../drugs/alpelisib.md) in 31% of [BRCA](../cancer_types/BRCA.md) and 7.4% of CRC [PMID:35871175](../papers/35871175.md)

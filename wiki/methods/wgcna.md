...
- Applied to [AML](../cancer_types/AML.md) RNA-seq data (Beat [AML](../cancer_types/AML.md) Waves 1–4, n=942 specimens); identified 13 module eigengenes with 98% concordance between Waves 1+2 and Waves 3+4; modules 3, 9, and 12 associated with shorter OS; module 3 hub gene [PEAR1](../genes/PEAR1.md) nominated as single-gene prognostic biomarker [PMID:35868306](../papers/35868306.md)
- Identified eight gene co-expression modules in muscle-invasive bladder cancer; cell-cycle, immune-infiltration and angiogenesis/TGF-beta modules correlated with worse disease-free survival [PMID:39550333](../papers/39550333.md)

...
- MTOR discussed as part of the mTOR pathway actionability framework in [HCC](../cancer_types/HCC.md); TSC1/TSC2 inactivating alterations (~10.6%) drive downstream mTOR activation and rationale for matched [everolimus](../drugs/everolimus.md) therapy; activating PI3K-mTOR pathway alterations as a group predicted worse [sorafenib](../drugs/sorafenib.md) outcomes (PFS HR 3.8, OS HR 2.5) [PMID:30373752](../papers/30373752.md)

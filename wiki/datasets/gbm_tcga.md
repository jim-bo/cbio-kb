...
- [PMID:30742122](../papers/30742122.md) — Neoadjuvant/adjuvant [pembrolizumab](../drugs/pembrolizumab.md) randomized [GBM](../cancer_types/GBM.md) trial: TCGA-GBM RNA-seq (HTSeq counts from GDC, n=166) used as an external comparator cohort, batch-corrected with limma `removeBatchEffect` against the trial's own transcriptomic data.
...
- Used as an IDH1-wildtype background reference (n=458 and n=503 samples) for mutation-frequency comparisons in the Columbia GBM immunotherapy cohort; [PTEN](../genes/PTEN.md) mutation frequency in TCGA (33%, 154/458) contextualized [PTEN](../genes/PTEN.md) enrichment among anti-PD-1 non-responders, and TCGA tumor purity estimates (ESTIMATE) supplemented the Columbia cohort transcriptomic analyses. [PMID:30742119](../papers/30742119.md)
...
- Used as the driver-alteration frequency benchmark for the Mayo GBM PDX panel; frequencies of [TERT](../genes/TERT.md), [EGFR](../genes/EGFR.md), [PTEN](../genes/PTEN.md), [TP53](../genes/TP53.md), [CDKN2A](../genes/CDKN2A.md), [BRAF](../genes/BRAF.md), and [IDH1](../genes/IDH1.md) alterations in the PDX panel were compared against TCGA-GBM. [PMID:31852831](../papers/31852831.md)

...
FBXW7 (F-Box And WD Repeat Domain Containing 7) encodes an E3 ubiquitin ligase substrate recognition subunit that targets multiple oncoproteins ([MYC](../genes/MYC.md), [NOTCH1](../genes/NOTCH1.md), [CCNE1](../genes/CCNE1.md), [JUN](../genes/JUN.md), [MCL1](../genes/MCL1.md)) for proteasomal degradation. Loss-of-function mutations in FBXW7 lead to accumulation of these oncoproteins and are recurrent across many cancer types, classifying FBXW7 as a pan-cancer tumor suppressor.

## Alterations observed in the corpus

- Subthreshold recurrent inactivating mutations in meningioma (q = 0.226); enriched in more aggressive molecular groups (MG3/MG4) [PMID:34433969](../papers/34433969.md).
- Altered in 13% of squamous cervical cancers (OncoKB-annotated) [PMID:37643132](../papers/37643132.md).
...
- R465H mutation identified in adenoid cystic carcinoma ([ACC](../cancer_types/ACC.md)); tumor suppressor that targets [MYC](../genes/MYC.md) and [NOTCH1](../genes/NOTCH1.md) for degradation [PMID:23685749](../papers/23685749.md)
...
- FBXW7 mutations in DLBCL cluster (CLUMPS 3D analysis) at the acceptor groove that impairs [CCNE1](../genes/CCNE1.md) recognition, invoking the same tumor-suppressor mechanism described in other cancer types [PMID:29713087](../papers/29713087.md)
- FBXW7 is recurrently mutated in 37 [UTUC](../cancer_types/UTUC.md) cases at frequencies not significantly different from TCGA UCB [PMID:31278255](../papers/31278255.md)
...
- Among the top recurrently mutated genes in rectal cancer tumoroids and the 287-patient MSK RC cohort ([rectal_msk_2019](../datasets/rectal_msk_2019.md)) [PMID:31591597](../papers/31591597.md)

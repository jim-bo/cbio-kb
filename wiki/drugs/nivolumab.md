...
- In a phase 2 trial (NCT03521570, n=51) of IMRT reirradiation combined with concurrent and maintenance nivolumab in recurrent/second-primary [HNSC](../cancer_types/HNSC.md), estimated 1-year PFS was 61.7% (95% CI 49.2%–77.4%), rejecting the historical null of 43.8% (1-arm log-rank P=.002). Median PFS 20.7 months, 2-year OS 48.4%; only 12% grade ≥3 treatment-related AEs and no grade 5 events [PMID:38780927](../papers/38780927.md).
- PD-L1 combined positive score (22C3, CPS <20 vs ≥20) did not predict PFS or OS benefit in this reirradiation + nivolumab context, diverging from the recurrent/metastatic HNSCC setting [PMID:38780927](../papers/38780927.md).

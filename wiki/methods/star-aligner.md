...
- Used for RNA-seq alignment in the [mixed_kunga_msk_2022](../datasets/mixed_kunga_msk_2022.md) cWGTS pipeline ([STAR](../genes/STAR.md) two-pass alignment) for whole-transcriptome sequencing in 101/114 pediatric/AYA solid tumor patients [PMID:35585047](../papers/35585047.md)
- [STAR](../genes/STAR.md) aligner used for bulk RNA-seq processing in 392 longitudinal glioma samples from the GLASS expansion cohort (alongside kallisto for expression quantification) [PMID:35649412](../papers/35649412.md)

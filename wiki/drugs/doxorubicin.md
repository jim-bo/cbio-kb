...
Anthracycline topoisomerase II inhibitor; backbone of CHOP-based lymphoma regimens.

## Evidence in the corpus

- Component of CHOP/CHOEP/EPOCH/BV-CH(E)P regimens in 132 MSK nodal [PTCL](../cancer_types/PTCL.md) patients; TP53-mutated [PTCL](../cancer_types/PTCL.md) had median PFS 4.5 months vs 10.5 months for TP53-wildtype on doxorubicin-containing induction [PMID:37078708](../papers/37078708.md).
- In the UCLA sarcoma PDTO biobank ([sarcoma_ucla_2024](../datasets/sarcoma_ucla_2024.md)), doxorubicin was a component of the MAP neoadjuvant regimen (methotrexate/doxorubicin/cisplatin) tested in three treatment-naïve [osteosarcoma](../cancer_types/OS.md) biopsies; organoid residual viability after MAP correlated with post-resection necrosis and clinical recurrence. [PMID:39305899](../papers/39305899.md)
- Doxorubicin is listed among NCCN-recommended regimens for [osteosarcoma](../cancer_types/OS.md), [rhabdomyosarcoma](../cancer_types/RMS.md), and [Ewing sarcoma](../cancer_types/ES.md) identified in the functional PDTO screen. [PMID:39305899](../papers/39305899.md)
...
- Cited in [HCC](../cancer_types/HCC.md) systemic therapy review as historical reference chemotherapy; not a frontline standard given sorafenib/lenvatinib era [PMID:30061739](../papers/30061739.md)
- Used as neoadjuvant monotherapy followed by ISG/SSG IV protocol ([vincristine](../drugs/vincristine.md), doxorubicin, [ifosfamide](../drugs/ifosfamide.md), [etoposide](../drugs/etoposide.md)) in a patient with [EWSR1](../genes/EWSR1.md)::[BEND2](../genes/BEND2.md) bladder sarcoma; intravesical tumor resolved but pelvic and lung metastases did not respond; patient switched to [docetaxel](../drugs/docetaxel.md) + [gemcitabine](../drugs/gemcitabine.md) after nephrotoxicity [PMID:41102727](../papers/41102727.md).
- Component of R-CHOP regimen; 85% of 304 DLBCL patients received R-CHOP-like therapy; [MYC](../genes/MYC.md) SVs, 13q31.3 gain, and 1q42.12 loss were independently prognostic for inferior PFS/OS on R-CHOP [PMID:29713087](../papers/29713087.md)
...
- Doxorubicin/cyclophosphamide (AC) followed paclitaxel/carboplatin ± [veliparib](../drugs/veliparib.md) in the 359-patient BrighTNess validation cohort used to test the LIG1-loss/carboplatin-resistance association [PMID:36001024](../papers/36001024.md).
...
- One neoadjuvant arm of SWOG S1314 (muscle-invasive bladder cancer, NCT02177695) was dose-dense MVAC ([methotrexate](../drugs/methotrexate.md), [vinblastine](../drugs/vinblastine.md), doxorubicin, [cisplatin](../drugs/cisplatin.md)), compared against gemcitabine-cisplatin, in a trial testing DDR alterations as predictors of pathologic response [PMID:39499893](../papers/39499893.md).
...
- [OS](../cancer_types/OS.md) — osteosarcoma; MAP regimen component; NCCN-listed in PDTO screen.
- [RMS](../cancer_types/RMS.md), [ES](../cancer_types/ES.md) — rhabdomyosarcoma and Ewing sarcoma; NCCN-recommended regimen in the PDTO screen.

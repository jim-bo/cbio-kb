...
- Mutated in 12.3% of CLL patients in the CLL map; a cardinal known CLL driver [PMID:35927489](../papers/35927489.md).
- Temporally intermediate in both M-CLL and U-CLL subtypes by [PhylogicNDT](../methods/phylogicndt.md) ordering [PMID:35927489](../papers/35927489.md).
- Negatively regulated by [ZFP36L1](../genes/ZFP36L1.md), which is disrupted by the recurrent 37-Mb chr14 deletion in U-CLL [PMID:35927489](../papers/35927489.md).
...
- NOTCH1 missense (3) and nonsense (1) mutations detected in 5% of [ACC](../cancer_types/ACC.md) cases; Notch-pathway activation supported by GSEA trend [PMID:23685749](../papers/23685749.md)
- NOTCH1 missense p.F1702S and frameshift p.Y550fs*81 detected in [ACC](../cancer_types/ACC.md) exome sequencing; functional direction (activating vs. loss-of-function per HNSCC) unresolved from mutation pattern alone [PMID:23778141](../papers/23778141.md)
...
- Mutated in 3/21 (14%) sequenced sinonasal adenoid cystic carcinomas — truncating variants including p.Ser2467Ter and p.Ala1908SerfsTer72; co-occurring with canonical [MYB](../genes/MYB.md)::[NFIB](../genes/NFIB.md) fusion in all 3 cases; associated with solid/basaloid and metatypical morphology and poor outcome (2/3 dead of disease) [PMID:39760648](../papers/39760648.md)
- NOTCH1 is mutated in [ESCC](../cancer_types/ESCC.md) as part of the canonical genomic landscape cited in a review of oral microbiome associations with [ESCC](../cancer_types/ESCC.md) [PMID:41096729](../papers/41096729.md)
...
- Significantly mutated in [ESCC](../cancer_types/ESCC.md) (enriched in the ESCC2 subtype); modulator of squamous cell maturation [PMID:28052061](../papers/28052061.md)
- Mutated in 6/19 (32%) of 1p/19q-codeleted anaplastic oligodendroglioma; specific alterations include A1701S, F357del, P1443Afs*36, T633Dfs*12, V324Qfs*6; not predictive of PFS or [OS](../cancer_types/OS.md) in this small NGS subset [PMID:28472509](../papers/28472509.md)
- Activating hot-spot mutations in HD and PEST domains in 18.3% of R/M ACC cases; any NOTCH1 alteration in 26.3% R/M vs. 8.5% primary (OR 3.86, P<0.0001); strongly associated with poor [OS](../cancer_types/OS.md) (median 55.1 vs. 204.5 months, P=1.10×10⁻⁴); mutually exclusive with [TERT](../genes/TERT.md) promoter mutations; co-occurs with chromatin-remodeling alterations; authors propose γ-secretase inhibitors as targeted therapy [PMID:31483290](../papers/31483290.md).
...
- One of the most common co-mutations in TRK fusion-positive tumors in the MSK cohort (n=113 NTRK-positive cases); co-mutation with [NOTCH2](../genes/NOTCH2.md) also observed [PMID:31871300](../papers/31871300.md)
...
- Loss-of-function mutations in 55.4% of cutaneous squamous cell carcinomas in a meta-analysis of 88 QC-passed tumors; ubiquitous NOTCH-pathway inactivation identified as near-obligate in [CSCC](../cancer_types/CSCC.md) [PMID:34272401](../papers/34272401.md)
...
- Chronic lymphocytic leukemia ([CLLSLL](../cancer_types/CLLSLL.md)) — 12.3% mutation frequency [PMID:35927489](../papers/35927489.md).
- Anaplastic thyroid carcinoma (ATC) — recurrent SNVs [PMID:38412093](../papers/38412093.md).
- Cutaneous squamous cell carcinoma (cSCC) — loss-of-function mutations are early/trunk events during AK-to-cSCC evolution; induce stem/progenitor cell state [PMID:39091884](../papers/39091884.md).

## Co-occurrence and mutual exclusivity

- Indirect pathway activation via [ZFP36L1](../genes/ZFP36L1.md) loss in U-CLL [PMID:35927489](../papers/35927489.md).
...
- Relationship of NOTCH1 mutation status to expression clusters and epitype [PMID:35927489](../papers/35927489.md).

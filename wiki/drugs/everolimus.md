...
name: everolimus
targets: [MTOR]
drug_class: mTOR inhibitor (rapalogue)
...
- In advanced hepatocellular carcinoma ([HCC](../cancer_types/HCC.md)), 2 patients received everolimus based on mTOR-AKT pathway alterations ([TSC1](../genes/TSC1.md)/[TSC2](../genes/TSC2.md)) identified on tissue and confirmed by cfDNA; one patient with a [TSC2](../genes/TSC2.md) splice site mutation achieved stable disease for 5.4 months, while the other ([TSC2](../genes/TSC2.md) frameshift deletion) progressed after 2.5 months [PMID:37769223](../papers/37769223.md).
...
- PI3K/AKT/mTOR pathway altered in ~28% of clear cell renal cell carcinoma ([CCRCC](../cancer_types/CCRCC.md)) tumors in the TCGA cohort; the authors nominate this pathway as a therapeutic target citing prior trials of everolimus in advanced [RCC](../cancer_types/RCC.md) [PMID:23792563](../papers/23792563.md).
...
- mTOR signaling is disrupted in 40–50% of HCCs; everolimus failed in unselected second-line [HCC](../cancer_types/HCC.md) trials but the review proposes mTOR-pathway dysregulation as a biomarker to enrich future trials [PMID:25369299](../papers/25369299.md)
- Phase III second-line trial in [HCC](../cancer_types/HCC.md) (post-sorafenib) failed to demonstrate [OS](../cancer_types/OS.md) benefit; cited as a negative result for mTOR inhibition in [HCC](../cancer_types/HCC.md) [PMID:30061739](../papers/30061739.md)
...
- [TSC2](../genes/TSC2.md) frameshift deletions may not confer the same clinical benefit from everolimus as [TSC2](../genes/TSC2.md) splice site mutations in [HCC](../cancer_types/HCC.md), based on differential outcomes in 2 patients [PMID:37769223](../papers/37769223.md).

## Cancer types (linked)

- [HCC](../cancer_types/HCC.md)
- [OS](../cancer_types/OS.md) — osteosarcoma (PDTO sensitivity, NCCN-listed)
- [CHDM](../cancer_types/CHDM.md) — chordoma (relatively resistant)
...
- [PMID:28027327](../papers/28027327.md) — Lefebvre et al. 2016, metastatic breast cancer WES; TSC1/2 mutations in 6.3% of HR+/HER2- mBC hypothesized as biomarker for everolimus outlier response.

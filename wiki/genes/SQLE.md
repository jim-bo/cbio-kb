...
SQLE (squalene epoxidase) catalyzes a rate-limiting step in cholesterol biosynthesis, converting squalene to 2,3-epoxysqualene. In hepatocellular carcinoma (HCC), SQLE is upregulated as part of the cholesterol biosynthesis reprogramming program alongside HMGCR and MVK. Notably, SQLE targeting has been shown to restore anti-PD-1 efficacy specifically in MASH (metabolic dysfunction-associated steatohepatitis)-induced HCC, linking cholesterol pathway perturbation to immune checkpoint therapy response.

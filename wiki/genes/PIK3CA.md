...
- Canonical activating hotspot p.H1047L detected in ACC exome sequencing (24-case cohort) [PMID:23778141](../papers/23778141.md)
...
- PIK3CA is altered in 12% of mCRPC tumors; part of the broader PI3K-pathway alteration set (with [PIK3CB](../genes/PIK3CB.md) 4%, PIK3R1 2.8%, AKT1 0.9%); PI3K-pathway alteration was not associated with survival or time on ARSI [PMID:31061129](../papers/31061129.md)
...
- PIK3CA/PIK3R1 events (n=23 combined) in the MAPPYACTS pediatric relapsed cohort (n=787); matched to mTOR inhibitors ([vistusertib](../drugs/vistusertib.md), everolimus) explored in AcSé-ESMART arms E/F alongside 25 PTEN losses [PMID:35292802](../papers/35292802.md)

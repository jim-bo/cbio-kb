...
Amplicon sequencing of the bacterial 16S rRNA gene used to characterize microbial community composition in tumor and matched normal tissue [PMID:37202560](../papers/37202560.md).
...
- Used in all 18 case–control studies meta-analyzed (predominantly V3–V4 region; platforms including Illumina MiSeq/HiSeq/NovaSeq and Ion Torrent) to characterize the oral microbiome in esophageal cancer cases vs. controls; significant beta-diversity differences reported in 12/17 studies [PMID:41096729](../papers/41096729.md)
- Multiple 16S rRNA sequencing studies (Zhang Q, Ito Z, Deng T, Zhang T, Jia X) synthesized in this CCA review, profiling gut microbiota dysbiosis in cholangiocarcinoma; documented depletion of Faecalibacterium/Roseburia/Bacteroides and enrichment of Escherichia-Shigella/Enterobacteriaceae in iCCA patients vs healthy controls [PMID:41018102](../papers/41018102.md)

## Notes

- In the AC-ICAM workflow, 16S sequencing was paired with tumor whole-genome sequencing for microbiome read mining and validation [PMID:37202560](../papers/37202560.md).
- Microbiome composition is sensitive to sample handling, diet, and geography, so the *R. bromii* signal requires external validation [PMID:37202560](../papers/37202560.md).

...
Seminoma is a histologically pure testicular germ cell tumor composed of primordial germ cells. It sits under TESTIS in OncoTree, with typically favorable [cisplatin](../drugs/cisplatin.md) sensitivity compared with nonseminomatous subtypes. Molecularly, seminoma is characterized by high [KIT](../genes/KIT.md) and [KRAS](../genes/KRAS.md) mutation rates, in contrast to the [TP53](../genes/TP53.md) enrichment seen in cisplatin-resistant nonseminomas.

## Cohorts in the corpus

- [gct_msk_2016](../datasets/gct_msk_2016.md) — 54 seminoma patients (30% of the 180-patient MSK [germ cell tumor](../cancer_types/germ-cell-tumor.md) cohort); profiled by whole-exome sequencing and MSK-IMPACT targeted sequencing [PMID:27646943](../papers/27646943.md).
...
- **12p gain** — present in 74% of discovery germ cell tumors overall; characteristic of both seminoma and nonseminoma [PMID:27646943](../papers/27646943.md).
...
- Pure seminoma is treated differently from mixed/nonseminomatous GCT; pure mediastinal seminoma has a better prognosis than mediastinal nonseminoma (0 of 4 primary mediastinal seminomas had TP53 alterations vs 13 of 18 nonseminomas) [PMID:27646943](../papers/27646943.md).

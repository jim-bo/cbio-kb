...
# Medullary Thyroid Cancer (THME)

## Overview

Medullary thyroid carcinoma (MTC) arising from parafollicular C-cells, characterized by calcitonin secretion. Strongly associated with germline and somatic [RET](../genes/RET.md) kinase-domain mutations, making it a key histology for RET-targeted therapy trials.
...
- [PMID:35304457](../papers/35304457.md) — Rosen et al., LIBRETTO-001 [selpercatinib](../drugs/selpercatinib.md) trial; mechanisms of response and resistance in RET-driven lung and thyroid cancers; THME as the predominant RET-mutant histology.

...
- [PMID:39185963](../papers/39185963.md) — MSK-IMPACT targeted NGS (mean 613× coverage) applied to all 20 atypical [SCLC](../cancer_types/SCLC.md) ([asclc_msk_2024](../datasets/asclc_msk_2024.md)) patients and a comparator cohort of 600 consecutive de novo SCLC patients at MSKCC; identified the absence of RB1/TP53 alterations and detected ecDNA amplifications of [CCND1](../genes/CCND1.md), CCND2/CDK4/MDM2, and [MYCL](../genes/MYCL.md); tNGS sensitivity for chromothripsis was 77% relative to WGS [PMID:39185963](../papers/39185963.md).

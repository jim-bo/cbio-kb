...
- [brca_tcga_pub](../datasets/brca_tcga_pub.md) — cited for TP53/PIK3CA co-mutation cross-species comparisons in ER+ breast cancer modeling [PMID:41000773](../papers/41000773.md).
...
- Among 3,880 MSK-IMPACT-sequenced breast cancers, invasive ductal carcinoma was less frequently APOBEC3-dominant than invasive lobular carcinoma (ILC, n=489), a pattern held in both primary and metastatic samples [PMID:40379787](../papers/40379787.md).
...
- [PIK3CA](../genes/PIK3CA.md)+TP53 co-mutated IDC tumors show transcriptional concordance with rat Pik3caH1047R/Tp53Indel models (Fisher's exact p<1×10^-14 for overlapping up-regulated genes), supporting cross-species translational relevance for endocrine and combination therapy studies [PMID:41000773](../papers/41000773.md).

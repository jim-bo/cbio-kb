...
name: mitomycin-c
targets: []
drug_class: DNA cross-linking agent (alkylating antibiotic)
...
- RAD51B knockdown in MCF-10A/MCF-12A breast epithelial cells confers sensitivity to mitomycin-C (interstrand crosslinker), consistent with homologous recombination deficiency; magnitude is intermediate between WT and BRCA1-knockdown cells, paralleling the partial HRD genomic phenotype (Signature 3, LST-high) in biallelic RAD51B loss tumors. [PMID:34635660](../papers/34635660.md)
...
- [BLCA](../cancer_types/BLCA.md) — intravesical agent used adjuvantly in low-grade Ta NMIBC.

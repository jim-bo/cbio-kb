...
CDKN2B (p15/INK4B) is a CDK4/6 inhibitor and tumor suppressor located at chromosome 9p21, adjacent to [CDKN2A](../genes/CDKN2A.md). CDKN2B is frequently co-deleted with [CDKN2A](../genes/CDKN2A.md) and functions to suppress cell cycle progression. In esophageal adenocarcinoma, CDKN2B contributes to Cell Cycle pathway enrichment, while in glioblastoma it shows differential alteration patterns between IDH-WT and IDH-mutant subtypes.

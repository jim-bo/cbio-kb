...
- Mutations found in 8% of [GBM](../cancer_types/GBM.md)s, primarily in the extracellular domain, suggesting a role in RTK activation [PMID:18772890](../papers/18772890.md).
- ERBB2 was among the genes altered *less* often in [LUAD](../cancer_types/LUAD.md) metastases than in matched primaries [PMID:37084736](../papers/37084736.md).
- ERBB2 amplification was identified in one female ovarian germ cell tumor treated with [trastuzumab](../drugs/trastuzumab.md), without durable response [PMID:36862133](../papers/36862133.md).
- In urothelial carcinoma, ERBB2 was inversely associated with [FGFR3](../genes/FGFR3.md) alterations overall but co-altered in 5% (19/414) of FGFR3-altered tumors, ranging from 2.5% in NMIBC to 11% in MIBC [PMID:37682528](../papers/37682528.md).
- ERBB2 mutations and amplification were detected in CSF ctDNA from lung cancer and breast cancer patients with CNS involvement in the [csf_msk_2024](../datasets/csf_msk_2024.md) cohort (1,007 CSF samples, 711 patients) [PMID:39289779](../papers/39289779.md).
- ERBB2 amplification was a positive prognostic factor for PFS in metastatic [EGC](../cancer_types/EGC.md) (HER2+ [EGC](../cancer_types/EGC.md), [pembrolizumab](../drugs/pembrolizumab.md) + [trastuzumab](../drugs/trastuzumab.md) + chemotherapy trial); loss of HER2 expression was the most common resistance mechanism (48% of progressing patients) [PMID:37406106](../papers/37406106.md).
- ERBB2 alterations in 12% of cervical cancers (4% amplifications, 9% oncogenic mutations); enriched in undifferentiated endocervical adenocarcinoma (UEA, 28%); one patient with D769N mutation had exceptional response to HER kinase inhibitor (>5 years) [PMID:37643132](../papers/37643132.md).
...
- [GBM](../cancer_types/GBM.md) — mutated in 8% of cases; primarily extracellular domain mutations suggesting RTK activation [PMID:18772890](../papers/18772890.md).
- [LUAD](../cancer_types/LUAD.md) — depleted in metastases vs primaries [PMID:37084736](../papers/37084736.md).
- [OGCT](../cancer_types/OGCT.md) — amplification in one patient in the Make-an-IMPACT rare-cancer cohort [PMID:36862133](../papers/36862133.md).
- [BLCA](../cancer_types/BLCA.md) / [UTUC](../cancer_types/UTUC.md) — co-altered in 11% of FGFR3-altered MIBC [PMID:37682528](../papers/37682528.md).
- [BRCA](../cancer_types/BRCA.md) / [NSCLC](../cancer_types/NSCLC.md) — mutations and amplification detected in CSF ctDNA from breast and lung cancer patients with CNS tumors [PMID:39289779](../papers/39289779.md).
- [EGC](../cancer_types/EGC.md) — defining treatment-eligible biomarker; loss of HER2 as key resistance mechanism [PMID:37406106](../papers/37406106.md); amplification associated with improved survival [PMID:37699004](../papers/37699004.md).
- [CESC](../cancer_types/CESC.md) — altered in 12% overall; 28% in UEA subtype [PMID:37643132](../papers/37643132.md).
- [UCEC](../cancer_types/UCEC.md) — amplification enriched in Black patients (12% vs 3%) [PMID:37651310](../papers/37651310.md).
- [HNSC](../cancer_types/HNSC.md) / [ESCA](../cancer_types/ESCA.md) / [BRCA](../cancer_types/BRCA.md) / [STAD](../cancer_types/STAD.md) / [GB](../cancer_types/GB.md) — HER2 expression level predicts ADC-mediated radiosensitization (T-DM1 + IR) in preclinical models; authors propose combining T-DM1 with IR warrants clinical evaluation in HER2+ locally advanced disease [PMID:27698471](../papers/27698471.md).
- [CHDM](../cancer_types/CHDM.md) — EGFR/ERBB2 pathway enriched in chordomas; TAK-285 (EGFR/ERBB2 kinase inhibitor) preferentially active in chordoma PDTOs vs pan-sarcoma (p=0.034) [PMID:39305899](../papers/39305899.md).
- [BLCA](../cancer_types/BLCA.md) (metastatic urothelial carcinoma) — alterations in 14% of cfDNA; independent predictor of shorter [OS](../cancer_types/OS.md) on cisplatin-based chemotherapy (multivariable HR 1.64, p=0.019) in CALGB 90601 [PMID:40256659](../papers/40256659.md).

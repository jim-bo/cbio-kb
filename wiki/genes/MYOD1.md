...
- Defining L122R hotspot mutation (VAF >50% in 19/20 genomically profiled patients) in spindle cell/sclerosing rhabdomyosarcoma ([SCSRMS](../cancer_types/SCSRMS.md)), driving a rewired transcriptional program enriched in the least-differentiated progenitor cell state [PMID:41758938](../papers/41758938.md).

## Cancer types (linked)

- [SCRMS](../cancer_types/SCRMS.md) — MYOD1-mutant spindle cell/sclerosing [RMS](../cancer_types/RMS.md) in the extremity [RMS](../cancer_types/RMS.md) series [PMID:37315267](../papers/37315267.md).
...
- Small sample size (n=2) limits inference about prognosis or therapy response [PMID:37315267](../papers/37315267.md).

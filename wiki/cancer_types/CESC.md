...
- 177 cervical cancer patients (CESC) prospectively sequenced at Memorial Sloan Kettering Cancer Center (Feb 2014 -- May 2019) using MSK-IMPACT (341/410/468 genes). Histologic subtypes: squamous cell carcinoma (39%), usual endocervical adenocarcinoma (28%), gastric-type adenocarcinoma (12%), adenosquamous (12%). Dataset: [cervix_msk_2023](../datasets/cervix_msk_2023.md); compared against [cesc_tcga_pan_can_atlas_2018](../datasets/cesc_tcga_pan_can_atlas_2018.md). [PMID:37643132](../papers/37643132.md)

## Recurrent alterations

- [PIK3CA](../genes/PIK3CA.md) — most frequent alteration; mutations/amplifications in 25% of cases; enriched in squamous (38%) vs. gastric type (5%). Most common OncoKB level 3B actionable alteration. [PMID:37643132](../papers/37643132.md)
- [ERBB2](../genes/ERBB2.md) — alterations in 12% (4% amplifications, 9% oncogenic mutations); enriched in usual endocervical adenocarcinoma (28%). One patient with D769N mutation had exceptional response to HER kinase inhibitor (>5 years). [PMID:37643132](../papers/37643132.md)
- [KRAS](../genes/KRAS.md) — mutations in 12%; enriched in gastric type (27%) and UEA (20%); includes [KRAS](../genes/KRAS.md) G12C hotspot. Significantly enriched vs. TCGA (P=0.019). [PMID:37643132](../papers/37643132.md)
- [TP53](../genes/TP53.md) — mutations in 11%; predominant in gastric type (55%). Mutually exclusive with HPV positivity (3.5% of HPV+ vs. 53.8% of HPV-negative gastric-type cases, P=0.00007). [PMID:37643132](../papers/37643132.md)
- [KMT2C](../genes/KMT2C.md) — altered in 10%; enriched in squamous (14%). [PMID:37643132](../papers/37643132.md)
- [KMT2D](../genes/KMT2D.md) — altered in 9%; enriched in squamous (14%). [PMID:37643132](../papers/37643132.md)
- [STK11](../genes/STK11.md) — altered in 14% of gastric type and 33% of adenosquamous carcinoma. [PMID:37643132](../papers/37643132.md)
...
- 37% of cases had at least one actionable alteration (OncoKB level 3B); 17% enrolled on therapeutic clinical trials (10% matched to trial based on MSK-IMPACT). [PMID:37643132](../papers/37643132.md)

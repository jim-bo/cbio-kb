...
- Used as a bulk RNA-seq benchmarking cohort (n=1,019 cell lines) to validate OncoMark hallmark predictions — K-S statistics >0.69 separating cancer from normal across all ten hallmarks (p≈0) [PMID:41057477](../papers/41057477.md)

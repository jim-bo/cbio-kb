...
EZH2 encodes the catalytic subunit of the Polycomb Repressive Complex 2 (PRC2), responsible for trimethylating histone H3 at lysine 27 (H3K27me3). In cancer, gain-of-function mutations at Y641 and nearby residues enhance H3K27 trimethylation, silencing tumor suppressor genes and promoting proliferation. EZH2 is a key oncogenic driver in germinal center B-cell (GCB) subtypes of diffuse large B-cell lymphoma (DLBCL) and follicular lymphoma ([FL](../cancer_types/FL.md)).

## Alterations observed in the corpus

- EZH2 was recurrently mutated in DLBCL and [FL](../cancer_types/FL.md), with gain-of-function mutations at Y641 (including Y641F, Y641N, Y641S, Y641H, Y641C), A682G, and A692V, leading to enhanced H3K27 trimethylation; mutations enriched in GCB subtype [PMID:21796119](../papers/21796119.md)
...
- Discussed as a therapeutic-target gene in [AML](../cancer_types/AML.md); LSD1/EZH2 inhibitors are a treatment strategy in the [AML](../cancer_types/AML.md) genomic landscape [PMID:30333627](../papers/30333627.md)
...
- EZH2 inhibition rationale in uterine adenosarcoma ([UAS](../cancer_types/UAS.md)): given SWI/SNF-EZH2 synthetic lethality precedent in epithelioid sarcoma ([EPIS](../cancer_types/EPIS.md)), the 43% SWI/SNF-altered rate in UAS motivates exploration of [tazemetostat](../drugs/tazemetostat.md) [PMID:35705560](../papers/35705560.md)
...
- EZH2 mutations co-occur with [CREBBP](../genes/CREBBP.md) and [EP300](../genes/EP300.md) mutations within the GCB DLBCL landscape, suggesting convergent disruption of histone modification balance [PMID:21796119](../papers/21796119.md)
...
- Whether EZH2 mutations are drivers or passengers in [FL](../cancer_types/FL.md) progression to DLBCL remains under investigation.

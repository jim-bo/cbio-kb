...
LDLR encodes the low-density lipoprotein receptor responsible for cellular uptake of LDL-cholesterol. In hepatocellular carcinoma ([HCC](../cancer_types/HCC.md)), LDLR inhibition paradoxically raises intracellular cholesterol synthesis through activation of the MEK/ERK pathway, ultimately promoting tumor growth. This places LDLR within the cholesterol-uptake axis that drives TKI resistance in HCC, alongside [PCSK9](../genes/PCSK9.md) and the mevalonate pathway enzymes.
...
- The precise mechanism by which LDLR inhibition activates MEK/ERK (i.e., whether via lipid raft remodeling or direct signaling) in HCC is not fully established.

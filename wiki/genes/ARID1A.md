...
- ARID1A loss-of-function mutations sensitize ovarian cancer cells to BET bromodomain inhibition (JQ1), establishing a synthetic lethal relationship exploitable therapeutically [PMID:41049615](../papers/41049615.md)
...
- Single somatic mutation observed in adenoid cystic carcinoma ([ACC](../cancer_types/ACC.md)) WES cohort (n=60); classified as SWI/SNF complex alteration [PMID:23685749](../papers/23685749.md)
...
- Single in-frame deletion p.Tyr560_Gln561delinsTer identified in sinonasal AdCC (1/21 sequenced cases); SWI/SNF complex component [PMID:39760648](../papers/39760648.md)
...
- Chromatin remodeling driver identified by NGS in [HCC](../cancer_types/HCC.md); listed among the newly identified [HCC](../cancer_types/HCC.md) driver genes [PMID:25369299](../papers/25369299.md)
- Loss-of-function mutation in 8% (range 4–12%) of HCCs (WES, n=1,289); chromatin-modifier trunk driver classified as non-actionable [PMID:30061739](../papers/30061739.md)
...
- Identified as a putative [MYB](../genes/MYB.md) transcriptional target in adenoid cystic carcinoma ([ACC](../cancer_types/ACC.md)); mutated in [ACC](../cancer_types/ACC.md) per prior sequencing studies cited in this analysis [PMID:26829750](../papers/26829750.md)
...
- SWI/SNF member; inactivating mutations identified as Mut-drivers in breast cancer (METABRIC 2,433-sample cohort); [ARID1B](../genes/ARID1B.md) synthetic-lethal dependency proposed as therapeutic strategy in ARID1A-deficient tumors [PMID:27161491](../papers/27161491.md)
- ARID1A (SWI/SNF complex) more frequently altered in esophageal adenocarcinoma ([EAC](../cancer_types/EAC.md)) than [ESCC](../cancer_types/ESCC.md); part of a recurrent SWI/SNF complex alteration pattern in upper GI cancers [PMID:28052061](../papers/28052061.md)
...
- Stop-gain driver SNV detected in the para-vertebral metastasis of [NSCLC](../cancer_types/NSCLC.md) patient CRUK0063, below multi-region sequencing calling threshold in the primary tumor region from which the metastatic subclone derived; illustrates subclonal metastatic seeding in [LUAD](../cancer_types/LUAD.md) [PMID:28445469](../papers/28445469.md)
...
- ARID1A is a SWI/SNF subunit mutated in medulloblastoma; together with [SMARCA4](../genes/SMARCA4.md) and [ARID2](../genes/ARID2.md), SWI/SNF subunits are altered in 33% of WNT MBs, providing rationale for PRC2 inhibitors (trial NCT02601937) [PMID:28726821](../papers/28726821.md)
...
- ARID1A recurrent (P=0.01) in [UTUC](../cancer_types/UTUC.md) WES cohort (n=40); associated with higher mutational load (P=0.01); enriched in muscle-invasive (MI) tumors (33% MI vs 0% NMI, P=0.042, FDR=0.2); collapsed into the SWI/SNF composite mutation feature for iClusterBayes subtyping [PMID:33397444](../papers/33397444.md)
...
- Mutations associated with higher TMB and downregulated ARID1A protein in CPTAC LSCC proteogenomics (108 tumors); ARID1A loss linked to worse OS in [NSCLC](../cancer_types/NSCLC.md). [PMID:34358469](../papers/34358469.md)
...
- CLL — ARID1A is a U-CLL-enriched driver tied to chromatin-remodeling dysfunction [PMID:35927489](../papers/35927489.md).
- [LUAD](../cancer_types/LUAD.md) — ARID1A alterations accumulate in metastatic lesions and in primary tumors that will later seed brain metastases [PMID:37084736](../papers/37084736.md) [PMID:37591896](../papers/37591896.md).
...
- In [LUAD](../cancer_types/LUAD.md) BM+ primaries, ARID1A alterations co-enrich with [TP53](../genes/TP53.md), [MYC](../genes/MYC.md), [SMARCA4](../genes/SMARCA4.md), [RB1](../genes/RB1.md), and [FOXA1](../genes/FOXA1.md) in tumors that will develop brain metastases [PMID:37591896](../papers/37591896.md).

## Therapeutic relevance

- No direct therapeutic associations for ARID1A are reported in the corpus [PMID:35927489](../papers/35927489.md) [PMID:37084736](../papers/37084736.md) [PMID:37591896](../papers/37591896.md).

## Open questions

- Whether ARID1A loss is causal for metastatic progression in [LUAD](../cancer_types/LUAD.md) or a marker of broader chromatin-remodeling instability remains unresolved [PMID:37084736](../papers/37084736.md) [PMID:37591896](../papers/37591896.md).

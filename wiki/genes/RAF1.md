...
RAF1 (CRAF) is a serine/threonine kinase in the RAS–MAPK signaling pathway. It is cataloged among somatic alterations in the mutational landscape of hepatocellular carcinoma ([HCC](../cancer_types/HCC.md)) derived from large-scale whole-exome sequencing studies.
...
- Individual mutation frequency and functional significance of RAF1 alterations in [HCC](../cancer_types/HCC.md) require further characterization.

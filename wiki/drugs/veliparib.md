...
targets:
  - PARP1
  - PARP2
drug_class: PARP inhibitor (PARPi)
...
- The MSK PDAC 2024 cohort (n=2,336) analyzed outcomes in n=29 stage-IV patients who received a PARPi (class encompasses [olaparib](../drugs/olaparib.md), [rucaparib](../drugs/rucaparib.md), [niraparib](../drugs/niraparib.md), and veliparib). 38% (11/29) had ≥6 months on therapy; all 10 long-responder [BRCA2](../genes/BRCA2.md) tumors had biallelic inactivation, but 6/16 biallelic BRCA2-mutant tumors did not benefit, demonstrating that biallelic [BRCA2](../genes/BRCA2.md) loss is necessary but not sufficient. [PMID:39753968](../papers/39753968.md)
...
- Veliparib directly targets PARP1/PARP2; in BRCA1/2-wild-type mCRPC, resistance to PARP inhibitors (including veliparib) may be driven by high [TRMT10A](../genes/TRMT10A.md) expression, which supports [BRCA1](../genes/BRCA1.md) recruitment to DNA double-strand breaks via ATM-mediated Ser28 phosphorylation [PMID:41071892](../papers/41071892.md)
- Veliparib + [temozolomide](../drugs/temozolomide.md) efficacy across 28 [GBM](../cancer_types/GBM.md) patient-derived xenografts from the Mayo PDX panel was limited to MGMT-methylated tumors; this preclinical biomarker-enrichment finding was cited as rationale for the Alliance clinical trial of veliparib in MGMT-methylated GBM [PMID:31852831](../papers/31852831.md).
...
- Biallelic [BRCA2](../genes/BRCA2.md) loss is necessary but not sufficient for PARPi response in PDAC; additional determinants of HRD competence (beyond BRCA2 biallelic inactivation) remain to be defined. [PMID:39753968](../papers/39753968.md)

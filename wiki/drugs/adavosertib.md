...
unverified: true
tags: [kinase-inhibitor, dna-damage-response, pediatric-oncology]
...
- Adavosertib ([WEE1](../genes/WEE1.md) inhibitor) was the most frequently recommended drug class (n=150 recommendations) in the MAPPYACTS precision-oncology trial (NCT02613962) for pediatric/young-adult recurrent malignancies; [TP53](../genes/TP53.md) alterations (n=215) drove [WEE1](../genes/WEE1.md) inhibitor matching, with [TP53](../genes/TP53.md) + WEE1 inhibition combinations explored in AcSé-ESMART platform arms [PMID:35292802](../papers/35292802.md)

## Resistance mechanisms

_No resistance findings recorded in this corpus yet._

## Cancer types (linked)

- [Pediatric solid tumors — multiple histologies](../cancer_types/HGGNOS.md) (MAPPYACTS cohort — sarcomas, CNS tumors, [NBL](../cancer_types/NBL.md), leukemia)

## Sources

- [PMID:35292802](../papers/35292802.md) — MAPPYACTS trial (NCT02613962), pediatric precision oncology

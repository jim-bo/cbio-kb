...
name: orlistat
targets: [FASN]
drug_class: FASN inhibitor / lipase inhibitor
canonical_source: corpus
unverified: true
tags: [hcc, fasn-inhibitor, de-novo-lipogenesis, combination-therapy, drug-repurposing]
...
Orlistat is a pancreatic lipase inhibitor approved by the FDA for obesity treatment. It is also a covalent inhibitor of [FASN](../genes/FASN.md) (fatty acid synthase), the rate-limiting enzyme of de novo lipogenesis (DNL). In cancer research, it is explored as a FASN inhibitor to disrupt DNL-dependent tumor growth, though it has limited bioavailability for systemic anti-tumor use. TVB-2640 and TVB-3664 are clinical-stage FASN inhibitors serving as more pharmacologically optimized analogs.

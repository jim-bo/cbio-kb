...
TCF7L2 (Transcription Factor 7 Like 2, also known as [TCF4](../genes/TCF4.md)) encodes the principal nuclear effector of the Wnt/beta-catenin signaling pathway in the intestinal epithelium. When beta-catenin translocates to the nucleus following Wnt pathway activation, it binds TCF7L2 to activate Wnt target gene transcription. TCF7L2 is one of the most studied Wnt pathway transcription factors in colorectal cancer, where it cooperates with beta-catenin to drive expression of pro-proliferative targets. Somatic deletions and mutations of TCF7L2 represent an alternative mechanism of Wnt pathway dysregulation in colorectal tumors lacking [APC](../genes/APC.md) mutations.
...
- [COAD](../cancer_types/COAD.md): Recurrent focal deletions and somatic mutations in non-hypermutated colorectal adenocarcinoma (12% prevalence); associated with Wnt pathway dysregulation [PMID:22810696](../papers/22810696.md)

## Co-occurrence and mutual exclusivity

- [APC](../genes/APC.md): TCF7L2 deletions/mutations likely represent an alternative route to Wnt activation in tumors with intact [APC](../genes/APC.md); pattern suggests partial mutual exclusivity [PMID:22810696](../papers/22810696.md)
- [CTNNB1](../genes/CTNNB1.md): Activating [CTNNB1](../genes/CTNNB1.md) mutations occur preferentially in APC-wild-type tumors; co-occurrence pattern with TCF7L2 alterations not explicitly reported [PMID:22810696](../papers/22810696.md)
- [TCF7L1](../genes/TCF7L1.md): Paralogous TCF/LEF family member altered via NAV2-TCF7L1 fusion in 3 CRC cases; both genes converge on Wnt pathway transcriptional dysregulation [PMID:22810696](../papers/22810696.md)

## Therapeutic relevance

- No direct therapeutic agent targeting TCF7L2; Wnt pathway inhibitors under development may be relevant for TCF7L2-altered colorectal tumors [PMID:22810696](../papers/22810696.md)

## Open questions

- Whether TCF7L2 deletions are driver events or passenger alterations in CRC requires functional validation [PMID:22810696](../papers/22810696.md)

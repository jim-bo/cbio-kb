...
- Early-onset [EGC](../cancer_types/EGC.md) had a higher proportion of women (39% vs 28%, P=0.002) and patients of Asian race (16% vs 9%, P=0.002).
...
- Among microsatellite-stable tumors, [CCNE1](../genes/CCNE1.md) alterations were enriched in early-onset (16% vs 7%, P=0.001, Q=0.011) and [CDH1](../genes/CDH1.md) alterations were enriched in early-onset (12% vs 6%, P=0.004, Q=0.03).
- [CDKN2A](../genes/CDKN2A.md) alterations were enriched in average-onset (22% vs 11%, P<0.001, Q=0.011).
...
- **[ERBB2](../genes/ERBB2.md)**: Amplification; trend toward higher frequency in average-onset (20% vs 15%, P=0.16). Associated with improved survival in multivariable model (HR=0.65, P=0.01).

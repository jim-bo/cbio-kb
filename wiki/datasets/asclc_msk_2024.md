...
- **Key clinical fields:** never/light smoker status (≤10 pack-years), Ki67 proliferation index, histotype ([SCLC](../cancer_types/SCLC.md) vs carcinoid), clinical outcomes (OS, treatment response).
...
- aSCLC constitutes 3% (20/600) of de novo SCLC at MSKCC, occurring exclusively in never/light smokers (mean age 53 years vs 67 for conventional SCLC, P < 0.0001); median OS 58 months — intermediate between smoking-associated SCLC (16 months) and atypical carcinoids (184 months). [PMID:39185963](../papers/39185963.md)

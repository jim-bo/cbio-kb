...
Desmoplastic small-round-cell tumor is a rare, highly aggressive soft-tissue sarcoma characterized by the [EWSR1](../genes/EWSR1.md)–[WT1](../genes/WT1.md) fusion translocation. It predominantly affects adolescent males and typically presents in the peritoneum. It is classified under Soft Tissue Sarcoma in OncoTree (parent: [SOFT_TISSUE](../cancer_types/SOFT_TISSUE.md)). Prognosis is poor despite multimodal therapy.
...
- [EWSR1](../genes/EWSR1.md)–[WT1](../genes/WT1.md) fusion (canonical driver; not directly profiled in the UCLA PDTO study but defining molecular feature of the disease).
...
- DSRCT was included in the MAPPYACTS pediatric precision-medicine trial (sarcomas 37% of 787 patients); WES + RNA-seq identified actionable alterations in 69% of enrolled patients with recurrent [EWSR1](../genes/EWSR1.md) fusions in sarcoma oncomap [PMID:35292802](../papers/35292802.md)
...
- In a 7,494-sarcoma cohort, desmoplastic small-round-cell tumor was among the translocation-associated histologies; EWSR1 fusions with [WT1](../genes/WT1.md) and other partners were characteristic [PMID:35705558](../papers/35705558.md).
- In the 2,138-sarcoma MSK-IMPACT cohort, DSRCT had the lowest intra-subtype entropy (most genomically homogeneous), driven by the defining EWSR1–WT1 translocation [PMID:35705560](../papers/35705560.md).

...
ITGB1 (Integrin Subunit Beta 1) encodes the beta-1 integrin chain, which pairs with multiple alpha subunits to form integrin heterodimers mediating cell-extracellular matrix adhesion. In cancer, ITGB1 functions as a receptor for ECM components and paracrine signals such as SEMA7A, transducing mechanosensory and pro-invasive signals that promote EMT and cancer stem cell traits.

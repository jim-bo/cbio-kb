...
HMGCR (3-Hydroxy-3-Methylglutaryl-CoA Reductase) is the rate-limiting enzyme of the mevalonate/cholesterol biosynthesis pathway and the primary target of statin drugs. In hepatocellular carcinoma ([HCC](../cancer_types/HCC.md)), HMGCR is upregulated and contributes to cholesterol accumulation that drives TKI resistance — including remodeling of lipid rafts that upregulate drug-efflux pumps ([ABCB1](../genes/ABCB1.md)) and activation of cholesterol metabolites (25-OHC via Sonic Hedgehog, 27-OHC via [GPX4](../genes/GPX4.md)) that confer [lenvatinib](../drugs/lenvatinib.md) and [sorafenib](../drugs/sorafenib.md) resistance respectively.
...
- Whether lipophilic statin trials in HCC would outperform hydrophilic statin trials is not yet answered prospectively; the mechanism behind class-specific differences in cancer contexts remains underexplored.
- Optimal combination strategy (statin + TKI, statin + ICI, statin + SQLE inhibitor) in HCC remains undefined.

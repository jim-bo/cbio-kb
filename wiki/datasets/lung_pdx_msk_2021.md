...
- [YAP1](../genes/YAP1.md) protein was consistently absent or very low across the cohort, questioning [YAP1](../genes/YAP1.md) IHC as a defining marker for the [YAP1](../genes/YAP1.md) [SCLC](../cancer_types/SCLC.md) subtype [PMID:35440124](../papers/35440124.md).
- The MSK773 case (SCLC-P) shared somatic mutations and copy-number changes between [SCLC](../cancer_types/SCLC.md) and admixed lung adenocarcinoma components, supporting clonal origin and possible type II pneumocyte cell of origin for SCLC-P [PMID:35440124](../papers/35440124.md).

...
- In 173 EWSR1-rearranged Ewing sarcomas (147 [EWSR1](../genes/EWSR1.md)::[FLI1](../genes/FLI1.md), 26 EWSR1::[ERG](../genes/ERG.md)) profiled by MSK-IMPACT, chromoplexy occurred in 31% of cases (42% for EWSR1::ERG vs 24% for EWSR1::FLI1, P=0.03), was significantly enriched among tumors metastatic at presentation (31% vs 10%, P=0.004), and chromosome 8 gain independently predicted worse OS in localized disease (P=0.034) [PMID:38335254](../papers/38335254.md).

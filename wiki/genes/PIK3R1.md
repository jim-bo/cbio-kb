...
- Frequent mutations (10%) discovered in [GBM](../cancer_types/GBM.md), mostly in the iSH2 domain (e.g., N564, D560), which disrupt interaction with p110α and lead to RTK/RAS/PI3K pathway activation [PMID:18772890](../papers/18772890.md).
...
- Mutated in 5/145 [EAC](../cancer_types/EAC.md) tumors as part of PI3K-pathway alterations alongside [PIK3CA](../genes/PIK3CA.md) and [PTEN](../genes/PTEN.md) [PMID:23525077](../papers/23525077.md)
- Co-deleted with [PTEN](../genes/PTEN.md) in one chromoplexy chain in prostate cancer; represents PI3K-pathway disruption via structural rearrangement rather than point mutation [PMID:23622249](../papers/23622249.md)
...
- [PIK3CA](../genes/PIK3CA.md) and PIK3R1 alterations are predominantly known activating hotspots in advanced prostate cancer; one patient acquired a PIK3CA E545K hotspot ~3 years post-prostatectomy, illustrating late-emergent actionable events [PMID:28825054](../papers/28825054.md)
...
- [GBM](../cancer_types/GBM.md) — mutated in 10% of cases, primarily in the iSH2 domain, leading to PI3K pathway activation [PMID:18772890](../papers/18772890.md).
- [ODG](../cancer_types/ODG.md) / [DIFG](../cancer_types/DIFG.md) — PI3K pathway alteration in intermediate-grade IDH-mutant oligodendroglioma [PMID:37910594](../papers/37910594.md).
- Endometrial carcinoma ([UCEC](../cancer_types/UCEC.md)) — PIK3R1 mutations less frequent in Black patients (13% vs. 28%); associated with endometrioid/PTEN-co-altered PI3K pathway subtype [PMID:37651310](../papers/37651310.md).
...
- Whether PI3K-pathway mutations should upgrade IDH-mutant [LGG](../cancer_types/LGG.md) molecular grade is unresolved [PMID:37910594](../papers/37910594.md).

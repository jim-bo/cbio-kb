---
name: sunitinib
targets: [KIT, PDGFRA, VEGFR2, FLT3, CSF1R, RET]
...
Sunitinib is an oral multi-targeted receptor tyrosine kinase inhibitor (TKI) that targets [KIT](../genes/KIT.md), [PDGFRA](../genes/PDGFRA.md), VEGFR2, [FLT3](../genes/FLT3.md), [CSF1R](../genes/CSF1R.md), and [RET](../genes/RET.md). It is FDA-approved as second-line therapy for gastrointestinal stromal tumors ([GIST](../cancer_types/GIST.md)) following [imatinib](../drugs/imatinib.md) failure or intolerance, and as first-line therapy for advanced renal cell carcinoma and pancreatic neuroendocrine tumors. In [GIST](../cancer_types/GIST.md), sunitinib is particularly relevant for tumors with KIT/PDGFRA-wildtype histology (e.g., SDH-deficient or NF1-related GISTs) that do not respond to [imatinib](../drugs/imatinib.md).

## Evidence in the corpus

- Cited as a therapeutic option relevant to [GIST](../cancer_types/GIST.md) patients harboring germline P/LP variants in SDH-complex genes (SDHA/SDHB/SDHC) or [NF1](../genes/NF1.md), whose tumors are KIT/PDGFRA-wildtype and respond poorly to [imatinib](../drugs/imatinib.md); sunitinib is referenced in the context of germline-guided therapy selection in 103 GIST patients with matched tumor-germline MSK-IMPACT sequencing [PMID:36593350](../papers/36593350.md)
...
- Failed as frontline [HCC](../cancer_types/HCC.md) therapy vs [sorafenib](../drugs/sorafenib.md) (phase III): median OS 8.0–8.8 vs 9.9–10.0 months for sorafenib (HR 1.12–1.15); demonstrated inferior efficacy in first-line setting [PMID:30061739](../papers/30061739.md)
- Multi-kinase inhibitor (KIT/PDGFRA/VEGFR); proposed as therapeutic candidate for KIT-mutant [germ cell tumor](../cancer_types/germ-cell-tumor.md) alongside imatinib in Appendix Table A2 of the cisplatin-resistance biomarker study [PMID:27646943](../papers/27646943.md)
...
- In PDAC proteogenomic subtyping (n=140, [paad_cptac_2021](../datasets/paad_cptac_2021.md)), DSigDB GSEA associated sunitinib (PDGFR/VEGFR inhibitor) drug signatures with the C2 (basal-like) subtype alongside PP-242/mTOR inhibitors, nominating sunitinib as a subtype-directed strategy for C2 PDAC [PMID:34534465](../papers/34534465.md)
- In first-line PD-L1+ metastatic renal cell carcinoma, sunitinib was the comparator arm against [atezolizumab](../drugs/atezolizumab.md) plus [bevacizumab](../drugs/bevacizumab.md), which showed encouraging PFS; highly angiogenic and PBRM1-mutant tumors were proposed to benefit most from sunitinib. [PMID:29867230](../papers/29867230.md)
...
- [GIST](../cancer_types/GIST.md) — second-line after imatinib failure; particularly for SDH-deficient and NF1-related GISTs

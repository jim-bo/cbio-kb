...
YAP1 (Yes-associated protein 1) is a transcriptional co-activator and downstream effector of the Hippo signaling pathway. In gastric cancer, YAP1 signaling is perturbed by oncogenic [RHOA](../genes/RHOA.md) mutations, linking Rho GTPase biology to Hippo pathway dysregulation in diffuse-type gastric adenocarcinoma.
...
- YAP1 entirely absent in aSCLC ([RB1](../genes/RB1.md)+/TP53+ atypical [SCLC](../cancer_types/SCLC.md)) but enriched in nsSCLC-RB1-/TP53-; may serve as a distinguishing molecular marker between the two never-smoker [SCLC](../cancer_types/SCLC.md) subtypes [PMID:39185963](../papers/39185963.md)
- A chromothripsis event at the YAP1 locus drove elevated YAP1 and downstream [CDK6](../genes/CDK6.md) expression in abemaciclib-resistant MDA-MB-453 breast cancer cells, a known CDK4/6-inhibitor resistance mechanism [PMID:40379787](../papers/40379787.md).

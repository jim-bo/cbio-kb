...
- **PDL1 in [NSCLC](../cancer_types/NSCLC.md) immunotherapy:** in MSK-BPC (n=29) the OS hazard ratio for PDL1+ vs PDL1− was 0.58 (95% CI 0.11–1.1, P=0.07); in MSK-CHORD with 754 NSCLC patients on immunotherapy with PDL1 testing, HR=0.64 (95% CI 0.54–0.77, P<0.001) — same magnitude, much higher power (Fig. 2a).
- **Post-treatment alteration enrichment** confirmed in MSK-CHORD vs MSK-BPC: [ESR1](../genes/ESR1.md), [CCND1](../genes/CCND1.md) and [NF1](../genes/NF1.md) in breast cancer; [EGFR](../genes/EGFR.md) T790M and [MET](../genes/MET.md) amplifications in EGFR-mutant NSCLC; [AR](../genes/AR.md) and [TP53](../genes/TP53.md) in prostate cancer; [CHEK2](../genes/CHEK2.md), [PPM1D](../genes/PPM1D.md) and TP53 (clonal-haematopoiesis context) — all enriched in patients with prior systemic therapy as annotated by NLP, and similarly enriched among patients with institutionally administered prior therapy (Fig. 2b).
...
- **Brain-MRI surveillance** in stage IV LUAD or hormone-receptor-positive [BRCA](../cancer_types/BRCA.md): RB1 alteration could refine risk-based imaging frequency given its CNS-metastasis association.

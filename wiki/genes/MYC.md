...
- MYC frequently amplified in [HCC](../cancer_types/HCC.md); transcriptionally drives SREBP1 ([SREBF1](../genes/SREBF1.md)) to activate de novo lipogenesis; MYC-driven DNL creates metabolic vulnerability targetable by fatty acid synthesis inhibitors [PMID:38355797](../papers/38355797.md).
- MYC amplification in 20% of CAC (colitis-associated colorectal cancer); focal amplifications enriched relative to sporadic CRC; along with [KRAS](../genes/KRAS.md) amplifications, MYC amplifications distinguish CAC from sporadic CRC [PMID:36611031](../papers/36611031.md).

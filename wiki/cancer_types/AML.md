...
- **NPM1 + DNMT3A + FLT3 triple-mutant:** putative novel intermediate-risk subtype with methylation loss in CpG-sparse regions and distinct miRNA signature (high miR-10a, low miR-424). [PMID:23634996](../papers/23634996.md)
...
- No drug treatments were administered or evaluated in the TCGA AML study; the dataset ([[laml_tcga_pub]]) was released as a public resource for risk-stratification and pathogenesis research. [PMID:23634996](../papers/23634996.md)

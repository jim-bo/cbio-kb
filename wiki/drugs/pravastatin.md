...
name: pravastatin
targets: [HMGCR]
drug_class: statin / HMG-CoA reductase inhibitor (hydrophilic)
canonical_source: corpus
unverified: true
tags: [hcc, statin, cholesterol, hydrophilic, failed-trial]
...
Pravastatin is a hydrophilic statin that inhibits [HMGCR](../genes/HMGCR.md) (HMG-CoA reductase), the rate-limiting enzyme of cholesterol biosynthesis. Unlike lipophilic statins (atorvastatin, simvastatin, lovastatin), it has limited passive diffusion into tumor cells. It is not FDA-approved as an anti-cancer agent.

...
KLRD1 (CD94) encodes a C-type lectin receptor expressed on NK cells and subsets of T cells. In the corpus it appears as a pharmacodynamic marker of innate/NK-cell engagement in on-treatment tumor biopsies from an anti-PD-1 clinical trial.
...
- Whether KLRD1 upregulation reflects NK-cell infiltration versus activation of pre-existing intratumoral NK cells is not resolved in the corpus [PMID:27169994](../papers/27169994.md).

...
- In Beat [AML](../cancer_types/AML.md) ex vivo screen (409 specimens / 363 [AML](../cancer_types/AML.md) patients), [BCOR](../genes/BCOR.md) mutation alone (without [RUNX1](../genes/RUNX1.md) co-mutation) correlated with sensitivity to crizotinib (multi-kinase inhibitor), distinguishing BCOR-solo from BCOR/RUNX1 co-mutant AML which instead showed JAK-inhibitor sensitivity [PMID:30333627](../papers/30333627.md).

...
- Alterations associated with worse OS in esophageal adenocarcinoma ([EAC](../cancer_types/EAC.md)) (KM p=0.028; multivariable HR 1.61, 95% CI 1.14-2.28, p=0.007; n=487 MSK cohort); consistent with prior reports linking SMAD4 loss to disease recurrence [PMID:33795256](../papers/33795256.md)
...
- SMAD4 altered in 10% of MSI-stable esophageal adenocarcinoma ([EAC](../cancer_types/EAC.md)) patients in the MSK neoadjuvant CRT cohort (n=237); not significantly associated with pathologic treatment response [PMID:35377946](../papers/35377946.md).
...
- SMAD4 (20%) is enriched in nonhypermutated colorectal cancer, with deletion enriched in descending colon and rectal tumors, and co-deletion with [SMAD2](../genes/SMAD2.md) (3%) in 18.2% of patients [PMID:35487942](../papers/35487942.md)
...
- SMAD4 carries new TGF-beta-pathway hotspot mutations (with SMAD2/SMAD3/TCF7L2, 87% in GI cancers) and is enriched in [BRAF](../genes/BRAF.md) Class I tumors along with [TGFBR2](../genes/TGFBR2.md) [PMID:41895280](../papers/41895280.md)
...
- [ESCA](../cancer_types/ESCA.md) (EAC subtype): SMAD4 is a significantly mutated gene enriched in EAC; 18q21.2 deletion is a recurrent copy-number event in this histology. [PMID:28052061](../papers/28052061.md)

## Co-occurrence and mutual exclusivity

- In EAC, SMAD4 alteration co-occurs with other SWI/SNF complex ([ARID1A](../genes/ARID1A.md), [SMARCA4](../genes/SMARCA4.md), [PBRM1](../genes/PBRM1.md)) and PI3K-pathway alterations as part of the broader EAC genomic landscape. [PMID:28052061](../papers/28052061.md)
...
- Whether SMAD4 loss in EAC confers differential sensitivity to chemotherapy or immunotherapy compared to SMAD4-intact EAC requires prospective evaluation. [PMID:28052061](../papers/28052061.md)

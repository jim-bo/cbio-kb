...
- IDH-mutant glioma (astrocytoma, diffuse glioma) — MGMT promoter methylation assessed as a co-variable in the epigenetic evolution study; standard biomarker for TMZ response in clinical practice [PMID:38117484](../papers/38117484.md).
- [Glioblastoma (GB)](../cancer_types/GB.md) — Identified as a core pathway component and biomarker; MGMT methylation is linked to both treatment response and potential for hypermutation [PMID:18772890](../papers/18772890.md).

## Co-occurrence and mutual exclusivity

- MGMT promoter methylation commonly co-occurs with IDH1/IDH2 mutations in lower-grade gliomas (GCIMP phenotype); however, the relationship is not [absolute](../methods/absolute.md) [PMID:38117484](../papers/38117484.md).

## Therapeutic relevance

- MGMT promoter methylation predicts sensitivity to [temozolomide](../drugs/temozolomide.md); methylated MGMT tumors are expected to benefit more from alkylating chemotherapy [PMID:38117484](../papers/38117484.md).
- *MGMT* methylation serves as a biomarker for response to alkylating agents like [temozolomide](../drugs/temozolomide.md) in glioblastoma [PMID:18772890](../papers/18772890.md).

## Open questions

- The interaction between MGMT methylation status, treatment-induced [MSH6](../genes/MSH6.md) mutations, and subsequent hypermutation in recurrent gliomas is not fully characterized in this corpus.

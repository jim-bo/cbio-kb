...
Buparlisib (BKM-120) is an oral pan-class I PI3K inhibitor targeting [PIK3CA](../genes/PIK3CA.md), [PIK3CB](../genes/PIK3CB.md), [PIK3CD](../genes/PIK3CD.md), and [PIK3CG](../genes/PIK3CG.md). It was investigated clinically across multiple solid tumors but did not reach regulatory approval due to toxicity concerns (CNS effects, hepatotoxicity).
...
- [PRAD](../cancer_types/PRAD.md) — castration-resistant prostate cancer (CRPC); PI3K-pathway-altered subtype

...
- PTEN is among germline P/LP alleles tied to heritable cancer syndromes (with TP53, [NF1](../genes/NF1.md), [BRCA2](../genes/BRCA2.md), RB1) in glioma patients; identified in the longitudinal glioma cohort [PMID:31263031](../papers/31263031.md)
...
- Mutation and deletion enriched in metastases in 4 tumor types: more frequent in [SKCM](../cancer_types/SKCM.md) brain metastases (7% vs 23%, q=0.01) and in [SKCM](../cancer_types/SKCM.md) patients with brain metastasis (7% vs 14%, q=0.04); PTEN deletion more frequent in [PRAD](../cancer_types/PRAD.md) bone mets (9% vs 19%, q<0.001) and loss more frequent in PRAD liver mets (11% vs 30%, q<0.001) [PMID:35120664](../papers/35120664.md)
...
- PTEN shared between LUAD and [SCLC](../cancer_types/SCLC.md) components of the MSK773 admixed tumor (clonal event), indicating PTEN loss preceded histologic divergence in the [SCLC](../cancer_types/SCLC.md) PDX/CDX characterization study (26 clinical + 42 PDX/CDX models) [PMID:35440124](../papers/35440124.md)

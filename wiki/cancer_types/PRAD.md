...
- [CDK12](../genes/CDK12.md) alterations in 100/1,875 (5.3%) of prostate cancers sequenced by MSK-IMPACT (highest among 25 solid tumor types); CDK12-biallelic (CDK12-Bi) cases showed tandem duplicator phenotype, fewer TMPRSS2-ERG fusions and [TP53](../genes/TP53.md) mutations, and shorter [OS](../cancer_types/OS.md) from metastatic diagnosis (median 64.4 vs 74.9 mo; aHR 1.80, 95% CI 1.12-2.89; p=0.024) [PMID:32317181](../papers/32317181.md)

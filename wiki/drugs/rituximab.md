...
Rituximab is a chimeric anti-CD20 (MS4A1) monoclonal antibody that depletes CD20-positive B cells through antibody-dependent cell-mediated cytotoxicity (ADCC), complement-dependent cytotoxicity, and direct apoptosis induction. It is FDA-approved and forms the backbone of R-CHOP (rituximab, [cyclophosphamide](../drugs/cyclophosphamide.md), [doxorubicin](../drugs/doxorubicin.md), [vincristine](../drugs/vincristine.md), [prednisone](../drugs/prednisone.md)), the standard frontline regimen for diffuse large B-cell lymphoma ([DLBCLNOS](../cancer_types/DLBCLNOS.md)). R-CHOP achieves approximately 60% 3-year event-free survival; the remaining ~40% largely die of disease, motivating genomic studies to identify additional therapeutic targets.
...
- Component of R-CHOP regimen (rituximab + [cyclophosphamide](../drugs/cyclophosphamide.md) + [doxorubicin](../drugs/doxorubicin.md) + [vincristine](../drugs/vincristine.md) + [prednisone](../drugs/prednisone.md)); 85% of 304 DLBCL patients received R-CHOP-like therapy; genetic subtypes (C1-C5) predict PFS/OS on R-CHOP independent of IPI [PMID:29713087](../papers/29713087.md)
- Regimen component (e.g., R-CHOP, DA-EPOCH plus R) among the combination chemotherapy regimens documented in this mature B-cell neoplasm cohort; DA-EPOCH plus/minus R was used in 15 (5%) of patients. [PMID:36201743](../papers/36201743.md)

## Resistance mechanisms

- Approximately 40% of DLBCL patients fail R-CHOP; genomic analysis from the [dlbc_broad_2012](../datasets/dlbc_broad_2012.md) cohort implicates BCR-signaling mutations ([CD79B](../genes/CD79B.md), [CARD11](../genes/CARD11.md)), NF-kB pathway alterations ([MYD88](../genes/MYD88.md)), and epigenetic deregulation ([KMT2D](../genes/KMT2D.md)) as potential resistance drivers [PMID:22343534](../papers/22343534.md).

## Cancer types (linked)

- [DLBCLNOS](../cancer_types/DLBCLNOS.md), [CLLSLL](../cancer_types/CLLSLL.md)

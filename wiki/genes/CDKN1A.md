...
CDKN1A encodes p21, a cyclin-dependent kinase inhibitor and p53 effector that enforces G1/S cell-cycle arrest. It is recurrently altered in urothelial carcinoma.
...
- H. pylori upregulates histone demethylase [KDM4B](../genes/KDM4B.md) and drives H4 acetylation at the CDKN1A (p21) promoter, activating [PTGS2](../genes/PTGS2.md) and contributing to gastric carcinogenesis [PMID:41097736](../papers/41097736.md)
- p53–p21–[RB1](../genes/RB1.md) pathway intact in EWS::FLI1-expressing heMSCs; p21 (CDKN1A) induction limits long-term in vitro culture of transduced cells in Ewing sarcoma cell-of-origin model [PMID:41136396](../papers/41136396.md)
...
- Identified as a significantly mutated gene (SMG) in [HCC](../cancer_types/HCC.md), consistent with prior [HCC](../cancer_types/HCC.md) genomic surveys, in a European multi-omic cohort (n=122 WES) [PMID:35508466](../papers/35508466.md)

## Cancer types (linked)

- [BLCA](../cancer_types/BLCA.md) / [UTUC](../cancer_types/UTUC.md) — recurrent alteration in FGFR3-altered UC [PMID:37682528](../papers/37682528.md).

## Co-occurrence and mutual exclusivity

- Co-occurs with [FGFR3](../genes/FGFR3.md) alterations in urothelial carcinoma [PMID:37682528](../papers/37682528.md).
...
- Prognostic or predictive significance of CDKN1A alterations in FGFR3-altered UC remains undefined [PMID:37682528](../papers/37682528.md).

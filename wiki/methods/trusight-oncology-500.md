...
- TruSight Oncology 500 panel used to profile 133 young Indian [NSCLC](../cancer_types/NSCLC.md) patients (Malik et al.), finding [EGFR](../genes/EGFR.md) mutations in 35.5%, [ALK](../genes/ALK.md) rearrangements in 65.7%, [ROS1](../genes/ROS1.md) fusions in 7.25%, and [KRAS](../genes/KRAS.md) in 3.7%; the review recommends broad NGS panels like TSO500 as standard for young patients [PMID:40958859](../papers/40958859.md)

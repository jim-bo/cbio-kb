...
- **[BLCA](../cancer_types/BLCA.md):** Clonally enriched in post-chemotherapy urothelial carcinoma; the high frequency of missense (83%) mutations is consistent with potential gain-of-function alterations selected during platinum-based chemotherapy. [PMID:27749842](../papers/27749842.md)

## Co-occurrence and mutual exclusivity

- L1CAM pathway mutations co-occurred with integrin-signaling pathway enrichment (OR=2.8, FDR=0.02) in post-chemotherapy UC, suggesting coordinated cell-adhesion and integrin remodeling as a chemotherapy-resistance axis. [PMID:27749842](../papers/27749842.md)
...
- Functional impact of observed L1CAM missense mutations in UC is inferred but not validated — gain-of-function studies in UC models are needed. [PMID:27749842](../papers/27749842.md)
- Whether the CAM-DR mechanism (integrin/L1CAM-mediated resistance) is generalizable across platinum-resistant carcinomas beyond UC remains an open question. [PMID:27749842](../papers/27749842.md)

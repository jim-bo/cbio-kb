...
- **TBL1XR1 not prognostic under SOC:** In an independent cohort of 177 MSK PCNSLs treated with standard of care, TBL1XR1 status was not associated with outcome, suggesting predictive rather than prognostic value for [ibrutinib](../drugs/ibrutinib.md).

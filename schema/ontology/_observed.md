...
- drug: t-5224 — observed in PMID:35617398 — note: c-Fos/AP-1 DNA-binding inhibitor; selectively reduced proliferation of CRPC-SCL (YAP/TAZ/AP-1-driven) prostate cancer models; investigational compound not yet in clinical trials for prostate cancer; not found in any canonical drug ontology
- method: swath-ms — observed in PMID:35508466 — note: data-independent acquisition mass spectrometry for proteome quantification (hcc_meric_2021, n=51 HCC biopsies, 6,167 proteins); not in gene_panels.json
...
- method: conditional-ddpm — observed in PMID:37646491 — note: conditional denoising diffusion probabilistic model for CBCT-to-synthetic-CT image translation in adaptive radiotherapy; no gene-panel ID; radiotherapy imaging methods paper only
- method: cone-beam-ct — observed in PMID:37646491 — note: CBCT imaging modality used in online adaptive radiotherapy; no gene-panel ID; radiotherapy imaging methods paper only
- method: cycle-gan — observed in PMID:37646491 — note: Cycle GAN baseline image-translation model for CBCT-to-CT synthesis; no gene-panel ID; radiotherapy imaging methods paper only
- method: dna-methylation-sequencing — observed in PMID:37119971 — note: genome-wide bisulfite sequencing for epigenomic profiling; reviewed as core epigenomics modality in multi-omics integration; not tied to a specific gene panel
- method: lipidomics — observed in PMID:37119971 — note: mass-spectrometry-based lipid profiling reviewed as an omics modality in multi-omics integration for precision health; no gene-panel ID; corpus-grown slug
...
- cancer_type: germ-cell-tumor — observed in PMID:27646943, PMID:35585047, PMID:36862133, PMID:37990009, PMID:41895280 — note: corpus umbrella for germ cell tumors reported without a site or histology; mirrors the OncoTree main type "Germ Cell Tumor", which has no code (its codes are site-specific: NSGCT/SEM under TESTIS, OGCT, EGCT, BGCT, VGCT). Replaces the earlier misuse of GCT, which in OncoTree is Granular Cell Tumor (parent SELT); pancan_pdx_uthsa_2023 sample data also labels germ cell tumors GCT
- cancer_type: TGCT — observed in PMID:29617662, PMID:29622463, PMID:29625048, PMID:29625050, PMID:29625055, PMID:32214244, PMID:34059130, PMID:36001024 — note: TCGA project abbreviation for testicular germ cell tumors; collides with OncoTree TGCT (Tenosynovial Giant Cell Tumor Diffuse Type, parent SOFT_TISSUE). wiki/cancer_types/TGCT.md holds the TCGA testicular content under this colliding code (unverified: true)

...
- SMAD4 LOF mutations independently associated with reduced OS in metastatic disease (multivariate HR 2.11, p = 0.012); [STK11](../genes/STK11.md) LOF mutations also independently associated with reduced OS (multivariate HR 3.76, p = 0.004) [PMID:36228155](../papers/36228155.md).

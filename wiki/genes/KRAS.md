...
- Endometrial carcinoma: KRAS oncogenic alterations less frequent in Black patients (12% vs 21% in White patients); the difference is driven by fewer endometrioid ECs in Black patients (MSK, 259 Black vs 1,276 White EC patients) [PMID:37651310](../papers/37651310.md).
...
- KRAS G12V mutation engineered in the A1309 CRC cell model used for [FBXO7](../genes/FBXO7.md) synthetic lethality screening [PMID:40896366](../papers/40896366.md)
...
- Mutated in 5/145 (3%) of esophageal adenocarcinomas ([EAC](../cancer_types/EAC.md)); 3 mutations at canonical p.G12 plus p.K117N (known transforming allele); KRAS/BRAF pathway mutations are uncommon in [EAC](../cancer_types/EAC.md) contrasting with colorectal cancer [PMID:23525077](../papers/23525077.md)
...
- Gain-of-function mutation identified in ovarian mixed neuroendocrine-non-neuroendocrine neoplasm (MiNEN) PN19 in a WGTA study of rare metastatic neuroendocrine neoplasms [PMID:40328872](../papers/40328872.md)
...
- KRAS activating mutations are rare in [HCC](../cancer_types/HCC.md) (~1%; 4.4% of 1,318 ctDNA samples in BEAMing screening); a biomarker-enriched phase II of [refametinib](../drugs/refametinib.md) + [sorafenib](../drugs/sorafenib.md) in 16 RAS-mutant patients reported median [OS](../cancer_types/OS.md) 12.7 months. [PMID:30061739](../papers/30061739.md)
...
- KRAS activating mutations (G12D, G12V, Q61H) in 24–27% intrahepatic and 37–46% extrahepatic CCA; G12/G13 alterations predict poor prognosis; synergizes with [ARID1A](../genes/ARID1A.md) loss to drive cholangiocarcinogenesis [PMID:41008893](../papers/41008893.md)
...
- KRAS cited in the context of murine KRAS/p53 knockout cholangiocarcinoma models that inadequately recapitulate human cholestatic CCA pathophysiology; humanized or organoid systems proposed as alternatives. [PMID:41018102](../papers/41018102.md)
...
- KrasG12D knock-in by AAV-CRISPR HDR in rats yielded ER+/PR+ ductal carcinoma with papillary features at ~70-day median latency; the same edit in mice produced ER-/PR- metaplastic tumors with squamous differentiation, illustrating species-specific lineage plasticity — KRAS is not commonly mutated in human breast cancer [PMID:41000773](../papers/41000773.md)
...
- n=25 KRAS mutations in pan-glioma TCGA cohort (n=1122); confirmed as a recurrently mutated Ras-pathway oncogene in human glioma, previously known mainly from engineered mouse models; co-occurs with [NRAS](../genes/NRAS.md) (n=5) [PMID:26824661](../papers/26824661.md)
- KRAS mutations occur collectively with [NRAS](../genes/NRAS.md) and [HRAS](../genes/HRAS.md) in 28% of PDTC and 24% of ATC; RAS mutations are mutually exclusive with [BRAF](../genes/BRAF.md) V600E and gene fusions; RAS-mutant PDTCs trend toward distant metastasis [PMID:26878173](../papers/26878173.md)
...
- Co-occurs with activating [PPP3CA](../genes/PPP3CA.md) mutations (p=0.033) in lung ADC in the TCGA pan-lung cohort; KRAS is a key Ras/Raf/RTK pathway driver considered when calculating the 76% actionable-driver fraction in lung ADC [PMID:27158780](../papers/27158780.md)
...
- KRAS mutations are under-represented in young-onset lung cancer (~9% in <40 yrs vs ~30% in 60-69 yrs); G12C and G12D dominate in the few KRAS-mutant young cases; Indian YLC data (Malik et al., n=133) showed 3.7% KRAS mutation rate [PMID:40958859](../papers/40958859.md)
...
- KRAS Q61H and G12C activating mutations identified in pediatric ALL and neuroblastoma ([NBL](../cancer_types/NBL.md)) as MEK-inhibitor targets; KRAS V14I also co-occurred with [STAT5B](../genes/STAT5B.md) I704L and [JAK1](../genes/JAK1.md) K1026E in T-BLL [PMID:28007021](../papers/28007021.md).
- KRAS amplified in subsets of esophageal adenocarcinoma ([EAC](../cancer_types/EAC.md)) alongside [ERBB2](../genes/ERBB2.md), [EGFR](../genes/EGFR.md), [IGF1R](../genes/IGF1R.md), and [VEGFA](../genes/VEGFA.md) amplifications in a multi-platform genomic characterization of gastroesophageal adenocarcinoma [PMID:28052061](../papers/28052061.md).
- 218 patients with KRAS mutations in prospective [LUAD](../cancer_types/LUAD.md) cohort (860 patients, MSK-IMPACT); codon 12 dominant; codon 61 in 12/235 (5%) of KRAS-mutated tumors; only 0.9% (2/218) received matched therapy; mutually exclusive with [EGFR](../genes/EGFR.md) (p<0.0001) [PMID:28336552](../papers/28336552.md)
...
- 6/23 (26%) endometrial polyps harbored low-VAF KRAS hotspot mutations including G12V and G13V; one sample bore both on independent reads; may indicate precursor lesion biology [PMID:41137179](../papers/41137179.md)
- Driver SNVs targeted in [LUAD](../cancer_types/LUAD.md) ctDNA panels; KRAS amplification (>15 copies) identified as an ancestral subclonal event driving lymph-node residual disease in patient CRUK0013 that responded to adjuvant chemoradiotherapy; SNV status not associated with pre-operative ctDNA detection rate within LUADs [PMID:28445469](../papers/28445469.md)
...
- Second most altered gene in a 62-tumor-type pan-cancer cohort (15% overall); G12 codon dominates (80% of KRAS mutations); 90% mutation rate in [PAAD](../cancer_types/PAAD.md), 44% in [COAD](../cancer_types/COAD.md); limited clinical actionability noted with then-available drugs [PMID:28481359](../papers/28481359.md)
- Assessed in the 7-gene cross-histology panel for clear-cell endometrial carcinoma; mutations enriched in endometrioid-like ([UEC](../cancer_types/UEC.md)) molecular profile subgroup [PMID:28485815](../papers/28485815.md)
...
- Recurrently focally amplified SCNA in MIBC (n=412, TCGA [BLCA](../cancer_types/BLCA.md) 2017). [PMID:28988769](../papers/28988769.md)
- Oncogenic alterations in 16% of CIN gastroesophageal cancer tumors; acquired activating co-mutations enriched post-trastuzumab progression (2% pre vs 13% post; associated with intrinsic and acquired [trastuzumab](../drugs/trastuzumab.md) resistance). [PMID:29122777](../papers/29122777.md)
- Mutated in 44% of MSS metastatic CRC; hotspot mutations are OncoKB Level 1 resistance markers for anti-EGFR antibodies; enriched in right-sided primaries; HR=1.40 for [OS](../cancer_types/OS.md) in multivariate analysis [PMID:29316426](../papers/29316426.md)
- Mutated in 83 [NSCLC](../cancer_types/NSCLC.md) patients (34%); KRAS mutation alone did not stratify durable clinical benefit to anti-PD-(L)1 therapy; DCB rate 36%, comparable to overall cohort [PMID:29337640](../papers/29337640.md)
- Cited as a comparator oncogenic driver with approved targeted therapies achieving higher response rates than [neratinib](../drugs/neratinib.md) in HER2-mutant disease; not a qualifying alteration in the SUMMIT basket trial [PMID:29420467](../papers/29420467.md)
...
- KRAS established hotspot mutations newly reach statistical significance (SMG status) in prostate cancer in the 1,013-sample WES meta-cohort ([prad_p1000](../datasets/prad_p1000.md)); RAS/RAF/MAPK pathway altered in 5% of [PRAD](../cancer_types/PRAD.md) overall. [PMID:29610475](../papers/29610475.md)
- KRAS shows strong mutual exclusivity with NRAS/HRAS and [BRAF](../genes/BRAF.md) V600 within Ras signaling across nearly all 33 TCGA tumor types; KRAS/NRAS/HRAS are among the most frequently predicted neoantigens; KRAS is mutually exclusive with [TP53](../genes/TP53.md) in COAD/READ/LUAD but co-occurs with [TP53](../genes/TP53.md) in [PAAD](../cancer_types/PAAD.md) [PMID:29625049](../papers/29625049.md)
- KRAS is the most-altered RTK-RAS gene pan-cancer (9% of TCGA); hotspot mutations dominate and are concentrated in [PAAD](../cancer_types/PAAD.md) (72%), colorectal genomically-stable (69%), and [LUAD](../cancer_types/LUAD.md) (33%); KRAS mutation is mutually exclusive with [EGFR](../genes/EGFR.md) amplification and NF1/RASA1 loss [PMID:29625050](../papers/29625050.md)
- KRAS enriched in extrahepatic cholangiocarcinoma (EHC) vs intrahepatic (38% vs 7%); associated with shorter [OS](../cancer_types/OS.md) in advanced disease (p=0.026); mutually exclusive with [IDH1](../genes/IDH1.md), [BAP1](../genes/BAP1.md), and [PBRM1](../genes/PBRM1.md). [PMID:29848569](../papers/29848569.md)
...
- KRAS mutation status discussed in context of PD-1 blockade response in lung adenocarcinoma; no distinct KRAS-specific association found beyond TP53/TMB signal in this combination PD-1+CTLA-4 immunotherapy cohort (n=75 [NSCLC](../cancer_types/NSCLC.md)). [PMID:29657128](../papers/29657128.md)
- Clonal hotspot mutations enriched in CR/PR responders across cancer types in a pooled ICB cohort (193 patients); association with response persisted after TMB correction (p<0.05, logistic regression) but did not survive FDR correction (q=0.18); KRAS-mutant smoker-signature [NSCLC](../cancer_types/NSCLC.md) tumors constitute a favorable ICB subgroup [PMID:30150660](../papers/30150660.md)
- KRAS mutations predicted MAPK-inhibitor sensitivity ex vivo in the Beat [AML](../cancer_types/AML.md) cohort ([aml_ohsu_2018](../datasets/aml_ohsu_2018.md)); sensitivity association weaker than [NRAS](../genes/NRAS.md) [PMID:30333627](../papers/30333627.md)
...
- KRAS mutations observed in histiocytic neoplasms: R149G (single-mutation [ECD](../cancer_types/ECD.md) patient), G12R and G13C (compound-mutation patients); all KRAS-mutant patients responded to [cobimetinib](../drugs/cobimetinib.md) MEK inhibition [PMID:30867592](../papers/30867592.md)
- Listed as a classic colorectal cancer SMG in a CPTAC proteogenomic colon cancer cohort (n=110); [BRAF](../genes/BRAF.md) and [POLE](../genes/POLE.md) mutations enriched in the MSI-H/hypermutated subgroup of this cohort [PMID:31031003](../papers/31031003.md)
...
- 62% of rectal cancer tumoroids were RAS mutant; KRAS-mutant tumoroids exhibited cell-autonomous resistance to [cetuximab](../drugs/cetuximab.md) ex vivo, mirroring the established clinical finding that KRAS mutation predicts anti-EGFR-antibody resistance in CRC [PMID:31591597](../papers/31591597.md).
- RAS pathway mutations (KRAS, [NRAS](../genes/NRAS.md), [HRAS](../genes/HRAS.md)) enriched in BCP-ALL and Fusion-negative [RMS](../cancer_types/RMS.md) PDX models in the PPTC pediatric cancer panel (261 models, 37 pediatric cancer types) [PMID:31693904](../papers/31693904.md).
...
- KRAS mutation was used as a prognostic covariate in the Mutation model Cox comparator in Sherlock-Lung non-smoking [LUAD](../cancer_types/LUAD.md) (n=232) [PMID:40970133](../papers/40970133.md)
...
- KRAS mutated in 8% of 119 [UTUC](../cancer_types/UTUC.md) patients by MSK-IMPACT, as part of the recurrent RTK/RAS/PI3K-pathway driver landscape that also includes [HRAS](../genes/HRAS.md) (15%), [PIK3CA](../genes/PIK3CA.md) (14–16%), and [TSC1](../genes/TSC1.md) (14%) [PMID:32332851](../papers/32332851.md)
- G12D (activating), Q61L pathogenic mutation in resistant HR+/HER2- [MBC](../cancer_types/MBC.md) biopsies; KRAS G12D overexpression confers CDK4/6i resistance in vitro; ERK inhibition (LY3214996) restores sensitivity; spontaneous KRAS G12V acquired in resistant cell line 361-AR-1 [PMID:32404308](../papers/32404308.md)
- RTK-RAS pathway co-alterations in HER2-positive metastatic esophagogastric cancer associated with significantly shorter PFS (median 5.9 vs 14.6 months, p=0.011) on [pembrolizumab](../drugs/pembrolizumab.md) + [trastuzumab](../drugs/trastuzumab.md) + chemotherapy [PMID:32437664](../papers/32437664.md)
- Mutant [LUAD](../cancer_types/LUAD.md) tumors showed outlier [SOS1](../genes/SOS1.md) S1161 phosphorylation, hyperphosphorylated [PRKCD](../genes/PRKCD.md), MAPK1/TAK1 pathway activation, upregulation of complement/coagulation cascades; [SOS1](../genes/SOS1.md) inhibition nominated as therapeutic strategy; [PRKCD](../genes/PRKCD.md) nominated as druggable kinase in KRAS-mutant LUAD [PMID:32649874](../papers/32649874.md)
...
- Strongly enriched in C-terminal [APC](../genes/APC.md) mutant mCRC tumors vs N-terminal (72% vs 46%; p<0.001, q<0.01) in 430 MSS unresectable mCRC patients treated with first-line chemotherapy at MSK; part of co-occurring RAS pathway activation pattern associated with poorer prognosis. [PMID:32730818](../papers/32730818.md)
- KRAS — activating mutations (G12S, G12D) observed as shared truncal precursor alterations in 63% of germ cell tumor / hematologic malignancy pairs vs 13% of de novo [AML](../cancer_types/AML.md); supports clonal ancestry from a shared embryonal precursor [PMID:32897884](../papers/32897884.md)
...
- Activating mutations in 10% of 412 intrahepatic cholangiocarcinoma tumors ([ihch_msk_2021](../datasets/ihch_msk_2021.md)); associated with shorter [OS](../cancer_types/OS.md) (multivariable HR 1.69, 95% CI 0.97–2.93, P=0.06 in resected; independent predictor in unresectable); correlated with perineural invasion and large bile-duct histotype [PMID:33765338](../papers/33765338.md)
- KRAS amplification found in esophagogastric adenocarcinoma ([egc_mskcc_2020](../datasets/egc_mskcc_2020.md)); one of 16 recurrent oncogenic drivers (≥5% prevalence); independently associated with worse [OS](../cancer_types/OS.md) (multivariable HR 1.83, 95% CI 1.31–2.55, P<0.001) [PMID:33795256](../papers/33795256.md)
- Subclonal A59G mutation identified in one TERT-altered metaplastic breast cancer in a 60-case multi-institutional cohort [PMID:33863915](../papers/33863915.md)
- [TP53](../genes/TP53.md) and KRAS mutations together form a 'high-risk' composite alteration set (with CDKN2A/B deletion) associated with worse OS in node-positive intrahepatic cholangiocarcinoma (N1 median OS 12.1 months vs 30.9 months for wild-type, P=0.002) [PMID:33963001](../papers/33963001.md)
- Recurrent driver in [NSCLC](../cancer_types/NSCLC.md) detected by MSK-ACCESS cfDNA assay; KRAS p.G12S in a lung adenocarcinoma case was reclassified from somatic to clonal hematopoiesis using matched WBC sequencing plus fragment-length evidence [PMID:34145282](../papers/34145282.md)
...
- KRAS cited as a canonical [HGSOC](../cancer_types/HGSOC.md) oncogene commonly overexpressed via CNA-driven aneuploidy; [AKT1](../genes/AKT1.md) and [MYC](../genes/MYC.md) co-listed; appears in curvature-ranked gene lists in a 45-patient [HGSOC](../cancer_types/HGSOC.md) ICI cohort. [PMID:34819508](../papers/34819508.md)
- KRAS activating mutations (e.g., G12V) found in 0.3% of both metastatic and primary HER2-amplified breast cancers (n=733); G12V phenocopies [NF1](../genes/NF1.md) loss in driving resistance to lapatinib/tucatinib and confers MEK sensitization (IC50 16–24 nM [trametinib](../drugs/trametinib.md)). [PMID:34795269](../papers/34795269.md)
- RAS-pathway mutations (KRAS, [NRAS](../genes/NRAS.md), [PTPN11](../genes/PTPN11.md)) identified among transformation drivers in pediatric neuroblastoma patients who developed therapy-related AML/MDS; patient 118728 had multiple RAS-pathway hits [PMID:35078859](../papers/35078859.md)
- Mutated in 1/13 (8%) tubular adenomas vs. 2/2 tubulovillous adenomas by WES; 5% to 42% frequency from TA to TVA in 281 polyps; 35% of MSS CRCs vs. 0% of MSI-H CRCs, marking KRAS as a key driver of the conventional adenoma-to-carcinoma MSS pathway [PMID:34910928](../papers/34910928.md)
- Mutations more frequent in pancreatic neuroendocrine metastases (1% vs 10%, q=0.03); 12p gain (encompassing KRAS) more frequent in [PAAD](../cancer_types/PAAD.md) metastases (17% vs 4%, q=0.002); MSS [COAD](../cancer_types/COAD.md) patients with lung metastasis had higher KRAS mutation frequency (39% vs 52%, q<0.001) [PMID:35120664](../papers/35120664.md)
- Enriched in Nigerian MSS colorectal tumors (RAS pathway 76.1% vs. 59.6% MSKCC, P=0.03); 61.1% in Nigerian MSI-H tumors (vs. 41.1% MSKCC, P=0.20), suggesting a distinct mutational landscape in West African CRC patients [PMID:34819518](../papers/34819518.md)
- In colorectal cancer with dual MAPK drivers (CRC-DD, n=47/4,561 MSK-IMPACT cases), KRAS is the most frequently mutated gene: G12D (43%), G13D (36%), G12V (23%), G12C (13%), A146T (11%); subclonal KRAS mutations are enriched in CRC-DD vs single-driver CRC, with allelic imbalance detected in 21/65 KRAS instances [PMID:35235413](../papers/35235413.md).
- In the MAPPYACTS pediatric precision oncology trial, RAS family mutations (KRAS/NRAS/HRAS, n=42 total) were classified as investigational-tier actionable alterations matched to MEK inhibitors, but deliberately not designated as ready-for-routine-use given limited MEK inhibitor clinical activity in pediatric RAS-mutant tumors [PMID:35292802](../papers/35292802.md).
- In RET-fusion [NSCLC](../cancer_types/NSCLC.md) patients treated with [selpercatinib](../drugs/selpercatinib.md), KRAS G12D/G12V pre-existing subclonal mutations in plasma conferred primary resistance; acquired KRAS G12A/G12R/G12V, G13D, and A59del mutations emerged at progression as off-target bypass resistance mechanisms [PMID:35304457](../papers/35304457.md).
- KRAS amplification was detected in 19% of MSI-stable esophageal adenocarcinoma patients in the neoadjuvant chemoradiotherapy cohort (n=237) but was not significantly associated with pathologic response [PMID:35377946](../papers/35377946.md).
- KRAS amplifications were identified in two atypical TP53/RB1-wildtype [SCLC](../cancer_types/SCLC.md) clinical samples (co-occurring with [MDM2](../genes/MDM2.md) amplification) and in ~15% of [SCLC](../cancer_types/SCLC.md) PDX models; KRAS amplification was shared between [SCLC](../cancer_types/SCLC.md) and adenocarcinoma components of the MSK773 admixed tumor, supporting a common clonal origin [PMID:35440124](../papers/35440124.md).
- Hotspot mutations in 33% (39/119) of low-grade serous ovarian carcinoma ([LGSOC](../cancer_types/LGSOC.md)) patients; G12V is the most frequent variant (n=19); enriched in age >50 (p=0.03) and platinum-sensitive disease (p=0.04); MAPK pathway alteration (including KRAS) is an independent favorable prognostic factor for OS (multivariate HR 2.5 for absence vs presence, p=0.019) [PMID:35443055](../papers/35443055.md).
- Concomitant amplification and overexpression detected in two pediatric/young adult cancer patients (H135462, H195916) by cWGTS without informative clinical biomarkers on panel testing; MSK-IMPACT missed the amplification, demonstrating lower copy-number sensitivity of panel assays [PMID:35585047](../papers/35585047.md).
- KRAS G12X mutations are present in 0.9% of sarcomas in the MSK sarcoma genomic profiling cohort (n=7,494, FoundationOne CDx); their rarity suggests they may flag sarcomatoid carcinoma rather than true mesenchymal neoplasms [PMID:35705558](../papers/35705558.md)
- KRAS/NRAS ('RAS') mutations correlated with Monocyte-like [AML](../cancer_types/AML.md) cell state in the Beat [AML](../cancer_types/AML.md) cohort (n=942); confer greater sensitivity to STE7/MEK inhibitors (expected) and to CDK-family inhibitors (unexpected) [PMID:35868306](../papers/35868306.md)
- 18% pan-cohort frequency (second most common after [TP53](../genes/TP53.md)) across 10,194 Asian solid-tumor patients; G12 hotspot predominant; significantly elevated in [IHCH](../cancer_types/IHCH.md) vs MSK; KRAS G12C in 2.7% of NSCLC ([sotorasib](../drugs/sotorasib.md) Level 1); unusual pairwise co-occurrence with [EGFR](EGFR.md) noted (atypical for Western LUAD) [PMID:35871175](../papers/35871175.md)
- Oncogenic alterations in 42% (274/652) of pMMR/MSS rectal cancer patients, mostly clonal at G12/G13; G12C in 2% (Level 3A); associated with borderline shorter DFS overall (p=0.04) and significantly shorter DFS in CRT-CNCT–treated patients (p=0.004); KRAS-/PIK3CA-mutant co-occurring tumors show elevated [CA9](../genes/CA9.md) (hypoxia marker) [PMID:35970919](../papers/35970919.md)
...
- KRAS amplification co-localized to chromothriptic chromosome 12q12 in a subset of atypical [SCLC](../cancer_types/SCLC.md) (aSCLC); KRAS canonical driver mutations found in 6% of never-smoker [RB1](../genes/RB1.md)−/TP53− [SCLC](../cancer_types/SCLC.md), anchoring the adenocarcinoma-to-SCLC plasticity pathway — absent in aSCLC. [PMID:39185963](../papers/39185963.md)
...
- In a pancreatic cancer nivolumab/chemotherapy trial, KRAS mutation frequency was balanced across treatment arms and did not explain the [nivolumab](../drugs/nivolumab.md) plus chemotherapy survival benefit [PMID:35662283](../papers/35662283.md).
- KRAS was a de novo co-driver in 6 NSCLC and 9 non-lung MET-amplified tumors, and one NSCLC acquired [MET](../genes/MET.md) amplification while on therapy for KRAS G12C [PMID:36044468](../papers/36044468.md).
...
- Whether KRAS mutations in dMMR gynecologic cancers are bystander events (passenger due to MSI) or functional drivers of immune evasion requires investigation [PMID:38653864](../papers/38653864.md).
- The VTE risk associated with KRAS ctDNA detection appears independent of specific genomic content by multivariate analysis, suggesting a general cancer burden signal rather than KRAS-specific thrombogenicity [PMID:39147831](../papers/39147831.md).
- How KRAS mutant-allele dosage gains in PDAC modify response to novel pan-RAS / KRAS-allele-specific inhibitors (e.g., RMC-6236) is unknown; clinical-trial cohorts stratified by dosage are needed. [PMID:39753968](../papers/39753968.md)
- Whether the ctDNA-detected KRAS in metastatic urothelial carcinoma (CALGB 90601) represents tumor shedding rather than a specific clonal driver event in that cancer type requires further investigation. [PMID:40256659](../papers/40256659.md)

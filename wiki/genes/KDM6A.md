...
- KDM6A was among the genes frequently co-altered with [FGFR3](../genes/FGFR3.md) in urothelial carcinoma in the MSK [bladder_msk_2023](../datasets/bladder_msk_2023.md) cohort, alongside [CDKN2A](../genes/CDKN2A.md) and [CDKN2B](../genes/CDKN2B.md) [PMID:37682528](../papers/37682528.md).
...
- Missense mutation in 7% of [ACC](../cancer_types/ACC.md) samples; loss of H3K27me3 demethylase activity confirmed in vitro; identified as a CHASM driver in ACC [PMID:23685749](../papers/23685749.md)
...
- KDM6A mutated in 2/21 (9%) of sinonasal adenoid cystic carcinoma cases with frameshift and splice-site variants (c.2172_2173del + c.618-619+2del in one case; c.64del in a second case) [PMID:39760648](../papers/39760648.md)
...
- Added to the significantly-mutated gene list in periampullary tumors by an inactivation-bias statistical test (alongside [PBRM1](../genes/PBRM1.md) and [RECQL4](../genes/RECQL4.md)); recurrently inactivated across ampullary, duodenal, and distal bile-duct adenocarcinoma cohort (n=160) [PMID:26804919](../papers/26804919.md)
- Recurrent chromatin-regulator mutation in adenoid cystic carcinoma (ACC; n=25 WGS); co-occurs with [KMT2C](../genes/KMT2C.md), [KMT2D](../genes/KMT2D.md), and SMARCA2/SMARCC1 mutations, consistent with a broader chromatin-remodeling axis in ACC pathogenesis [PMID:26862087](../papers/26862087.md)
...
- KDM6A M997fs frameshift identified in pediatric medulloblastoma ([MBL](../cancer_types/MBL.md)) as a prognostic marker for risk-stratification into group 4 [PMID:28007021](../papers/28007021.md).
- KDM6A (UTX) histone-modifier alterations frequent in esophageal squamous cell carcinoma ([ESCC](../cancer_types/ESCC.md)), especially in the ESCC2 molecular subtype; co-altered with KMT2D and KMT2C [PMID:28052061](../papers/28052061.md).
...
- Recurrent histone-methylation-modifier mutations in medulloblastoma; KDM6A especially enriched in methylation subtype VIII alongside [ZMYM3](../genes/ZMYM3.md) [PMID:28726821](../papers/28726821.md)
- Histone demethylase SMG in MIBC (n=412); recurrent inactivating mutations plus 4.9% focal deletions; loss implicates BRD4-EZH2 signaling dependence and sensitivity to JQ1 and [EZH2](../genes/EZH2.md) inhibition; also a MutCN cluster definer. [PMID:28988769](../papers/28988769.md)
- KDM6A is among the epigenetic regulators ([ARID1A](../genes/ARID1A.md), KMT2C, KMT2D, KDM6A) mutated collectively in 73% (11/15) of patient-derived bladder cancer organoid lines in the Columbia/MSK biobank [PMID:29625057](../papers/29625057.md)
- KDM6A is recurrently mutated in upper tract urothelial carcinoma ([UTUC](../cancer_types/UTUC.md)) at a frequency not significantly different from TCGA muscle-invasive bladder cancer, confirming shared chromatin-modifier landscape [PMID:31278255](../papers/31278255.md).
...
- KDM6A mutated in 38% of 119 upper tract urothelial carcinoma (UTUC) patients by MSK-IMPACT, making it the second most common alteration after [FGFR3](../genes/FGFR3.md) (47–48%); KDM6A mutations were enriched in chromatin-remodeling gene co-alterations including KMT2D, ARID1A, [CREBBP](../genes/CREBBP.md), and [STAG2](../genes/STAG2.md) [PMID:32332851](../papers/32332851.md)
- Mutated in 27% of WES UTUC cases (FDR=1.03×10⁻³); co-occurs with [ZFP36L1](../genes/ZFP36L1.md) (LOR=3.1, P=0.03) in upper tract urothelial carcinoma. [PMID:33397444](../papers/33397444.md)
...
- One of several epigenetic modifiers (with [IDH1](../genes/IDH1.md), [IDH2](../genes/IDH2.md), [ASXL1](../genes/ASXL1.md), [BCOR](../genes/BCOR.md), [PHF6](../genes/PHF6.md)) differentially enriched between HOXA and HOXB expression groups in pediatric [AML](../cancer_types/AML.md) [PMID:38212634](../papers/38212634.md).
- KDM6A was altered in at least 10% of bladder cancer specimens (S1314 cohort), among the genes most frequently mutated after [TERT](../genes/TERT.md) promoter and [TP53](../genes/TP53.md) [PMID:39499893](../papers/39499893.md).
...
- [BLCA](../cancer_types/BLCA.md) / [UTUC](../cancer_types/UTUC.md) — recurrent co-alteration with [FGFR3](../genes/FGFR3.md) [PMID:37682528](../papers/37682528.md).
- [MNG](../cancer_types/MNG.md) — novel recurrent driver in MG3/MG4 molecular groups (chromatin remodeling role) [PMID:34433969](../papers/34433969.md).
- [PRAD](../cancer_types/PRAD.md) — deep deletion in NEPC PDX model [PMID:38488813](../papers/38488813.md).

## Co-occurrence and mutual exclusivity

- Frequently co-altered with [FGFR3](../genes/FGFR3.md), [CDKN2A](../genes/CDKN2A.md), and [CDKN2B](../genes/CDKN2B.md) in urothelial carcinoma [PMID:37682528](../papers/37682528.md).
- Co-altered with [CHD2](../genes/CHD2.md) and [PTEN](../genes/PTEN.md) as chromatin remodeling drivers in MG3/MG4 meningiomas [PMID:34433969](../papers/34433969.md).
...
- Whether KDM6A loss modifies [erdafitinib](../drugs/erdafitinib.md) response in FGFR3-altered UC is unresolved [PMID:37682528](../papers/37682528.md).

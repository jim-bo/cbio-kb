...
- EGFR amplification is a recurrent driver at ≥5% in esophageal/GEJ adenocarcinoma ([egc_mskcc_2020](../datasets/egc_mskcc_2020.md), n=487); no independent OS association demonstrated in this cohort [PMID:33795256](../papers/33795256.md).
...
- **Esophageal/gastroesophageal junction adenocarcinoma ([EAC](../cancer_types/EAC.md)):** amplification at ≥5% frequency; co-occurs with [MYC](../genes/MYC.md), [VEGFA](../genes/VEGFA.md), [CDK6](../genes/CDK6.md), and [CCND3](../genes/CCND3.md) amplifications; no independent OS association [PMID:33795256](../papers/33795256.md).
...
- Convergent activation of [PTPN11](../genes/PTPN11.md) and [PLCG1](../genes/PLCG1.md) downstream of EGFR (and [PDGFRA](../genes/PDGFRA.md)) suggests these as alternative therapeutic targets in EGFR-altered [GBM](../cancer_types/GBM.md) [PMID:33577785](../papers/33577785.md).

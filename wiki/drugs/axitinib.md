...
targets:
  ...
  - FLT1
  - FLT4
drug_class: selective VEGFR inhibitor (TKI)
...
Axitinib is a selective inhibitor of vascular endothelial growth factor receptors VEGFR1 (FLT1), VEGFR2 ([KDR](../genes/KDR.md)), and VEGFR3 ([FLT4](../genes/FLT4.md)), approved for second-line treatment of renal cell carcinoma. It is used in combination with immune checkpoint inhibitors (e.g., [avelumab](../drugs/avelumab.md)+axitinib in the JAVELIN Renal 101 trial) for first-line ccRCC.
...
- clear cell renal cell carcinoma ([CCRCC](../cancer_types/CCRCC.md))

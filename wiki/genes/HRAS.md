...
- Cited as prior lenti-HrasQ61L mammary intraductal model: produces ER-/metaplastic tumors in mice but ER+/PR+ ductal carcinoma in rats, providing historical evidence of species-specific lineage plasticity motivating CRISPR-based ER+ breast cancer modeling [PMID:41000773](../papers/41000773.md)
...
- Cooperating alteration enriched in BRAF Class III pan-cancer tumors, alongside NF1. [PMID:41895280](../papers/41895280.md)

## Cancer types (linked)

- [ANGS](../cancer_types/ANGS.md) — HRAS hotspot mutations enriched in RT-AS (14%) vs sporadic AS (2%); implicated in both the stress-activated MAPK cascade and VEGF/VEGFR signaling pathways [PMID:37350195](../papers/37350195.md).
- [CESC](../cancer_types/CESC.md) — HRAS is part of the RAS/PIK3CA pathway alteration landscape assessed in 177 cervical cancer patients at MSK; no specific HRAS frequency reported separately [PMID:37643132](../papers/37643132.md).
- [RMS](../cancer_types/RMS.md) — HRAS is among RAS pathway drivers in FN-RMS (5/17 patients with RAS/PIK3CA pathway alterations) [PMID:37730754](../papers/37730754.md).

## Co-occurrence and mutual exclusivity

- Co-occurs with [MYC](../genes/MYC.md) amplification, [FLT4](../genes/FLT4.md) amplification, [CRKL](../genes/CRKL.md) amplification, and [KMT2D](../genes/KMT2D.md) alterations in RT-AS [PMID:37350195](../papers/37350195.md).
- RAS pathway co-altered with [PIK3CA](../genes/PIK3CA.md), [NRAS](../genes/NRAS.md), and [KRAS](../genes/KRAS.md) in FN-RMS [PMID:37730754](../papers/37730754.md).

## Therapeutic relevance

- HRAS is part of both the stress-activated MAPK cascade and VEGF/VEGFR signaling pathways identified as potential molecular targets in RT-AS [PMID:37350195](../papers/37350195.md).

## Open questions

- Whether RAS-directed therapies or downstream MEK/ERK inhibitors are effective in HRAS-mutant RT-AS is not addressed in the corpus [PMID:37350195](../papers/37350195.md).
- The functional significance of the specific HRAS hotspot variants (A59T, Q61R/L) in angiosarcoma biology has not been characterized [PMID:37350195](../papers/37350195.md).

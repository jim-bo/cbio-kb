...
targets:
  - DNA
  - TYMS
drug_class: combination chemotherapy regimen (oxaliplatin + leucovorin + fluorouracil)
...
FOLFOX is a multi-drug chemotherapy regimen combining [oxaliplatin](../drugs/oxaliplatin.md) (a platinum-based DNA crosslinker), [leucovorin](../drugs/leucovorin.md) (folinic acid, a folate that potentiates 5-FU), and [fluorouracil](../drugs/fluorouracil.md) (5-FU, a pyrimidine antimetabolite that inhibits thymidylate synthase TYMS and incorporates into RNA/DNA). It is a standard systemic regimen for colorectal and rectal cancers. In the neoadjuvant rectal-cancer setting, FOLFOX provides cytotoxic systemic coverage that complements the local effects of short-course radiotherapy (SCRT), and is being evaluated in combination with checkpoint blockade ([zimberelimab](../drugs/zimberelimab.md)) and adenosine-receptor inhibition ([etrumadenant](../drugs/etrumadenant.md)) to create a multi-mechanism strategy for achieving pathological complete response (pCR).
...
- [READ](../cancer_types/READ.md) — rectal adenocarcinoma; FOLFOX component of SCRT + etrumadenant + zimberelimab + FOLFOX in ImmunoRad MCT2 (NCT05024097).
- [PAAD](../cancer_types/PAAD.md) — pancreatic adenocarcinoma; FOLFIRINOX (incorporates FOLFOX components) used as first-line standard in 38% of MSK PDAC cohort.

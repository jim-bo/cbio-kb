...
Dermatofibrosarcoma Protuberans is a low- to intermediate-grade superficial soft tissue tumor of the dermis, characterized by the pathognomonic t(17;22) translocation producing a [COL1A1](../genes/COL1A1.md)–[PDGFB](../genes/PDGFB.md) fusion gene, which drives constitutive PDGF receptor activation. DFSP is classified under skin cancer (non-melanoma) in OncoTree.

## Cohorts in the corpus

- [sarcoma_msk_2022](../datasets/sarcoma_msk_2022.md): DFSP was among the 44 sarcoma histologies profiled by FoundationOne Heme in 7,494 sarcomas [PMID:35705558](../papers/35705558.md).
...
- Fibrosarcomatous transformation of DFSP represents a higher-grade variant with increased genomic complexity.

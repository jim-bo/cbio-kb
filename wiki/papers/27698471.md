...
- **Cell lines:** CAL-27 and SCC-25 ([HNSC](../cancer_types/HNSC.md), [EGFR](../genes/EGFR.md)+); SCC-35, SCC-61, SQ-9G ([HNSC](../cancer_types/HNSC.md), EGFR+, provided by Weichselbaum, U. Chicago); A549 and CALU3 ([NSCLC](../cancer_types/NSCLC.md)); OE19 ([ESCA](../cancer_types/ESCA.md), HER2+); BT474 ([BRCA](../cancer_types/BRCA.md), HER2+); NCI-N87 ([STAD](../cancer_types/STAD.md), HER2+); HCT-116 ([COAD](../cancer_types/COAD.md), HER2−); LN229 ([GB](../cancer_types/GB.md), EGFR−).
...
- **Agents synthesized:** Cy5-labelled C-MMAE ([cetuximab](../drugs/cetuximab.md)–MC-VC-MMAE, drug-to-antibody ratio ~3.7) and T-MMAE ([trastuzumab](../drugs/trastuzumab.md)–MC-VC-MMAE, DAR ~3.2); clinical-grade T-DM1, cetuximab, trastuzumab, [erlotinib](../drugs/erlotinib.md), [lapatinib](../drugs/lapatinib.md), [cisplatin](../drugs/cisplatin.md), and [paclitaxel](../drugs/paclitaxel.md) obtained from UCSD Moores Cancer Center pharmacy; free MMAE (Concortis); mertansine (Abcam).
...
- [ERBB2](../genes/ERBB2.md) (HER2) — HER2 expression gates T-MMAE and T-DM1 activity. HER2+ lines (OE19, NCI-N87, CALU3, BT474) show sub-nanomolar T-DM1 IC50 and G2/M arrest; HER2− lines (HCT-116, CAL-27, LN229) are ~100-fold less sensitive. The paper frames the broader ErbB family (EGFR, HER2, HER3, HER4) as tumour radioresistance drivers but only EGFR and [ERBB2](../genes/ERBB2.md) are experimentally targeted.
...
- **Context of clinical failures.** The authors note that adding [cetuximab](../drugs/cetuximab.md) to cytotoxic chemo-radiotherapy in [NSCLC](../cancer_types/NSCLC.md) or HNC failed to improve outcomes (refs 37–38), motivating the ADC-delivery paradigm over receptor signal inhibition.
...
- **ErbB3/ErbB4.** Although the introduction names all four ErbB family members, [ERBB3](../genes/ERBB3.md) and [ERBB4](../genes/ERBB4.md) are not experimentally interrogated.

...
Small RNA (microRNA) sequencing by next-generation sequencing platforms; quantifies mature miRNA expression profiles across samples.
...
- Part of the TCGA multi-platform profiling battery alongside [whole-exome-seq](../methods/whole-exome-seq.md), [whole-genome-seq](../methods/whole-genome-seq.md), RNA-seq, HM450, and Affymetrix SNP6 in ChRCC.

...
- Amplified on chromothriptic chr12 (12q12) in aSCLC; enriched in the comparator nsSCLC-RB1−/TP53− cohort (6%) but NOT in aSCLC itself; aSCLC n=20 (MSKCC) [PMID:39185963](../papers/39185963.md).
- Mutated in 31% of CAC (colitis-associated colorectal cancer); KRAS amplifications more frequent than in sporadic CRC; KRAS hot-spot mutations less frequent than sporadic CRC; in CAC, KRAS and [BRAF](../genes/BRAF.md) V600E mutations occur significantly less frequently than in sporadic CRC [PMID:36611031](../papers/36611031.md).

...
FGFR2 is a receptor tyrosine kinase whose activating fusions and mutations are actionable with FGFR inhibitors in multiple tumor types, but in urothelial carcinoma it is vanishingly rare compared with [FGFR3](../genes/FGFR3.md).
...
- Tandem duplication identified in one adenoid cystic carcinoma ([ACC](../cancer_types/ACC.md)) tumor, similar to hematologic malignancy ITDs; no fusion transcript detected by RT-PCR [PMID:23685749](../papers/23685749.md)
...
- MAPK-pathway alteration (with [FGFR1](../genes/FGFR1.md), [BRAF](../genes/BRAF.md), [NF1](../genes/NF1.md), NTRK1/2) enriched in PA-like [LGG](../cancer_types/LGG.md) (52%) and LGm6-GBM (32%) in a pan-glioma TCGA methylation/genomic study (n=1122); alterations associated with pilocytic-astrocytoma-like IDH-wildtype LGG subtype [PMID:26824661](../papers/26824661.md)
...
- FGFR2-BICC1 is the most recurrent fusion in [CHOL](../cancer_types/CHOL.md) (5.6% of samples); FGFR2 is a top recurrent 5-prime kinase fusion partner across 33 TCGA cancer types (9,624 samples); druggable in 15 cancer types per DEPO annotation. [PMID:29617662](../papers/29617662.md)
...
- FGFR2 gene fusions detected in 14% of intrahepatic cholangiocarcinoma (IHC) patients in a prospective MSK-IMPACT cohort (n=195); fusion partners include BICC1 and [KIAA1217](../genes/KIAA1217.md); exclusive to IHC subtype and targeted by [infigratinib](../drugs/infigratinib.md) and pan-FGFR inhibitors. [PMID:29848569](../papers/29848569.md)
...
- Mutations/amplifications in 3/41 (7.3%) resistant HR+/HER2- [MBC](../cancer_types/MBC.md) biopsies, all intrinsic resistance; one of eight categories covering 65.9% of resistant tumors [PMID:32404308](../papers/32404308.md)
...
- Fusions in 47/412 (11%) of intrahepatic cholangiocarcinoma (iCCA) cases (38 known in-frame); total FGFR2 alterations in 15% of cohort; mutually exclusive with IDH1/2 mutations but not independently prognostic for [OS](../cancer_types/OS.md) [PMID:33765338](../papers/33765338.md)
...
- FGFR2 fusions prevalence 15.5% in intrahepatic cholangiocarcinoma (IHC) profiled cohort; in N1-node patients (N=4 FGFR2fus vs N=48 FGFR2wt) no significant survival difference (HR 0.64, 95% CI 0.15–2.7, P=0.545; median OS 31.4 vs 21.5 months) [PMID:33963001](../papers/33963001.md)
...
- [BLCA](../cancer_types/BLCA.md) / [UTUC](../cancer_types/UTUC.md) — actionable FGFR2 alterations are essentially absent [PMID:37682528](../papers/37682528.md).
- [PAAD](../cancer_types/PAAD.md) — FGFR2 fusions/alterations included in the OncoKB actionability landscape of [pdac_msk_2024](../datasets/pdac_msk_2024.md); activating MAPK-gene fusions are enriched in KRAS-WT PDAC [PMID:39753968](../papers/39753968.md).
...
- In principle eligible for [erdafitinib](../drugs/erdafitinib.md) alongside [FGFR3](../genes/FGFR3.md), but the near-absence of FGFR2 events in UC limits clinical impact in this disease [PMID:37682528](../papers/37682528.md).

## Open questions

- Clinical significance of the observed FGFR2:MARVELD3 fusion is unclear [PMID:37682528](../papers/37682528.md).

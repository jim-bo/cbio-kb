---
name: dasatinib
targets: [BCR-ABL1, SRC, KIT, PDGFR]
drug_class: BCR-ABL/Src family kinase inhibitor
...
Dasatinib is a second-generation BCR-ABL1/Src-family tyrosine kinase inhibitor that also inhibits [KIT](../genes/KIT.md) and PDGFR. It is FDA-approved for chronic myeloid leukemia and Philadelphia chromosome-positive acute lymphoblastic leukemia. In the UCLA sarcoma PDTO screen it was included in the >400-compound panel and showed sensitivity association with disease trajectory.
...
- Progressive clinical disease trajectory is associated with ex vivo PDTO resistance to dasatinib (p=0.039) in sarcoma, alongside sirolimus/rapamycin (p=0.014) and [gefitinib](../drugs/gefitinib.md) (p=0.048). [PMID:39305899](../papers/39305899.md)

## Cancer types (linked)

- [OS](../cancer_types/OS.md), [LMS](../cancer_types/LMS.md), [RMS](../cancer_types/RMS.md), [CHDM](../cancer_types/CHDM.md) — sarcoma subtypes in the pan-sarcoma PDTO screen.

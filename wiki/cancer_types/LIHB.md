...
Hepatoblastoma is the most common primary liver tumor in children, with peak incidence in the first 3 years of life. It arises from hepatic progenitor cells and is associated with Beckwith-Wiedemann syndrome and familial adenomatous polyposis (FAP/APC mutations). The molecular landscape is dominated by activating mutations of the Wnt/beta-catenin pathway ([CTNNB1](../genes/CTNNB1.md) in ~70%, [APC](../genes/APC.md) in FAP-associated cases). Prognosis depends on resectability and treatment response to cisplatin-based chemotherapy.
...
- Germline WES of 372 pediatric cancer patients (Düsseldorf) included a hepatoblastoma patient (LPP_04) carrying a monoallelic [ATM](../genes/ATM.md) pLoF LP/PV; [ATM](../genes/ATM.md) burden OR=3.2 (p=.040) in the single-cohort analysis [PMID:29489754](../papers/29489754.md)

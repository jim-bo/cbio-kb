...
- [NOTCH2](../genes/NOTCH2.md) PEST-truncating mutations in 9/172 (5.2%) MCL confer dismal prognosis (3-year OS 0% vs 62%, P=2.5×10⁻⁴) and are an independent OS risk factor (HR 3.5; 95% CI 1.3–9.5; P=0.017); mutually exclusive with [NOTCH1](../genes/NOTCH1.md) mutations (8/172, 4.6%). [PMID:24145436](../papers/24145436.md)

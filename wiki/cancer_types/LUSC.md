...
- TCGA WES of 178 lung squamous cell carcinomas defined the genomic landscape: near-universal [CDKN2A](../genes/CDKN2A.md) loss, [TP53](../genes/TP53.md) mutation, and frequent KEAP1/NFE2L2 alterations [PMID:22960745](../papers/22960745.md)
- Pan-NSCLC WES of 660 [LUAD](../cancer_types/LUAD.md) and 484 LUSC tumour/normal pairs ([nsclc_tcga_broad_2016](../datasets/nsclc_tcga_broad_2016.md)); LUSC had median somatic mutation rate 9.7/Mb and 20 SMGs; novel LUSC driver [RASA1](../genes/RASA1.md); [TP53](../genes/TP53.md), [CDKN2A](../genes/CDKN2A.md), and [PIK3CA](../genes/PIK3CA.md) were significantly more frequently mutated in LUSC than [LUAD](../cancer_types/LUAD.md) (p<0.01); LUSC genetic landscape more closely resembled [HNSC](../cancer_types/HNSC.md) and [BLCA](../cancer_types/BLCA.md) than [LUAD](../cancer_types/LUAD.md); 53% of LUSCs had ≥5 predicted neoepitopes [PMID:27158780](../papers/27158780.md)
- LUSC had a 97% pre-operative ctDNA detection rate (30/31 cases) in the TRACERx cohort, compared with 19% for [LUAD](../cancer_types/LUAD.md); non-adenocarcinoma histology, lymphovascular invasion, and high Ki67 were independent predictors of ctDNA detection on multivariable logistic regression. [PMID:28445469](../papers/28445469.md)
- Squamous cell lung cancer comprised 14% (34/240) of the anti-PD-(L)1 [NSCLC](../cancer_types/NSCLC.md) MSK-IMPACT cohort used to validate targeted NGS-based TMB as an immunotherapy biomarker; LUSC mutational signatures were used as a comparison reference in the vulvar SCC WES landscape study [PMID:29337640](../papers/29337640.md)
...
- Pan-cancer fusion study (9,624 TCGA samples) identified [FGFR3](../genes/FGFR3.md)–[TACC3](../genes/TACC3.md) in 1.2% of LUSC samples; [FGFR3](../genes/FGFR3.md) is a druggable target across 15 cancer types [PMID:29617662](../papers/29617662.md)
...
- In a pan-cancer [MET](../genes/MET.md) copy-number survey of 66,285 MSK-IMPACT tumor samples, lung squamous cell carcinoma (LUSC) was one of the [NSCLC](../cancer_types/NSCLC.md) histologic subtypes broken out for MET amplification frequency, alongside LUAD, [LUNE](../cancer_types/LUNE.md) and pleomorphic/sarcomatoid NSCLC (8.5%) [PMID:36044468](../papers/36044468.md).

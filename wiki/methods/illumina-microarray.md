...
- In the [NSCLC](../cancer_types/NSCLC.md) radiogenomics dataset, the microarray arm (n=26) is substantially smaller than the RNA-seq arm (n=130) and is provided for completeness rather than as the primary expression layer [PMID:30325352](../papers/30325352.md).

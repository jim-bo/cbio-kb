...
- Genome sequencing + proteomics of HGSOC (Zhang et al.) linked copy-number variations to proteome and post-translational modification (PTM) changes, exemplifying proteogenomics integration for ovarian cancer molecular characterization. [PMID:37119971](../papers/37119971.md)
...
- [PMID:37119971](../papers/37119971.md) — Babu & Snyder, multi-omics precision health review; HGSOC proteogenomics cited (2023).

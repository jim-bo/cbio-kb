...
TACC3 is a centrosomal/spindle protein best known in cancer genomics as the canonical 3' fusion partner of [FGFR3](../genes/FGFR3.md), producing oncogenic FGFR3-TACC3 fusions.
...
- Noted as a background-context fusion partner: [FGFR3](../genes/FGFR3.md):TACC3 fusions in adult glioblastoma are cited as the conceptual analog for the [FGFR1](../genes/FGFR1.md) kinase-domain activations and [FGFR1](../genes/FGFR1.md):[TACC1](../genes/TACC1.md) fusions identified in pediatric pilocytic astrocytoma [PMID:23817572](../papers/23817572.md)
...
- FGFR3-TACC3 is a recurrent inframe activating kinase fusion across [BLCA](../cancer_types/BLCA.md) (2.0%), [CESC](../cancer_types/CESC.md) (1.7%), and [LUSC](../cancer_types/LUSC.md) (1.2%); [FGFR3](../genes/FGFR3.md) named as a druggable target in 15 cancer types in the TCGA pan-cancer fusion landscape [PMID:29617662](../papers/29617662.md)
- TACC3 is a fusion partner of [FGFR3](../genes/FGFR3.md) ([FGFR3](../genes/FGFR3.md)–TACC3, exon 17–exon 11 junction) in bladder cancer organoid line SCBO-10; the same fusion junction was previously reported in glioblastoma (GBM-021) and bladder cell line RT112 [PMID:29625057](../papers/29625057.md)
- FGFR3-TACC3 and FGFR3-BAIAP2L1 recurrent activating fusions present in cell-line models used for functional validation in a [UTUC](../cancer_types/UTUC.md) genomic characterization study; FGFR3-TACC3 fusions also observed in 16 glioma patients (n=923, MSK-IMPACT) in a concurrent glioma cohort [PMID:31278255](../papers/31278255.md) [PMID:31263031](../papers/31263031.md)
- FGFR3-TACC3 fusion detected in three [GBM](../cancer_types/GBM.md) PDX (out of 84); identified as a potentially targetable FGFR-fusion event; two novel [FGFR3](../genes/FGFR3.md) partner fusions (FGFR3-TRIM54, FGFR3-CALCOCO1) also discovered in the same cohort [PMID:31852831](../papers/31852831.md)
- Partner in a single FGFR3-TACC3 oncogenic fusion identified by RNA-seq (case UTUC-11) in the IGBMC [UTUC](../cancer_types/UTUC.md) cohort (n=40); FGFR3-TACC3 fusions are established oncogenic drivers in bladder/urothelial cancer [PMID:33397444](../papers/33397444.md)
- FGFR3-TACC3 fusions detected in bladder cancers; acquired FGFR3 point mutations conferring FGFR-inhibitor resistance found in tumors with pre-existing FGFR3-TACC3 fusions via MSK-ACCESS [PMID:34145282](../papers/34145282.md)
- TACC3 protein levels decreased while mRNA was upregulated in TP53-mutant HCCs (proteogenomic cohort, n=159), part of a mitotic-spindle regulatory signature with discordant mRNA/protein expression [PMID:35508466](../papers/35508466.md)

## Cancer types (linked)

- [BLCA](../cancer_types/BLCA.md) / [UTUC](../cancer_types/UTUC.md) — FGFR3-TACC3 fusions contribute to the actionable FGFR3-altered population [PMID:37682528](../papers/37682528.md).

## Co-occurrence and mutual exclusivity

- Obligate partner of [FGFR3](../genes/FGFR3.md) in FGFR3-TACC3 fusions [PMID:37682528](../papers/37682528.md).

## Therapeutic relevance

- FGFR3-TACC3-fusion urothelial tumors are eligible for [erdafitinib](../drugs/erdafitinib.md) [PMID:37682528](../papers/37682528.md).

## Open questions

- Whether FGFR3-fusion tumors respond differently to [erdafitinib](../drugs/erdafitinib.md) than FGFR3-mutant tumors is not directly resolved in the corpus [PMID:37682528](../papers/37682528.md).

...
- ABSOLUTE used to [estimate](../methods/estimate.md) copy-number purity and ploidy from Affymetrix SNP 6.0 data in 333 cutaneous melanoma samples as part of the TCGA [SKCM](../cancer_types/SKCM.md) integrative analysis. [PMID:26091043](../papers/26091043.md)
...
- Used to estimate tumor purity from WES data in the [GBM](../cancer_types/GBM.md) anti-PD-1 immunotherapy cohort; purity was not significantly different between responders and non-responders (p=0.19) [PMID:30742119](../papers/30742119.md)

...
MSH2 is a core component of the mismatch repair complex (MutSalpha with [MSH6](../genes/MSH6.md); MutSbeta with [MSH3](../genes/MSH3.md)). Germline mutations in MSH2 cause Lynch syndrome, predisposing to colorectal, endometrial, and other cancers. Somatic MSH2 inactivation produces MSI-H tumors sensitive to immune checkpoint blockade.

## Alterations observed in the corpus

- Somatic and germline MSH2 mutations detected in dMMR/MSI-H gynecologic cancers; 30% of cases harbored pathogenic somatic MMR gene mutations including MSH2 [PMID:38653864](../papers/38653864.md)
- In glioblastoma treated with [temozolomide](../drugs/temozolomide.md), alterations in mismatch repair genes including MSH2 are associated with a hypermutator phenotype when [MGMT](../genes/MGMT.md) is methylated [PMID:18772890](../papers/18772890.md).
- MSH2 mutations with loss of protein expression by IHC in treatment-refractory corticotroph pituitary neuroendocrine tumors [PMID:38758238](../papers/38758238.md)
...
- MSH2 mutations, together with [MSH6](../genes/MSH6.md) and [MLH1](../genes/MLH1.md), account for MMR deficiency in 12% of ATC vs 2% of PDTC; associated with hypermutator phenotype in anaplastic thyroid carcinoma [PMID:26878173](../papers/26878173.md)
- MSH2, together with [MSH6](../genes/MSH6.md), underlies complex structural aberrations causing hypermutation in 5 men with metastatic castration-resistant prostate cancer (mCRPC); MMR deficiency apparent in matched primaries [PMID:26928463](../papers/26928463.md)
- Mismatch repair defect identified in hypermutated [HNSC](../cancer_types/HNSC.md) tumors, alongside [MLH1](../genes/MLH1.md), [MSH6](../genes/MSH6.md), and [POLD1](../genes/POLD1.md) [PMID:27442865](../papers/27442865.md)
- R680 missense mutation in 1/19 sequenced 1p/19q-codeleted oligodendroglioma cases [PMID:28472509](../papers/28472509.md)
- MMR gene altered in ~3% of advanced prostate cancer patients alongside [MLH1](../genes/MLH1.md), MSH6, and [PMS2](../genes/PMS2.md); alterations produce a hypermutator phenotype with MMR/MSI signatures suggesting immune-checkpoint blockade candidacy [PMID:28825054](../papers/28825054.md)
...
- Germline MMR alleles (MSH2, MSH6, [PMS1](../genes/PMS1.md), [PMS2](../genes/PMS2.md)) identified; two glioma cases had biallelic loss with Lynch-pattern MSI hypermutation; somatic MSH2/MSH6 mutations observed in 31/38 (82%) hypermutated recurrences. [PMID:31263031](../papers/31263031.md)
...
- Co-occurring mutation with [MSH5](../genes/MSH5.md), [PMS1](../genes/PMS1.md), and [POLE](../genes/POLE.md) in IC-1621GBM (Lynch/constitutional MMR-deficiency) PDX model in the PPTC panel; this model was ultrahypermutated at 124 Mut/Mb [PMID:31693904](../papers/31693904.md).
- MSH2 protein (MutS complex) is downregulated in MSI cell lines in the CCLE proteomic dataset; its abundance predicts [WRN](../genes/WRN.md) knockdown sensitivity [PMID:31978347](../papers/31978347.md)
...
- MSH2 germline loss identifies Lynch syndrome [UTUC](../cancer_types/UTUC.md) subsets (UCC36, UCC34); MSH2/MSH6 IHC-negative without identifiable germline cause (UCC17) represents sporadic MSI-H [UTUC](../cancer_types/UTUC.md); all MSI-H cases had TMB 20.3–157.2 mut/Mb and showed resistance to neoadjuvant gemcitabine/cisplatin [PMID:32332851](../papers/32332851.md)
...
- MSH2 germline pathogenic variant identified in 1 MSI-H Nigerian CRC patient; MSH2 protein assayed by IHC as part of the MMR panel in 94 Nigerian tumors [PMID:34819518](../papers/34819518.md)
...
- MMR gene altered in 2.1% of sarcomas (n=7,494) alongside MLH1, MSH6, and PMS2, tightly correlated with MSI-H status [PMID:35705558](../papers/35705558.md)
...
- Gynecologic cancers: MSH2 somatic/germline mutations contribute to dMMR; [nivolumab](../drugs/nivolumab.md) achieves durable responses in MSH2-deficient tumors [PMID:38653864](../papers/38653864.md)
- [Glioblastoma (GB)](../cancer_types/GB.md) — MSH2 is part of the mismatch repair pathway whose compromise, in the presence of [MGMT](../genes/MGMT.md) methylation and [temozolomide](../drugs/temozolomide.md) treatment, leads to hypermutation [PMID:18772890](../papers/18772890.md).
- Prostate cancer: MSH2 alterations enriched in MSI-H/dMMR subset; associated with ICB response [PMID:38949888](../papers/38949888.md)
- Pituitary neuroendocrine tumors: MSH2 mutations in aggressive, treatment-refractory corticotroph PitNETs [PMID:38758238](../papers/38758238.md)

## Co-occurrence and mutual exclusivity

- Co-mutated with [MLH1](../genes/MLH1.md), [MSH6](../genes/MSH6.md), [PMS2](../genes/PMS2.md) in MMR-deficient tumors [PMID:38653864](../papers/38653864.md) [PMID:38949888](../papers/38949888.md)

## Therapeutic relevance

- MSH2-deficient dMMR/MSI-H tumors respond to [nivolumab](../drugs/nivolumab.md) and other anti-PD-1 agents [PMID:38653864](../papers/38653864.md)
- MSH2 alterations support [pembrolizumab](../drugs/pembrolizumab.md) use in treatment-refractory PitNETs with MMR deficiency [PMID:38758238](../papers/38758238.md)
- Prostate cancer with MSH2-associated dMMR status shows durable ICB responses [PMID:38949888](../papers/38949888.md)

## Open questions

- The relative contributions of individual MMR gene defects (MSH2 vs. [MLH1](../genes/MLH1.md) vs. [MSH6](../genes/MSH6.md)) to differential ICB outcomes within dMMR populations are not well characterized.

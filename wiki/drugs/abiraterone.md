...
- AR alterations predict androgen-axis treatment failure in mCSPC; abiraterone (with [enzalutamide](../drugs/enzalutamide.md) and [apalutamide](../drugs/apalutamide.md)) is a next-generation AR-pathway therapy for which NOTCH-pathway status, [CDK12](../genes/CDK12.md) biallelic inactivation, and AR alteration profiles may stratify benefit [PMID:32220891](../papers/32220891.md)

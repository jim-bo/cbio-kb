...
Gallbladder carcinoma; in the corpus it is grouped with extrahepatic cholangiocarcinoma ([EHCH](EHCH.md)) as the "biliary" reference class.

## Cohorts in the corpus

- [hcc_msk_2024](../datasets/hcc_msk_2024.md) — GBC cases used (with EHC) as a reference class for the hidden-genome classifier of intrahepatic cholangiocarcinoma, within the broader MSK biliary/HCC MSK-IMPACT cohort (2003–2022) [PMID:38864854](../papers/38864854.md).
...
- Desmoplastic stroma drives GBC progression via CAF-secreted [SEMA7A](../genes/SEMA7A.md) (upregulated on stiff 16 kPa matrix through YAP1/WWTR1/TEAD1), which signals through [ITGB1](../genes/ITGB1.md) on tumor cells to activate AKT1/EP300, promoting EMT and stemness; high stromal [SEMA7A](../genes/SEMA7A.md) associated with lymph node metastasis and shorter OS in 86 patients [PMID:40830485](../papers/40830485.md)
...
- MSK-IMPACT sequencing of 81 primary GBC tumors from three international centers (US, Chile, Japan) found [TP53](../genes/TP53.md) mutated in 58%, [SMAD4](../genes/SMAD4.md) in 31% (independently associated with worse OS; HR 2.01, p=0.043), [ARID1A](../genes/ARID1A.md) in 25% (absent in Japanese patients), and [PIK3CA](../genes/PIK3CA.md) in 12% (absent in Japanese patients); 80% of tumors harbored ≥1 actionable alteration; dataset [gbc_msk_2018](../datasets/gbc_msk_2018.md) [PMID:30427539](../papers/30427539.md)
...
- Among 1,254 MSK-IMPACT-sequenced biliary tract cancers, 277 (22.1%) were gallbladder cancer, with higher median TMB (4.1 vs 2.6 mut/Mb) and more whole-genome doubling (32% vs 20.7%) than intrahepatic cholangiocarcinoma, and enrichment of [KRAS](../genes/KRAS.md) G13D and [ERBB2](../genes/ERBB2.md) alterations relative to [IHCH](../cancer_types/IHCH.md) [PMID:42360806](../papers/42360806.md).

## Subtypes

## Therapeutic landscape

- Used as a reference class to define biliary-class [IHCH](IHCH.md), which carries markedly worse OS than HCC-class IHC [PMID:38864854](../papers/38864854.md).

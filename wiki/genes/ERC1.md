...
ERC1 (ELKS/RAB6-interacting/CAST family member 1) encodes a scaffold protein involved in presynaptic active zone organization. In cancer genomics, ERC1 is notable primarily as a fusion partner for [RET](../genes/RET.md), with the ERC1-RET fusion arising from chromosomal rearrangement and constitutively activating RET kinase signaling.
...
- Prevalence of ERC1-RET specifically vs other RET fusion partners in Indian vs non-Indian YLC cohorts is not well defined.

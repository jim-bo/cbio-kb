...
- MDM4 exon-6 inclusion (MDM4-FL) is a predictive biomarker for MDM4 dependence and [MDM2](../genes/MDM2.md) inhibitor [nutlin-3a](../drugs/nutlin-3a.md) sensitivity in [TP53](../genes/TP53.md) wild-type cancer cell lines; [RPL22](../genes/RPL22.md) K15fs frameshift (in 68% of MSI lines) drives [RPL22L1](../genes/RPL22L1.md) upregulation which promotes MDM4 exon-6 inclusion. [PMID:31068700](../papers/31068700.md)
- Amplification in 2% of [GBM](../cancer_types/GBM.md) PDX (n=84); co-occurs with [MDM2](../genes/MDM2.md) amplification as an alternative mechanism of p53 pathway inactivation in [GBM](../cancer_types/GBM.md) [PMID:31852831](../papers/31852831.md)
- MDM4 splicing is tied to [RPL22L1](../genes/RPL22L1.md) protein levels in the CCLE proteomics dataset [PMID:31978347](../papers/31978347.md)
...
- Amplification specific to proneural and classical [GBM](../cancer_types/GBM.md) subtypes in [gbm_cptac_2021](../datasets/gbm_cptac_2021.md) (n=99); subtype-specific distribution contrasts with MDM2 amplification, which is restricted to mesenchymal GBM [PMID:33577785](../papers/33577785.md)
...
- MDM4 highlighted alongside MDM2 as a potential therapeutic target via the TP53-MDM2/MDM4-ARF network in pan-cancer precision oncology analysis of Chinese solid-tumor patients [PMID:35871175](../papers/35871175.md)

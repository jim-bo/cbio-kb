...
- Used as an independent validation cohort to replicate 11 AML genomic subgroups (chromatin–spliceosome, TP53–aneuploidy, [IDH2](../genes/IDH2.md) R172, etc.) identified in 1540 AMLSG trial patients; subgroup structure and prognostic associations were confirmed in this TCGA AML dataset. [PMID:27276561](../papers/27276561.md)
...
- Served as an independent validation cohort for [PEAR1](../genes/PEAR1.md) as a prognostic biomarker: elevated PEAR1 expression was significantly associated with shortened overall survival in TCGA [LAML](../cancer_types/LAML.md), replicating the Beat AML functional-genomic study findings [PMID:35868306](../papers/35868306.md)

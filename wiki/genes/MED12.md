...
- Recurrent alterations in extremity [ARMS](../cancer_types/ARMS.md) at 8%–17% frequency, alongside [CDK4](../genes/CDK4.md) amplifications and [CDKN2A](../genes/CDKN2A.md) deletions [PMID:37315267](../papers/37315267.md).
- Recurrent alterations in fusion-positive rhabdomyosarcoma (FP-RMS) in a sequential multi-platform genomic study [PMID:37730754](../papers/37730754.md).
...
- Not recurrently mutated in endometrial polyps; discussed only as comparator — MED12 is the dominant driver in uterine leiomyomas (70–80%) but was not found in this polyp cohort [PMID:41137179](../papers/41137179.md)
...
- MED12 mutated in only 11% (9/80) of uterine leiomyosarcoma (uLMS), in contrast to ~70% mutation frequency in benign uterine leiomyomas; MED12 was absent in non-uterine [LMS](../cancer_types/LMS.md) (0% vs 11%, p=0.01), arguing that uLMS rarely evolves from antecedent leiomyomas [PMID:32299819](../papers/32299819.md)
...
- Assessed at ≥2% frequency in 426 treatment-naive clinical N2-negative [LUAD](../cancer_types/LUAD.md) patients (MSK-IMPACT); no significant difference in alteration frequency by pN status. [PMID:34290393](../papers/34290393.md)
- G44 hotspot missense mutation in 16% of uterine leiomyosarcoma ([ULMS](../cancer_types/ULMS.md)) detected by MSK-IMPACT panel sequencing of 2,138 sarcoma samples [PMID:35705560](../papers/35705560.md)
...
- Whether MED12 alteration carries independent prognostic weight in [ARMS](../cancer_types/ARMS.md) is not assessed [PMID:37315267](../papers/37315267.md).
- The significance of MED12 hotspot mutations specifically in serous EC from Black patients is unresolved; their overlap with treatment targets requires investigation [PMID:37651310](../papers/37651310.md).

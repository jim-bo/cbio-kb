...
CTNNB1 (beta-catenin) is the central effector of the canonical Wnt signaling pathway and also functions as a structural component of adherens junctions. In the absence of Wnt signals, beta-catenin is phosphorylated by [GSK3B](../genes/GSK3B.md) and CK1 at N-terminal residues (including S33) and targeted for proteasomal degradation. Activating mutations or phosphorylation-site alterations stabilize beta-catenin, driving Wnt target gene expression. In glioblastoma, [EGFR](../genes/EGFR.md) directly phosphorylates CTNNB1 at S33 (a proteasomal-degradation site), potentially stabilizing beta-catenin protein despite decreased mRNA.
...
- Mutations more frequent in [PRAD](../cancer_types/PRAD.md) lung metastases vs primaries (3% vs 8%, q=0.007) in MSK-MET; WNT pathway alterations in 26% of [PRAD](../cancer_types/PRAD.md) lung-met tumors vs 13% of primary [PRAD](../cancer_types/PRAD.md) (q<0.001), consistent with WNT-pathway role in PRAD lung organotropism [PMID:35120664](../papers/35120664.md)
...
- CTNNB1 protein elevation co-occurs with [EGFR](../genes/EGFR.md) structural variants and amplification in [GBM](../cancer_types/GBM.md); also associated with [GSK3B](../genes/GSK3B.md) phosphorylation tracking Wnt pathway activity [PMID:33577785](../papers/33577785.md).

## Therapeutic relevance

- EGFR-mediated stabilization of CTNNB1 in GBM may implicate Wnt/beta-catenin pathway inhibition as a downstream strategy in EGFR-altered GBM; hypothesis-generating from this proteogenomic analysis [PMID:33577785](../papers/33577785.md).

## Open questions

- Whether EGFR phosphorylation of CTNNB1 at S33 is a bona fide mechanism of beta-catenin stabilization in GBM (rather than an incidental phospho-outlier) requires functional validation [PMID:33577785](../papers/33577785.md).

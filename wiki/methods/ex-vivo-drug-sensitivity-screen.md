...
- Applied to 942 [AML](../cancer_types/AML.md) specimens (Beat AML Waves 1–4) with probit dose-response curve fitting; identified 65 additional mutation–drug associations in the expanded cohort vs Waves 1+2 alone (27% increase in power); drug-family analysis across 25 drug families showed cell-state-biased response patterns [PMID:35868306](../papers/35868306.md)
- Used on PDX-derived disaggregated MYOD1-mutant rhabdomyosarcoma cells to screen PI3K/AKT/mTOR/IGF1R inhibitors and standard chemotherapy, identifying submicromolar sensitivity to [samotolisib](../drugs/samotolisib.md), AZD8055 and A-674563 and synergy of samotolisib with irinotecan/temozolomide [PMID:41758938](../papers/41758938.md).

...
- 74-tumor WES cohort (Genentech) characterised colorectal adenocarcinoma genomic landscape; RSPO2/RSPO3 fusions mutually exclusive with [APC](../genes/APC.md) loss establish Wnt pathway as universal driver [PMID:22895193](../papers/22895193.md)
...
- Prospective MSK-IMPACT sequencing of 1,134 colorectal adenocarcinomas (979 metastatic + 120 early-stage patients) identified 47 recurrently mutated genes; WNT pathway alteration reached 96% when intronic [APC](../genes/APC.md) and large [CTNNB1](../genes/CTNNB1.md) exon-3 deletions were included; right-sided MSS mCRC had shorter OS (5-year 45% vs 67%, p<0.001) and distinct oncogenic enrichment versus left-sided [PMID:29316426](../papers/29316426.md)

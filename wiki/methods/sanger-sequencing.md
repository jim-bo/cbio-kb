...
- Used to validate [MEF2B](../genes/MEF2B.md) mutations in 261 [FL](../cancer_types/FL.md), 259 DLBCL, 17 cell lines, 35 other NHL, and 8 centroblast samples in the BCGSC NHL study [PMID:21796119](../papers/21796119.md)
...
- Sanger sequencing used to validate [PREX2](../genes/PREX2.md) and [KIT](../genes/KIT.md) mutations identified in melanoma WGS [PMID:22622578](../papers/22622578.md)
- Used for validation sequencing of candidate mutations identified by WGS in 37 medulloblastoma tumors (PCGP cohort, [mbl_pcgp](../datasets/mbl_pcgp.md)) [PMID:22722829](../papers/22722829.md)
...
- In the TCGA glioblastoma interim analysis, sequencing results were used to identify significantly mutated genes and core pathways (RTK/RAS/PI3K, p53, and RB) [PMID:18772890](../papers/18772890.md).

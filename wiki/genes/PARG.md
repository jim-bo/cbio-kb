...
PARG (Poly(ADP-Ribose) Glycohydrolase) encodes the primary enzyme responsible for degrading poly(ADP-ribose) chains synthesized by PARP1/2. It plays a central role in DNA damage response and repair. In never-smoker lung adenocarcinoma (NS-LUAD), PARG is a fusion partner in a novel recurrent structural variant.
...
- The functional consequence of the PARG-BMS1 fusion on PARG enzymatic activity and PARP pathway regulation in NS-LUAD is unknown.
- Whether this fusion is subtype-specific (steady/proliferative/chaotic) and whether it confers sensitivity to PARP inhibitors has not been tested.

...
ZEB1 (Zinc finger E-box binding homeobox 1) is a transcriptional repressor that drives epithelial-to-mesenchymal transition (EMT) by silencing E-cadherin ([CDH1](../genes/CDH1.md)) and other epithelial markers. ZEB1 is negatively regulated by the miR-200 family of microRNAs, forming a double-negative feedback loop that controls cell plasticity. In the NCI-60 cancer cell line panel, ZEB1 expression is strongly inversely correlated with CDH1 (E-cadherin) expression, confirming its role as a master EMT regulator across multiple cancer types.
...
- ZEB1 co-regulates EMT alongside SNAI2, ZEB2, and TWIST1 (all repressors of CDH1) and is negatively regulated by the miR-200 microRNA family [PMID:22802077](../papers/22802077.md)

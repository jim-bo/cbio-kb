...
name: carboplatin
targets: [DNA]
drug_class: platinum-based chemotherapy (second-generation)
...
- Used as part of platinum-based chemoimmunotherapy backbone in R/M [NPC](../cancer_types/NPC.md) trials cited in this review [PMID:41002550](../papers/41002550.md)
- In muscle-invasive bladder cancer patients ineligible for [cisplatin](../drugs/cisplatin.md), carboplatin-based regimens are proposed as candidates for study in ERCC2-mutant tumors, given the mechanistic link between [ERCC2](../genes/ERCC2.md) loss-of-function and platinum sensitivity [PMID:25096233](../papers/25096233.md)
...
- Platinum chemotherapy; usable from second trimester in pregnant young-onset [NSCLC](../cancer_types/NSCLC.md) patients when combined with taxanes or vinca alkaloids; recommended as pregnancy-compatible alternative to [cisplatin](../drugs/cisplatin.md) in this review [PMID:40958859](../papers/40958859.md)
- Adjuvant [cisplatin](../drugs/cisplatin.md)/carboplatin plus [vinorelbine](../drugs/vinorelbine.md) was the standard adjuvant backbone in the TRACERx [NSCLC](../cancer_types/NSCLC.md) ctDNA study (NCT01888601, n=24 longitudinal patients); ctDNA clearance after adjuvant therapy correlated with sustained remission while rising ctDNA burden identified platinum-resistance in real time. [PMID:28445469](../papers/28445469.md)
...
- Carboplatin plus [etoposide](../drugs/etoposide.md) yielded only 13% CR and 20% PR (33% total) in 15 evaluable atypical [SCLC](../cancer_types/SCLC.md) (aSCLC) patients — well below the ~70% benchmark for conventional SCLC; aSCLC is characterized by [RB1](../genes/RB1.md)+/TP53+ status and chromothripsis-driven [CCND1](../genes/CCND1.md)/[CDK4](../genes/CDK4.md) amplification [PMID:39185963](../papers/39185963.md).
- Historical comparator: first-line gemcitabine-carboplatin gave a 9.3-month median OS with a 21% treatment-discontinuation rate in metastatic urothelial carcinoma, versus 15.9 months for [atezolizumab](../drugs/atezolizumab.md) in this cisplatin-ineligible cohort. [PMID:27939400](../papers/27939400.md)
- In neoadjuvant carboplatin plus docetaxel-treated triple-negative breast cancer, a 19q13.31-33 deletion spanning LIG1/POLD1/XRCC1 was associated with resistance to pathologic complete response; PDX and PDX-derived explant screens showed [LIG1](../genes/LIG1.md) loss was selectively associated with carboplatin (not [docetaxel](../drugs/docetaxel.md)) resistance. [PMID:36001024](../papers/36001024.md)
- [UTUC](../cancer_types/UTUC.md) patient PT12 (TMB-high, microsatellite-stable, cluster C5) was treated with gemcitabine/carboplatin before an FGFR inhibitor, [nivolumab](../drugs/nivolumab.md), and later intravesical BCG. [PMID:39550333](../papers/39550333.md)
- IMvigor210 cohort 2 (n=310) enrolled metastatic urothelial carcinoma patients who had progressed during or after platinum-based chemotherapy ([cisplatin](../drugs/cisplatin.md) or carboplatin) before receiving atezolizumab monotherapy in this final analysis. [PMID:39642637](../papers/39642637.md)
...
- [NSCLC](../cancer_types/NSCLC.md) — adjuvant cisplatin/carboplatin + [vinorelbine](../drugs/vinorelbine.md) in TRACERx; platinum resistance detectable by rising ctDNA burden.
...
- [PMID:28445469](../papers/28445469.md) — Abbosh et al. 2017, *Nature*. TRACERx [NSCLC](../cancer_types/NSCLC.md) ctDNA study; carboplatin/cisplatin + [vinorelbine](../drugs/vinorelbine.md) adjuvant backbone; ctDNA monitors platinum resistance in real time.

...
Acinar cell carcinoma of the pancreas is a rare malignant pancreatic tumor accounting for ~1–2% of pancreatic exocrine neoplasms, classified under Pancreatic Cancer in OncoTree (parent: PANCREAS). It arises from acinar cells and is distinct from the more common pancreatic ductal adenocarcinoma ([PAAD](../cancer_types/PAAD.md)).

## Cohorts in the corpus

- [msk_chord_2024](../datasets/msk_chord_2024.md): included within the MSK-CHORD pancreatic cancer cohort (n=3,109 PAAD/PAAC combined) with MSK-IMPACT targeted sequencing and NLP-derived clinical annotations. [PMID:39506116](../papers/39506116.md)
...
- [GNAS](../genes/GNAS.md) codon 201 hotspot mutations (R201C/R201H) found in all 4 colloid (PAAC) cases in a 109-case microdissected WES cohort; all GNAS-mutant cases were IPMN-derived; 4 of 6 GNAS-mutant cases also harbored [KRAS](../genes/KRAS.md) mutations [PMID:25855536](../papers/25855536.md)

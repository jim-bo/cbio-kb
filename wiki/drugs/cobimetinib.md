...
Allosteric MEK1/2 inhibitor used to target MAPK-pathway-activated tumors.
...
- Used in combination with [vemurafenib](../drugs/vemurafenib.md) in 3 of 11 BRAFi+MEKi combination-arm patients with BRAF V600E/K-mutant metastatic [melanoma](../cancer_types/SKCM.md); [PTEN](../genes/PTEN.md) loss-of-function alterations were identified as a candidate biomarker of intrinsic BRAFi±MEKi resistance in this pretreatment sequencing cohort (n=66) [PMID:32913971](../papers/32913971.md).
- MEK inhibitor; indicated for [KRAS](../genes/KRAS.md) GoF mutations in CRC in Chinese pan-cancer cohort (n=10,194) at OncoKB Level 3B/4, alongside [trametinib](../drugs/trametinib.md) and [binimetinib](../drugs/binimetinib.md) [PMID:35871175](../papers/35871175.md)

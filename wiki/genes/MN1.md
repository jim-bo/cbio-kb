...
- **[ASTB](../cancer_types/ASTB.md) (Astroblastoma):** MN1::BEND2 fusions are the defining alteration of an epigenetic subtype of astroblastoma; typically replacing each other in CNS vs. non-CNS contexts when [EWSR1](../genes/EWSR1.md)::BEND2 is found [PMID:41102727](../papers/41102727.md)
- **EWS / Undifferentiated Small Round Cell Sarcoma:** MN1 is discussed as a comparator to contextualize EWSR1::BEND2 bladder sarcoma within the WHO classification of EWSR1-non-ETS fusion neoplasms [PMID:41102727](../papers/41102727.md)

## Co-occurrence and mutual exclusivity

- MN1::BEND2 and EWSR1::BEND2 fusions appear mutually exclusive within astroblastoma subtypes, with EWSR1::BEND2 fusions described in CNS cases sharing molecular similarity with MN1-rearranged astroblastomas [PMID:41102727](../papers/41102727.md)
...
- Whether EWSR1::BEND2 sarcomas outside the CNS (e.g., bladder) form a distinct molecular subgroup from MN1::BEND2 / EWSR1::BEND2 astroblastomas remains unresolved; the differing EWSR1 breakpoint (exon 10 in bladder vs. exons reported in CNS cases) raises this question [PMID:41102727](../papers/41102727.md)

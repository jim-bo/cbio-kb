...
ETV6 encodes an ETS-family transcriptional repressor. The ETV6-NTRK3 fusion is the canonical driver of infantile fibrosarcoma ([IFS](../cancer_types/IFS.md)) and is present in ~90% of cases. ETV6-NTRK3 status, assessed by FISH or RNA fusion testing, is a key diagnostic criterion and biomarker for [larotrectinib](../drugs/larotrectinib.md) sensitivity.
...
- ETV6 loss-of-function alterations, along with [RUNX1](../genes/RUNX1.md), are enriched in the immature/Unclassified subset of a pediatric [AML](../cancer_types/AML.md) gene-expression classification cohort. [PMID:38212634](../papers/38212634.md)
...
- ETV6-NTRK3 fusion is mutually exclusive with the [SCSRMS](../cancer_types/SCSRMS.md) diagnosis; its absence is necessary for this reclassification [PMID:39305899](../papers/39305899.md).

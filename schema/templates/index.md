...
- **2026-05-14** — Added 5 papers (PMIDs 26544944, 26551667, 26631609, 26683228, 26760213) — **final wave of the 30-paper /loop**. TCGA prostate adenocarcinoma 333-tumor 7-platform integrated genomics defining 7 molecular subtypes covering 74% of cases ([PMID 26544944](papers/26544944.md)). Columbia CTCL WES of 42 patients (Sézary syndrome + mycosis fungoides) defining TP53/PTEN/DNMT3A deletions, novel PRKG1 LoF, and NFκB/JAK therapy implications ([PMID 26551667](papers/26551667.md)). MD Anderson adenoid cystic carcinoma 102-sample WGS+FISH discovering MYBL1-NFIB fusions as MYB-equivalent driver ([PMID 26631609](papers/26631609.md)). QIMR uveal melanoma WGS+WES discovering PLCB4 p.D630Y as a third Gαq-pathway hotspot mutually exclusive with GNAQ/GNA11 ([PMID 26683228](papers/26683228.md)). SickKids medulloblastoma 33 primary/recurrence pairs showing only 11.8% shared SNVs and TP53-pathway convergence in 79% of recurrent Shh-MBL ([PMID 26760213](papers/26760213.md)). 102 unique genes touched, 6 new datasets, 2 new cancer types (MYCF, SS), 1 new drug (tofacitinib), 3 new methods (expands, sleeping-beauty-transposon-screen, targeted-deep-amplicon-seq).

...
MAP2K2 (MEK2) is a MAPK kinase paralog of [MAP2K1](../genes/MAP2K1.md). In CLL it was nominated as a novel driver via 3-D mutation clustering.
...
- MAP2K1/MAP2K2 combined at 7% in 696 melanomas ([mel_mskimpact_2020](../datasets/mel_mskimpact_2020.md)); combined with MAP2K1 as 7% of MAPK-pathway drivers; MAP2K2 classified jointly as MAPK-pathway kinase drivers in melanoma [PMID:33509808](../papers/33509808.md)

## Cancer types (linked)

- [CLLSLL](../cancer_types/CLLSLL.md) — newly nominated driver in the integrated CLL map (n=1,148) [PMID:35927489](../papers/35927489.md).
...
- None directly tested; authors suggest activated ERK signaling as the functional consequence [PMID:35927489](../papers/35927489.md).

## Open questions

- Functional validation of MAP2K2 as a CLL driver is deferred to future work [PMID:35927489](../papers/35927489.md).

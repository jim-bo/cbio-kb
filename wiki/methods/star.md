...
- STAR v2.7.3 used for RNA-seq alignment to GRCh38 in the Sherlock-Lung NS-LUAD study (n=684 tumors); HTSeq + GENCODE v35 used for quantification downstream [PMID:32015526](../papers/32015526.md).

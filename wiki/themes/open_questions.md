...
- **CT radiomic signature generalizability in head-and-neck cancer.**
  ...
  *dropped* AUROC vs EMR+volume, and external performance degraded on 2 of 3
  ...
  shift. Point of contention: whether HNSCC CT [radiomics](../methods/radiomics.md) generalizes across
...
- **Direction of the early peripheral PD-1+Ki-67+ [CD4](../genes/CD4.md)+ T-cell surge under

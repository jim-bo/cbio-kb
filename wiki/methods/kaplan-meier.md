...
- Used to generate survival curves for OS, PFI, DFI, and DSS endpoints across 11,160 TCGA patients in 33 cancer types (TCGA Pan-Cancer Clinical Data Resource); paired with Cox proportional hazards regression for multivariable analysis; analysis performed in R 3.2.2 [PMID:29625055](../papers/29625055.md).
...
- Kaplan-Meier survival analysis used to compare overall survival by [SMAD4](../genes/SMAD4.md) mutation status in 81 GBCA patients; SMAD4-mutant patients had median OS 10.4 mo vs 24.8 mo [PMID:30427539](../papers/30427539.md)

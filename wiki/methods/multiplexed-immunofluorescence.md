...
- Multiplexed immunofluorescence (MxIF) performed on 34 WU-RCC patients with a 19-marker ccRCC antibody panel for spatial proteomics validation of HiTME subtypes [PMID:40834854](../papers/40834854.md)
...
- Opal multiplex fluorescent IHC stained CD8, PD-1, CD45, [GFAP](../genes/GFAP.md) and PD-L1 in a recurrent glioblastoma neoadjuvant PD-1 blockade trial [PMID:30742122](../papers/30742122.md).
...
- Multiplexed IF revealed spatial relationships between CD8+ T cell exhaustion markers ([TOX](../genes/TOX.md), PD-1) and tumor cells ([PAX8](../genes/PAX8.md)) in the context of [nivolumab](../drugs/nivolumab.md) response [PMID:38653864](../papers/38653864.md).

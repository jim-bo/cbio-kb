...
GLIS2 (GLIS family zinc finger 2) encodes a Kruppel-like zinc-finger transcription factor. In pediatric acute megakaryoblastic leukemia ([AMKL](../cancer_types/AMKL.md)), the [CBFA2T3](../genes/CBFA2T3.md)–GLIS2 fusion gene is a recurrent and diagnostically defining event associated with poor prognosis. The fusion arises from a cryptic inversion of chromosome 16 and is not reliably detected by standard karyotype.
...
- No co-occurrence or mutual exclusivity data reported in the corpus beyond the CBFA2T3 fusion partnership.
...
- The optimal treatment strategy for CBFA2T3–GLIS2-positive AMKL remains an active area of investigation; whether GLIS2-directed or fusion-targeted approaches can improve outcomes is not established.

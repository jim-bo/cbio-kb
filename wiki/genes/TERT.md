...
- **HCC** — TERT promoter mutation spans both the proliferation class (enriched for [TP53](../genes/TP53.md) inactivation) and the non-proliferation class (enriched for [CTNNB1](../genes/CTNNB1.md) mutations, where TERT promoter mutation rate is higher). Listed among trunk HCC mutations not currently druggable. [PMID:24798001](../papers/24798001.md)

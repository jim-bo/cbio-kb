...
Papillary thyroid carcinoma (PTC/THPA) is the most common thyroid malignancy, with generally excellent prognosis. On OncoTree it is a child of Well-Differentiated Thyroid Carcinoma (WDTC). It is driven predominantly by [BRAF](../genes/BRAF.md) V600E or RAS mutations and characterized by a low mutation burden. A minority of PTCs undergo dedifferentiation to anaplastic thyroid carcinoma ([THAP](../cancer_types/THAP.md)).

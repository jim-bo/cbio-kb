...
- [DLBCLNOS](../cancer_types/DLBCLNOS.md) — canonical ABC-subtype driver; context for secondary CNS lymphoma in the MSK [ibrutinib](../drugs/ibrutinib.md) cohort [PMID:38995739](../papers/38995739.md).
- Diffuse large B-cell lymphoma (DLBCL) — key classifier for MCD subtype in LymphGen algorithm; MCD classification validated on 400-gene clinical NGS panel [PMID:38497151](../papers/38497151.md).

...
FLI1 (Friend leukemia integration 1 transcription factor) is an ETS-family transcription factor. It is most prominently known as the C-terminal fusion partner in the [EWSR1](../genes/EWSR1.md)::FLI1 fusion oncogene, which defines the majority of Ewing sarcomas. The fusion protein acts as an aberrant transcription factor that rewires gene expression programs in the cell of origin.

## Alterations observed in the corpus

- [EWSR1](../genes/EWSR1.md)::FLI1 fusion expressed in heMSCs is sufficient to induce Ewing sarcoma–like transcriptome, [BRCA1](../genes/BRCA1.md) dysregulation, DDR defect, and metastatic tumor formation; binds intronic CA microsatellites in stem cell context vs GGAA microsatellite enhancers in established Ewing lines [PMID:41136396](../papers/41136396.md)
...
- FLI1 fusions (e.g., EWSR1-FLI1) are the canonical oncogenic driver in Ewing sarcoma, reported in this cohort study [PMID:41102727](../papers/41102727.md)

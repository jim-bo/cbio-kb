...
- **Neuroendocrine identification (zero-shot learning):** Differentiation score distinguished [NSCLC](../cancer_types/NSCLC.md) from [SCLC](../cancer_types/SCLC.md) (AUC=0.963) and metastatic prostate adenocarcinoma from NEPC (AUC=0.834).
...
- "The differentiation score produced a high ROC AUC for differentiating non-small cell lung cancer (N=606; [NSCLC](../cancer_types/NSCLC.md)) from small cell lung cancer (N=137; SCLC; AUC 0.963) and for differentiating metastatic prostate adenocarcinoma (N=721) from neuroendocrine prostate cancer (N=61; NEPC; AUC 0.834)." (Results)

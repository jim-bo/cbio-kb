...
Myeloproliferative Neoplasms (MPN) is a group of clonal hematopoietic stem cell disorders under the OncoTree Myeloid and Lymphoid Neoplasms (MNM) parent node. Classic BCR-ABL1-negative MPNs include polycythemia vera ([PV](../cancer_types/PV.md)), essential thrombocythemia ([ET](../cancer_types/ET.md)), and primary myelofibrosis (MF/PMF). [JAK2](../genes/JAK2.md) V617F is the most prevalent driver, with [CALR](../genes/CALR.md) and [MPL](../genes/MPL.md) mutations defining the JAK2-negative subset.

## Cohorts in the corpus

- [mpn_cimr_2013](../datasets/mpn_cimr_2013.md) — 151 MPN patients (48 PV, 62 ET, 39 [MF](../cancer_types/MF.md), 2 unclassifiable) with whole-exome sequencing. [PMID:24325359](../papers/24325359.md)
...
- [ET](../cancer_types/ET.md) — Essential Thrombocythemia
- [PV](../cancer_types/PV.md) — Polycythemia Vera
- [MPNU](../cancer_types/MPNU.md) — Myeloproliferative Neoplasms, Unclassifiable

## Therapeutic landscape

- CALR mutation discovery opens prospect of CALR-mutant-specific therapeutic strategies distinct from the JAK2/MPL signaling axis. [PMID:24325359](../papers/24325359.md)

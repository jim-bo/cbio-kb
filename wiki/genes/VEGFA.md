...
VEGFA encodes vascular endothelial growth factor A, the principal driver of tumor angiogenesis. VEGFA focal amplification occurs in [HCC](../cancer_types/HCC.md), and VEGFA signaling is the central mechanism of action of multiple approved [HCC](../cancer_types/HCC.md) systemic therapies. Anti-VEGF strategies are also investigated in nasopharyngeal carcinoma ([NPC](../cancer_types/NPC.md)).
...
- Recurrent amplification driver (≥5% prevalence) in esophageal/esophagogastric junction adenocarcinomas ([EGC](../cancer_types/EGC.md)/[ESCA](../cancer_types/ESCA.md)) by MSK-IMPACT (N=487); one of 10 amplification-driven recurrent drivers; no independent OS association demonstrated in this cohort. [PMID:33795256](../papers/33795256.md)
...
- VEGFA anchors a 6-gene angiogenesis (Angio) signature (with [KDR](../genes/KDR.md), [ESM1](../genes/ESM1.md), [PECAM1](../genes/PECAM1.md), [ANGPTL4](../genes/ANGPTL4.md), [CD34](../genes/CD34.md)) in metastatic [RCC](../cancer_types/RCC.md); AngioHigh tumors predicted greater [sunitinib](../drugs/sunitinib.md) benefit and tracked CD31 IHC vascular density [PMID:29867230](../papers/29867230.md).
...
- **[EGC](../cancer_types/EGC.md) / [ESCA](../cancer_types/ESCA.md)** — Recurrent focal amplification at ≥5% prevalence in [EAC](../cancer_types/EAC.md) (N=487 MSK-IMPACT); one of 10 amplification-driven recurrent drivers; no independent OS association in this cohort. [PMID:33795256](../papers/33795256.md)

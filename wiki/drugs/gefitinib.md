...
- Cited as the sole phase II agent trialed in metastatic cutaneous SCC (cSCC), reporting an 18% CR rate; the authors argue [EGFR](../genes/EGFR.md) pathway biomarker refinement ([EGFR](../genes/EGFR.md) S720F, amplification) is needed before uniform EGFR targeting in this disease [PMID:25589618](../papers/25589618.md)

...
PCSK9 (proprotein convertase subtilisin/kexin type 9) encodes a serine protease that promotes [LDLR](../genes/LDLR.md) degradation, thereby regulating LDL cholesterol uptake. Beyond its established cardiovascular role, PCSK9 has been identified as a component of the cholesterol-uptake axis dysregulated in hepatocellular carcinoma ([HCC](../cancer_types/HCC.md)), where altered cholesterol homeostasis contributes to tumor growth, lipid metabolism reprogramming, and resistance to systemic therapies.
...
- Whether direct PCSK9 inhibition has anti-tumor activity in HCC, beyond its cardiovascular application, remains to be demonstrated in clinical studies.

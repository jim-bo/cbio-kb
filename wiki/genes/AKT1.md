...
- AKT1 mutation identified in ARID1A-mutant ovarian cancer functional genomics screen as a synthetic lethal vulnerability with BET bromodomain inhibition [PMID:41049615](../papers/41049615.md)
...
- Phosphorylated at S473 in [GBC](../cancer_types/GBC.md) cells in response to paracrine rh-SEMA7A; PI3K inhibition by LY294002 blocked downstream p-EP300 S1834, placing AKT1 upstream of [EP300](../genes/EP300.md) in the SEMA7A/ITGB1 signaling cascade [PMID:40830485](../papers/40830485.md)
...
- Cross-disease context: SF3B1-driven alternative splicing targets AKT1 in other cancers (e.g. breast cancer); used as comparison context in a CLL study where SF3B1-K700E activates mTORC1/MYC via [NFATC1](../genes/NFATC1.md) mis-splicing rather than AKT1 [PMID:40694421](../papers/40694421.md)
...
- In a proteogenomic study of 99 GBMs, AKT1 is potentially activated downstream of [PTEN](../genes/PTEN.md) loss in proneural, mesenchymal, and classical subtypes; AKT1 protein levels correlate with diacylglycerol (DG) levels in lipidomic profiling. [PMID:33577785](../papers/33577785.md)
...
- Referenced as a downstream [KRAS](../genes/KRAS.md) signaling axis effector (along with PAK1/PAK2 and MAPK-ERK/PI3K) in PDAC proteogenomics; combined PAK1/2 + MAPK-ERK/PI3K-AKT-mTOR inhibition proposed as a strategy to target KRAS-driven signaling in pancreatic ductal adenocarcinoma. [PMID:34534465](../papers/34534465.md)
...
- Co-occurs with [FGFR3](../genes/FGFR3.md) alterations as part of the PI3K-pathway co-alteration pattern alongside [PIK3CA](../genes/PIK3CA.md) and [TSC1](../genes/TSC1.md) [PMID:37682528](../papers/37682528.md).

## Therapeutic relevance

- Acquired AKT1 activation is a candidate bypass resistance mechanism to [erdafitinib](../drugs/erdafitinib.md); supports rationale for AKT or PI3K-pathway combinations [PMID:37682528](../papers/37682528.md).

## Open questions

- Whether AKT1-directed combinations can prevent or reverse [erdafitinib](../drugs/erdafitinib.md) resistance in FGFR3-altered UC is untested [PMID:37682528](../papers/37682528.md).

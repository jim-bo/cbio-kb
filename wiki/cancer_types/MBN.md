...
Mature B-Cell Neoplasms is a broad OncoTree category encompassing post-germinal-center B-cell malignancies classified under Non-Hodgkin Lymphoma (NHL). It includes subtypes such as [CLLSLL](../cancer_types/CLLSLL.md) (Chronic Lymphocytic Leukemia/Small Lymphocytic Lymphoma) and [DLBCLNOS](../cancer_types/DLBCLNOS.md) (Diffuse Large B-Cell Lymphoma, NOS). These tumors arise in lymphoid tissue and generally show point mutation dominance over structural variants.

## Cohorts in the corpus

- PCAWG pan-cancer WGS cohort (n=2,658 tumors, 38 types): mature B-cell lymphomas contributed to the pan-cancer driver and mutational process analyses [PMID:32025007](../papers/32025007.md).
...
- [CLLSLL](../cancer_types/CLLSLL.md) — Chronic Lymphocytic Leukemia/Small Lymphocytic Lymphoma.
- [DLBCLNOS](../cancer_types/DLBCLNOS.md) — Diffuse Large B-Cell Lymphoma, NOS.

## Therapeutic landscape

*No drug-level data from the current corpus.*

...
SLC27A4, also known as fatty acid transport protein 4 (FATP4), is a plasma membrane fatty acid transporter that selectively imports monounsaturated fatty acids (MUFAs). In hepatocellular carcinoma (HCC), SLC27A4 upregulation enables cancer cells to preferentially import MUFAs, raising the MUFA:PUFA ratio in membrane phospholipids and thereby protecting against lipid peroxidation and ferroptosis. This mechanism confers sorafenib resistance, as sorafenib partially acts via induction of ferroptotic cell death.

...
- RUNX1 is recurrently mutated in [MDS](../cancer_types/MDS.md) (myelodysplastic syndromes), co-occurring with [STAG2](../genes/STAG2.md) mutations in the Tokyo cohort [PMID:40720765](../papers/40720765.md)
- Homozygous deletion in 2 cases of breast cancer (Broad WES, 103 tumors); partner of [CBFB](../genes/CBFB.md) in transcription factor complex; CBFB/RUNX1 inactivation highlights role of differentiation transcription factors in breast cancer [PMID:22722202](../papers/22722202.md)
...
- Mutated in 2/21 sequenced sinonasal adenoid cystic carcinomas (AdCC; 9%); frameshift duplications/deletions detected; chromatin-regulatory context alongside [EP300](../genes/EP300.md), [KDM6A](../genes/KDM6A.md), and [BCOR](../genes/BCOR.md) mutations [PMID:39760648](../papers/39760648.md)
...
- Identified as a Mut-driver transcription factor in the METABRIC 2,433-tumor breast cancer cohort; co-mutation with [CDH1](../genes/CDH1.md) is characteristic of invasive lobular carcinoma biology ([CDH1](../genes/CDH1.md) co-mutated with [PIK3CA](../genes/PIK3CA.md), [TBX3](../genes/TBX3.md), RUNX1, and [ERBB2](../genes/ERBB2.md); OR=5.7 for [CDH1](../genes/CDH1.md)+[ERBB2](../genes/ERBB2.md) co-mutation). [PMID:27161491](../papers/27161491.md)
...
- Germline heterozygous splice-site c.806-2A>G in [AML](../cancer_types/AML.md) — diagnostic of familial platelet disorder; HLA-matched sibling and father carried the same variant, prompting selection of an unrelated donor for bone-marrow transplant [PMID:28007021](../papers/28007021.md)
...
- In [MDS](../cancer_types/MDS.md), clonal and subclonal RUNX1 mutations carried equivalent leukemia-free-survival risk, consistent with its previously published survival effect. [PMID:24030381](../papers/24030381.md)
- RUNX1::[RUNX1T1](../genes/RUNX1T1.md) fusion defines a favorable-outcome core-binding-factor AML category (110 cases, 12.4%) with high granulocyte-monocyte progenitor scores; RUNX1 loss-of-function alterations (with [ETV6](../genes/ETV6.md)) were separately enriched in the immature/Unclassified AML subset. [PMID:38212634](../papers/38212634.md)
- Altered in 3 of 25 (12%) invasive lobular breast carcinomas, alongside [CCND1](../genes/CCND1.md), [PAK1](../genes/PAK1.md), [PTEN](../genes/PTEN.md) and [KMT2C](../genes/KMT2C.md). [PMID:38347189](../papers/38347189.md)

## Cancer types (linked)

- Clonal hematopoiesis in patients with nonhematologic cancer — RUNX1-mutant CH anticipates progression to hematologic malignancy [PMID:38147626](../papers/38147626.md).
...
- RUNX1-mutant CH may warrant closer hematologic surveillance in solid-tumor patients [PMID:38147626](../papers/38147626.md).

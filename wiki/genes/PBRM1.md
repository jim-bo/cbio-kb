...
- Loss-of-function mutations in PBRM1 define a molecular subtype of ccRCC associated with distinct immune infiltration and immunotherapy response patterns [PMID:40834854](../papers/40834854.md)
...
- Flagged as a SWI/SNF chromatin-remodeling complex partner (alongside [ARID1B](../genes/ARID1B.md)) in the genomic landscape of sinonasal adenoid cystic carcinoma [PMID:39760648](../papers/39760648.md)
...
- PBRM1 was mutated in 44% of metastatic [RCC](../cancer_types/RCC.md) tumors in the IMmotion150 trial; mutants had higher Angio-signature expression and better PFS on [sunitinib](../drugs/sunitinib.md) (HR 0.38), while [atezolizumab](../drugs/atezolizumab.md) monotherapy performed worse than sunitinib in the PBRM1-mutant subgroup (HR 2.49) [PMID:29867230](../papers/29867230.md).
...
- Endometrial cancer ([UCEC](../cancer_types/UCEC.md)) / ovarian cancer ([OVT](../cancer_types/OVT.md)) — PBRM1 mutations detected in the dMMR/MSI-H gynecologic cancer cohort; not differentially enriched by response to PD-1 blockade [PMID:38653864](../papers/38653864.md).

## Co-occurrence and mutual exclusivity

- Co-occurs with other SWI/SNF complex alterations ([ARID1A](../genes/ARID1A.md) 82%, [ARID2](../genes/ARID2.md)) in the dMMR gynecologic cancer cohort [PMID:38653864](../papers/38653864.md).

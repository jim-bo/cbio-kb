...
- Used as an external reference cohort for cross-species transcriptome comparison; 10.5% TP53/PIK3CA co-mutation rate cited to contextualize rat CRISPR model findings [PMID:41000773](../papers/41000773.md)
- Served as the validation cohort for the three [ILC](../cancer_types/ILC.md) transcriptional subtypes (reactive-like, immune-related, proliferative); reactive-like [ILC](../cancer_types/ILC.md) had better DSS (HR=0.47, p=0.038) and OS (HR=0.50, p=0.023) than proliferative [ILC](../cancer_types/ILC.md) [PMID:26451490](../papers/26451490.md)

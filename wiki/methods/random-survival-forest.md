...
- Used LASSO regression and random survival forest to select four variables (mitotic count, Ki-67+ density, CD163+ density, MTOR mutation) for an integrated risk-stratification model in solitary fibrous tumors, validated across four cohorts [PMID:37980418](../papers/37980418.md).

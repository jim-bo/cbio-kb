...
- The four novel hypermutated SMGs identified in the CPTAC colon study ([CASP5](../genes/CASP5.md), [RNF43](../genes/RNF43.md), [LTN1](../genes/LTN1.md), [BMPR2](../genes/BMPR2.md)) were not reported in the original TCGA colorectal analysis, possibly due to the MSI-H enrichment of the CPTAC prospective cohort.

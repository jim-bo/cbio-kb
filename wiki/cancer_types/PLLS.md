...
- [sarc_mskcc](../datasets/sarc_mskcc.md): 24 PLLS patients (11.6% of 207 high-grade [STS](../cancer_types/STS.md)), profiled by targeted resequencing (722 genes), 250K SNP-array SCNA, LOH, and expression arrays. [PMID:20601955](../papers/20601955.md)

## Recurrent alterations

- [TP53](../genes/TP53.md) — mutated in 17% of PLLS; the only subtype in the seven-subtype cohort in which [TP53](../genes/TP53.md) mutations were detected. [PMID:20601955](../papers/20601955.md)
- [NF1](../genes/NF1.md) — mutated in 8% of PLLS (point mutations + genomic deletions); biallelic inactivation observed in some tumors; loss linked to mTOR pathway activation. First report of somatic [NF1](../genes/NF1.md) alterations outside MPNST/GIST in the context of [NF1](../genes/NF1.md) patients. [PMID:20601955](../papers/20601955.md)
...
- [ERBB4](../genes/ERBB4.md) — mutations found on resequencing of PLLS and [MFS](../cancer_types/MFS.md) samples. [PMID:20601955](../papers/20601955.md)

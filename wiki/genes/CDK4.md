...
- Elevated kinase activity in colon cancer tumors ([COAD](../cancer_types/COAD.md) proteomic study); identified as a targetable therapeutic candidate — CDK4 inhibitors (palbociclib-class) approved; supports CDK4 inhibition in CIN-subtype COAD [PMID:31031003](../papers/31031003.md)
...
- Focal gain co-acquired with CDKN2A loss as part of the cell-cycle module in recurrent IDHmut-noncodel glioma (along with [CDK6](../genes/CDK6.md) and [CCND2](../genes/CCND2.md)); this aneuploidy + cell-cycle alteration subgroup has significantly shorter survival (log-rank P < 0.0001), supporting potential use of CDK inhibitors at recurrence [PMID:31748746](../papers/31748746.md)

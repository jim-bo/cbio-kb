...
- [msk_impact_2017](../datasets/msk_impact_2017.md) — FLC was among 62 principal tumor types profiled in the MSK-IMPACT prospective pan-cancer sequencing initiative (n=10,945 tumors overall).
...
- Fibrolamellar carcinoma is considered a distinct entity from conventional hepatocellular carcinoma ([HCC](../cancer_types/HCC.md)); DNAJB1-PRKACA fusion is the defining molecular event and is absent in HCC.

## Therapeutic landscape

- No targeted therapy directly approved for FLC at the time of the MSK-IMPACT publication; PRKACA-targeted strategies (PKA inhibitors) are under investigation. [PMID:28481359](../papers/28481359.md)

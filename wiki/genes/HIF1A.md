...
- Hypoxia regulator gene found within a GISTIC2 deletion peak in a pediatric solid tumor PDX cohort [PMID:37990009](../papers/37990009.md).

## Cancer types (linked)

- [CCRCC](../cancer_types/CCRCC.md): 14q (HIF1A locus) deletion in 45% of tumors; loss associated with aggressive phenotype. In VHL-null mouse models, HIF1A is required for early proximal tubule cell proliferation.

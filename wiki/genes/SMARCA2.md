...
- SMARCA2 target gene set enriched among differentially methylated regions (DMRs) distinguishing EpiC-high from EpiC-low UTUC subtypes by GSEA; part of the SWI/SNF-mutated EpiC-high signature associated with worse OS (HR=6.57) in the IGBMC UTUC cohort (n=40) [PMID:33397444](../papers/33397444.md)

## Cancer types (linked)

- [RMS](../cancer_types/RMS.md) — relapse-specific mutations in FN-RMS (24%); absent at diagnosis, indicating acquired alteration under therapeutic pressure [PMID:37730754](../papers/37730754.md).

## Co-occurrence and mutual exclusivity

- Relapse-acquired in the context of FN-RMS; concurrent relapse alterations included [TP53](../genes/TP53.md) loss, [BCOR](../genes/BCOR.md), and RAS/PIK3CA pathway mutations [PMID:37730754](../papers/37730754.md).

## Therapeutic relevance

- No direct targeted therapy reported in the corpus; SWI/SNF complex disruption at relapse warrants investigation of SMARCA2-directed or epigenetic strategies in relapsed FN-RMS [PMID:37730754](../papers/37730754.md).

## Open questions

- Whether SMARCA2 mutations are detectable in ctDNA at relapse and whether they predict response or resistance to salvage therapies is not addressed in the corpus [PMID:37730754](../papers/37730754.md).

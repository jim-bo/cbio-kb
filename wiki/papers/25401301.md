...
- **Significantly mutated genes in pRCC** (q ≥ 1, FDR ≤ 10%): [[MET]], [SLC5A3](../genes/SLC5A3.md), [NF2](../genes/NF2.md), [PNKD](../genes/PNKD.md), [CPQ](../genes/CPQ.md), [LRP2](../genes/LRP2.md), [CHD3](../genes/CHD3.md), [NHERF1](../genes/NHERF1.md) (SLC9A3R1), [SETD2](../genes/SETD2.md), [CRTC1](../genes/CRTC1.md).
- **Significantly mutated genes in chRCC**: [[TP53]], [[PTEN]], [FAAH2](../genes/FAAH2.md), [[PDHB]], [PDXDC1](../genes/PDXDC1.md), [ZNF765](../genes/ZNF765.md).
- **Significantly mutated genes in renal oncocytoma**: [ERCC2](../genes/ERCC2.md), [C2CD4C](../genes/C2CD4C.md).
- **MET in pRCC**: mutated in 15% (10/65) of pRCC, up from a previously reported 8% (9/121). Nearly all mutations were in the kinase domain. Four newly identified activating alterations (p.Val1088Ala, p.Ile1095Thr, recurrent p.Phe1218Ile, and the extracellular p.Asp153Tyr) were experimentally validated — they conferred elevated MET phosphorylation and anchorage-independent growth of NIH3T3 cells over wild-type MET. MET mutations were mutually exclusive with [[NF2]], [[PTEN]], [TSC1](../genes/TSC1.md) and [MTOR](../genes/MTOR.md) mutations (low frequency, not statistically significant).
...
- **MiTF gene fusions**: known ASPSCR1-[TFE3](../genes/TFE3.md) and PRCC-[[TFE3]] fusions confirmed in tRCCs (validated by FISH). Two tRCCs (14336T, PtS1T) had elevated [[TFE3]] expression *without* TFE3 fusion or amplification; sample 14336T harbored a novel [MIDN](../genes/MIDN.md)-[SBNO2](../genes/SBNO2.md) fusion (chr19p13.3 inversion) placing full-length SBNO2 under the MIDN promoter, with the two highest SBNO2 expression levels seen in these two samples.
...
- **[[TSC1]], [TSC2](../genes/TSC2.md), [[MTOR]]** — recurrent mutations in chRCC, suggesting mTORC1 addiction and possible responsiveness to mTORC1 inhibitors.
...
- **[IDH2](../genes/IDH2.md), [JAK2](../genes/JAK2.md), [[MTOR]]** — among 60 genes with COSMIC hotspot mutations identified as potential drug targets across nccRCC.

...
- COAD/READ tumors with [APC](../genes/APC.md)+[KRAS](../genes/KRAS.md) drivers share mRNA cluster 15 and RPPA C8 but partition into methylation clusters 10 vs 11; [TP53](../genes/TP53.md) and [KRAS](../genes/KRAS.md) are mutually exclusive in COAD/READ but co-occur in [PAAD](../cancer_types/PAAD.md) [PMID:29625049](../papers/29625049.md)

...
- IDH1 acts as an early/founding driver in the epigenetic axis in [AML](../cancer_types/AML.md); co-mutates with [NPM1](../genes/NPM1.md); among the 5234 driver mutations across 76 genes identified in 1540 AML patients enrolled in German-Austrian AMLSG intensive-therapy trials [PMID:27276561](../papers/27276561.md)
...
- R132C mutation in 6 medulloblastoma cases (5 [SHH](../genes/SHH.md), 1 WNT); IDH1-mutant SHH tumours are CIMP+, mirroring G-CIMP in glioma [PMID:28726821](../papers/28726821.md)
...
- IDH1 mutation defines the [LGG](../cancer_types/LGG.md) subgroup that clusters separately from [GBM](../cancer_types/GBM.md) by aneuploidy pattern: IDH-mutant LGG is characterized by 1p loss and 19q gain (1p/19q co-deletion), while IDH-wildtype GBM shows chromosome 7 gain and chromosome 10 loss. [PMID:29622463](../papers/29622463.md)
...
- IDH1 most commonly altered gene in intrahepatic cholangiocarcinoma (30% of IHC, n=195); mutually exclusive with TP53, [SMAD4](../genes/SMAD4.md), [FGFR2](../genes/FGFR2.md), and [KRAS](../genes/KRAS.md); drove 43 patients to OncoKB level 3 classification and enrollment in ivosidenib (AG-120) clinical trial. [PMID:29848569](../papers/29848569.md)
...
- Missense mutations detected at <1% in advanced [HCC](../cancer_types/HCC.md); possibly defines a cholangiocarcinoma-like HCC subset susceptible to selective IDH1 inhibitors such as ivosidenib [PMID:30373752](../papers/30373752.md)
...
- IDH1-mutant GBM PDX (GBM164, GBM196) carry TP53 mutations and homozygous [CDKN2A](../genes/CDKN2A.md) deletion; GBM154 (recurrence of oligodendroglioma) lost IDH1 p.R132H but acquired a novel IDH1 p.F397L variant while retaining 1p/19q co-deletion [PMID:31852831](../papers/31852831.md)
...
- R132H mutation acquired in patient 118725 during clonal evolution toward therapy-related AML in pediatric neuroblastoma; emerged 12 months after NPM1 mutation detection, illustrating multi-step molecular progression [PMID:35078859](../papers/35078859.md)

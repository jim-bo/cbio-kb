...
name: nab-paclitaxel
targets: [TUBB]
drug_class: taxane / microtubule stabilizer (albumin-bound formulation)
...
Nab-paclitaxel (Abraxane; nanoparticle albumin-bound [paclitaxel](../drugs/paclitaxel.md)) is an albumin-formulated taxane that stabilizes microtubules and arrests cells in G2/M. The albumin binding improves solubility and tumor penetration compared to solvent-based [paclitaxel](../drugs/paclitaxel.md). In combination with [gemcitabine](../drugs/gemcitabine.md), it is a standard first-line regimen for metastatic pancreatic adenocarcinoma.
...
- [PAAD](../cancer_types/PAAD.md) — pancreatic adenocarcinoma; dominant first-line regimen (37% of MSK curated cohort) in combination with gemcitabine.

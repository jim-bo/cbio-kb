...
- Authors argue that [DNMT3A](../genes/DNMT3A.md), IDH1/IDH2, and [TET2](../genes/TET2.md) add prognostic value for intermediate-risk classification beyond the then-current markers (FLT3, NPM1, [CEBPA](../genes/CEBPA.md), [KIT](../genes/KIT.md)). [PMID:23634996](../papers/23634996.md)

...
- Used LASSO regression and random survival forest to [select](../methods/select.md) four variables (mitotic count, Ki-67+ density, CD163+ density, [MTOR](../genes/MTOR.md) mutation) for an integrated risk-stratification model in solitary fibrous tumors, validated across four cohorts [PMID:37980418](../papers/37980418.md).

...
Belzutifan (PT2977/MK-6482) is a small-molecule inhibitor of hypoxia-inducible factor 2-alpha ([EPAS1](../genes/EPAS1.md)), the oncogenic HIFα isoform stabilized by loss of the [VHL](../genes/VHL.md) ubiquitin ligase in clear cell renal cell carcinoma ([CCRCC](../cancer_types/CCRCC.md)). By blocking HIF2A's interaction with its obligate dimerization partner ARNT, belzutifan prevents transcription of HIF2A-regulated genes involved in tumor growth, angiogenesis, and dedifferentiation of proximal tubular cells.
...
- No resistance mechanisms to belzutifan are reported in the current corpus.

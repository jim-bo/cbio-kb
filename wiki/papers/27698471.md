...
- **Translational path via T-DM1.** Because [trastuzumab-emtansine](../drugs/trastuzumab-emtansine.md) is already FDA-approved for HER2+ metastatic breast cancer, the authors argue combining T-DM1 with IR "warrants speedy clinical evaluation" in HER2+ locally advanced disease (esophageal, gastric, breast).

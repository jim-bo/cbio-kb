...
- No direct letrozole resistance mechanisms reported in the current corpus; cited as a benchmark comparator for endocrine-response gene signatures [PMID:26437033](../papers/26437033.md).
...
- [PMID:26437033](../papers/26437033.md) — Bu et al. (bioRxiv 2025). Rat somatic genome editing models of ER+ breast cancer; letrozole (GSE5462) used as benchmark neoadjuvant endocrine-therapy transcriptomic reference dataset.

...
PDGFRA encodes platelet-derived growth factor receptor alpha; activating mutations and amplifications drive a subset of [GIST](../cancer_types/GIST.md) and gliomas.
...
- PDGFRA harbors 34 newly identified hotspots from a 3,130-sample glioma meta-analysis; identified alongside [EGFR](../genes/EGFR.md) hotspots in adult glioma [PMID:31263031](../papers/31263031.md)
...
- No amplification observed in any [GBM](../cancer_types/GBM.md) PDX (n=84) despite ~15% expected frequency in IDH-wildtype [GBM](../cancer_types/GBM.md); three PDX carried SNVs including D842V; GBM159 demonstrated PDX-engraftment-associated amplification loss (FISH: 45–75% of patient cells amplified, none in PDX) [PMID:31852831](../papers/31852831.md)
- Top druggable kinase nominated by a BRAFFusion-specific phosphosite module in pediatric [LGG](../cancer_types/LGG.md); PDGFRA RNA/protein in BRAFFusion [LGG](../cancer_types/LGG.md) were comparable to HGG levels, motivating evaluation of PDGFRA inhibitors in this subtype. [PMID:33242424](../papers/33242424.md)
...
- Amplified preferentially in proneural and IDH-mutant [GBM](../cancer_types/GBM.md) tumors; elevated phospho-S1067/S1070; trans-phosphorylates [PTPN11](../genes/PTPN11.md) Y546/Y584 [PMID:33577785](../papers/33577785.md)
...
- PDGFRA referenced among NSCLC-typical mutations detected in [SCLC](../cancer_types/SCLC.md) PDX subsets (MSK1053, MSK511c, MSK773) in a 26-clinical + 42 PDX/CDX [SCLC](../cancer_types/SCLC.md) characterization study [PMID:35440124](../papers/35440124.md)
...
- [NBL](../cancer_types/NBL.md) — expressed in undifferentiated nC3 and MSC nC1 clusters; co-expressed with [PRRX1](../genes/PRRX1.md) and [YAP1](../genes/YAP1.md) as mesenchymal markers; absent in low-risk 4S tumors by RNAscope. [PMID:34493726](../papers/34493726.md)
...
- Whether PDGFRA amplification should upgrade IDH-mutant [LGG](../cancer_types/LGG.md) molecular grade is unresolved [PMID:37910594](../papers/37910594.md).

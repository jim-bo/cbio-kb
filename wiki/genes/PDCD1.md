...
- PDCD1 (PD-1) expression measured alongside [CD274](../genes/CD274.md) (PD-L1) in 684 never-smoker lung adenocarcinomas; combined [CD274](../genes/CD274.md)+PDCD1 R²=0.093 for ICB response (TIDE score), much lower than subtype-augmented R²=0.25, demonstrating that transcriptomic subtype adds predictive value beyond immune checkpoint markers [PMID:32015526](../papers/32015526.md)

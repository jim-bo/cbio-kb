...
Prospective international cohort study of advanced [NSCLC](../cancer_types/NSCLC.md) patients undergoing plasma ctDNA sequencing via the Resolution Bioscience ctDx Lung platform, evaluating ctDNA detection as a prognostic and therapy-matching biomarker [PMID:36357680](../papers/36357680.md).

## Composition

- 1,127 adults with stage IV or recurrent [NSCLC](../cancer_types/NSCLC.md) analyzed (1,357 initially enrolled) at Memorial Sloan Kettering (New York) and GenesisCare (Sydney, Australia); cancer types [LUAD](../cancer_types/LUAD.md) and [LUSC](../cancer_types/LUSC.md); most (1,003; 89%) provided a single plasma sample [PMID:36357680](../papers/36357680.md).

## Assays / panels (linked)

- [ctDx Lung](../methods/ctdx-lung.md) targeted plasma NGS; MSK patients additionally profiled with tissue [MSK-IMPACT](../methods/IMPACT468.md), and from June 2019 with plasma [MSK-ACCESS](../methods/ACCESS129.md); both MSK assays use matched WBC sequencing to remove clonal hematopoiesis and germline variants [PMID:36357680](../papers/36357680.md).

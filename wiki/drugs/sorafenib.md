...
targets:
  ...
  - RET
  - FLT3
drug_class: multi-target kinase inhibitor (RAF/VEGFR/PDGFR)
...
- Activating [RET](../genes/RET.md) mutations in metastatic MTCs (PN3, PN7, PN8) and high [PIK3R2](../genes/PIK3R2.md) expression (PN1) informed sorafenib recommendations in the POG NEN WGTA cohort (n=28) [PMID:40328872](../papers/40328872.md)
...
- In a phosphoproteogenomic [HCC](../cancer_types/HCC.md) dataset (n=122 biopsies), sorafenib is cited alongside [regorafenib](../drugs/regorafenib.md) as a current standard agent; authors note preclinical evidence of synergy between AURKA/CDK inhibitors (elevated by KSEA) and sorafenib as motivation for targeted combination strategies in HCC [PMID:35508466](../papers/35508466.md)
- Multi-kinase/FLT3 inhibitor; in Beat [AML](../cancer_types/AML.md) Waves 3+4 (n=805), sorafenib sensitivity in FLT3-ITD [AML](../cancer_types/AML.md) is conditional on maturation state: Progenitor-like scores predict sensitivity, Monocyte-like scores confer resistance [PMID:35868306](../papers/35868306.md)
- Sorafenib is a first-line TKI for advanced [HCC](../cancer_types/HCC.md) with ORR of ~26%; resistance mechanisms catalogued in this review include [SLC27A4](../genes/SLC27A4.md)-mediated MUFA import suppressing ferroptosis, [SCD](../genes/SCD.md)-driven PUFA:MUFA lowering, phosphatidic acid/RTK upregulation, [ACSL4](../genes/ACSL4.md) loss, 27-hydroxycholesterol-driven [GPX4](../genes/GPX4.md) upregulation, and [FASN](../genes/FASN.md)-stabilized HIF1α/SLC7A11 axis — multiple combinations ([FASN](../genes/FASN.md) inhibitors, [SCD](../genes/SCD.md) inhibitors, ND-654) sensitize HCC to sorafenib preclinically [PMID:41118283](../papers/41118283.md).

...
- Mutated in 11.2% of patients in the 1,148-patient CLL map, making it one of the top four cardinal CLL drivers alongside [SF3B1](../genes/SF3B1.md), [NOTCH1](../genes/NOTCH1.md), and [TP53](../genes/TP53.md) [PMID:35927489](../papers/35927489.md).
- Inactivating mutations (frameshift, nonsense, splice site) in 10% of sporadic [ANGS](../cancer_types/ANGS.md) vs only 2% of radiation-associated (RT) angiosarcoma (n=44 RT-AS, n=135 sporadic AS); ATM alterations were depleted in the RT-AS setting [PMID:37350195](../papers/37350195.md).
...
- ATM mutated in 19% of gallbladder carcinoma; trend toward mutual exclusivity with [TP53](../genes/TP53.md) [PMID:30427539](../papers/30427539.md)
...
- ATM altered in 7% of mCRPC tumors; as part of the homologous-recombination repair gene set (with [BRCA2](../genes/BRCA2.md), BRCA1), no association with survival or time on ARSI was detected in this 429-patient tumor cohort (composite P=0.495/0.611), contrasting with prior cfDNA-based findings [PMID:31061129](../papers/31061129.md)
- ATM recurrently mutated in high-grade [UTUC](../cancer_types/UTUC.md) at a frequency not significantly different from TCGA UCB; identified among DNA-damage response genes in the genomic landscape of upper tract urothelial carcinoma [PMID:31278255](../papers/31278255.md)
...
- ATM mutations present but rare in MSI-stable esophageal/GEJ adenocarcinoma (n=237); not independently driving the TP53-pathway signal, which was dominated by TP53 truncating bi-allelic mutations and [MDM2](../genes/MDM2.md) amplification [PMID:35377946](../papers/35377946.md)

## Cancer types (linked)

- CLL — ATM is a cardinal known driver recovered as significantly mutated across the integrated CLL cohort [PMID:35927489](../papers/35927489.md).
...
- Not specifically reported in the corpus for ATM partners [PMID:35927489](../papers/35927489.md).

## Therapeutic relevance

- No ATM-directed therapy is reported in the corpus for CLL [PMID:35927489](../papers/35927489.md).

## Open questions

- The CLL map does not resolve whether ATM mutation prognostic impact is preserved in the ibrutinib/venetoclax era [PMID:35927489](../papers/35927489.md).

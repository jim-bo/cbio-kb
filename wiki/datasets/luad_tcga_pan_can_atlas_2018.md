...
- [PMID:40970133](../papers/40970133.md) — Zhao et al. 2025, *bioRxiv*: Sherlock-Lung NS-LUAD transcriptomic subtyping; 74 TCGA-LUAD never-smoker cases contributed to the discovery cohort.
...
- Contributed 74 never-smoker LUAD cases to the 684-sample Sherlock-Lung NS-LUAD transcriptomic cohort; 13 cases also had matched WGS used for driver-mutation integration; transcriptomic subtypes (steady/proliferative/chaotic) were concordant across Sherlock and TCGA-derived never-smoker subsets [PMID:40970133](../papers/40970133.md)

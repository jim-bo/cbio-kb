...
SLIT3 (Slit Guidance Ligand 3) is an extracellular matrix protein that acts as a repulsive guidance cue for axons and migrating cells through binding to Robo receptors. Its role in cancer is not well characterized; it has been identified as preferentially mutated in [NSCLC](../cancer_types/NSCLC.md) tumors with durable clinical benefit from PD-1 blockade.

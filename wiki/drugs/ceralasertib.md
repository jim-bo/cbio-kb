...
Ceralasertib (AZD6738) is a selective ATP-competitive inhibitor of [ATR](../genes/ATR.md) (ataxia telangiectasia and RAD3-related) kinase, a key regulator of the DNA damage response (DDR) replication-stress checkpoint. It is under clinical development as monotherapy and in combinations with PARP inhibitors and chemotherapy across multiple tumor types. In the UCLA sarcoma PDTO screen, it showed the most significant differential sensitivity in osteosarcoma of any single agent.
...
- [OS](../cancer_types/OS.md) — osteosarcoma; strongest differential sensitivity signal in pan-sarcoma PDTO screen (p=0.00026).

...
- Deletion (HR 3.3, 95% CI 1.1–9.5, P=0.030) independently predicts worse OS in node-positive (N1) intrahepatic cholangiocarcinoma; combined CDKN2A/B deletion (HR 5.0) part of the poor-prognosis composite ([TP53](../genes/TP53.md) mut / [KRAS](../genes/KRAS.md) mut / CDKN2A/B del): median OS 12.1 vs 30.9 months (P=0.002) [PMID:33963001](../papers/33963001.md)
...
- CDKN2A among the genes listed in the genomic landscape of [SCLC](../cancer_types/SCLC.md) PDX/CDX cohort (n=46 models from 33 MSK patients); canonical [SCLC](../cancer_types/SCLC.md) genomic landscape dominated by [TP53](../genes/TP53.md) and [RB1](../genes/RB1.md) loss [PMID:35440124](../papers/35440124.md)

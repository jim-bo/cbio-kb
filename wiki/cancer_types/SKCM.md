...
- 38 pretreatment metastatic SKCM biopsies profiled by WES and RNA-seq to identify genomic and transcriptomic correlates of anti-PD-1 response; the IPRES mesenchymal/angiogenic transcriptional program defined innate resistance in 9/13 non-responders vs 1/15 responders, and [BRCA2](../genes/BRCA2.md) LOF mutations were enriched in responders (28% vs 6%, Fisher P=0.002, OR=6.2) [PMID:26997480](../papers/26997480.md)
- Cutaneous melanoma (SKCM) used as comparator to acral melanoma ([ACRM](../cancer_types/ACRM.md)): SKCM harbours canonical UV-signature BRAF/NRAS/NF1 drivers and higher mutation burden, contrasting with [ACRM](../cancer_types/ACRM.md)'s structural-variant dominance and UV-signature absence [PMID:28373299](../papers/28373299.md)
- Riaz et al. profiled paired pre- and on-therapy biopsies from 68 advanced melanoma patients on anti-PD-1 ([nivolumab](../drugs/nivolumab.md), CA209-038 trial), demonstrating that pre-therapy TMB predicts [OS](../cancer_types/OS.md) in ipilimumab-naive but not ipilimumab-progressed patients, and that genomic contraction (selective depletion of neoantigenic clones on-therapy) in responders provides evidence of immunoediting under PD-1 blockade [PMID:29033130](../papers/29033130.md)
- MC3 pan-cancer mutation-calling project (10,510 TCGA pairs) included SKCM; concordance with the legacy PanCan12 MAF exceeded 90%; SKCM had the largest median SNVs per sample along with [LUSC](../cancer_types/LUSC.md) and [LUAD](../cancer_types/LUAD.md), consistent with UV-mutagen exposure [PMID:29596782](../papers/29596782.md)
- Pan-cancer fusion study (9,624 TCGA samples) included SKCM; SKCM (melanoma) clustered in the neural-lineage arm-level group with [GBM](../cancer_types/GBM.md) and [LGG](../cancer_types/LGG.md) in the aneuploidy analysis; druggable fusions annotated across 29 cancer types including SKCM [PMID:29617662](../papers/29617662.md)
...
- BRAF-mutant SKCM tumors in C3 immune subtype have higher CD8 T-cell fraction than NRAS-mutant tumors (ANOVA P<2e-5); a CD8-CD274(PD-L1)-PDCD1(PD-1) signaling loop recovered, suggesting [BRAF](../genes/BRAF.md)+PD-L1 co-targeting may be synergistic [PMID:29625049](../papers/29625049.md)
- SKCM leads in OncoKB Level 1/2A actionable alteration frequency at 46% (driven by [BRAF](../genes/BRAF.md) hotspots at 51%); RTK-RAS alteration rate 95% in SKCM; PI3K+RAF combination actionable in 12% [PMID:29625050](../papers/29625050.md)

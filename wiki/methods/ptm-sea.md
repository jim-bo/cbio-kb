...
Post-Translational Modification Signature Enrichment Analysis (PTM-SEA) tests phosphosite-level (and other PTM) data against curated perturbation and kinase-signature sets to infer pathway and kinase activity.
...
- Not a cBioPortal gene panel or registered molecular-profile type; corpus-grown slug.

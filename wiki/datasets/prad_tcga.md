...
- Used to validate [NOL10](../genes/NOL10.md) overexpression in tumor vs. normal prostate, allele-specific [BCR](../genes/BCR.md) and survival outcomes (rs4519489 A/A genotype HR=13.05 for OS, P=0.038), and correlation of elevated [NOL10](../genes/NOL10.md) with advanced T stage (P=0.0058), lymph-node metastasis (P=0.045), and Gleason score (P=0.015) [PMID:41062477](../papers/41062477.md).

...
# MSK-IMPACT 410 (IMPACT410)

## Overview

Targeted (410 cancer genes) sequencing of various tumor types via MSK-IMPACT on Illumina HiSeq sequencers — canonical cBioPortal gene panel `IMPACT410`.

## Used by

- [PMID:37078708](../papers/37078708.md) — one of the panel eras used to profile 132 adults with nodal [PTCL](../cancer_types/PTCL.md) at MSK; identified [TP53](../genes/TP53.md) mutations (16%, 21/132) as inferior-PFS markers and [CDKN2A](../genes/CDKN2A.md) deletions (7%) as inferior-OS markers [PMID:37078708](../papers/37078708.md).
- [PMID:37315267](../papers/37315267.md) — MSK-IMPACT (410–505 genes) was used in 40% of 61 extremity rhabdomyosarcoma patients; identified [MED12](../genes/MED12.md) alterations, [CDK4](../genes/CDK4.md) amplifications, and [CDKN2A](../genes/CDKN2A.md) deletions as recurrent [ARMS](../cancer_types/ARMS.md) events, with mutually exclusive [CDK4](../genes/CDK4.md) amp / [CDKN2A](../genes/CDKN2A.md) del correlating with poor OS (P=.02) [PMID:37315267](../papers/37315267.md).
...
- Used alongside [IMPACT341](../methods/IMPACT341.md) to sequence 105 NMIBC tumors from the [blca_nmibc_2017](../datasets/blca_nmibc_2017.md) cohort; identified [ARID1A](../genes/ARID1A.md) mutations as the only gene significantly associated with BCG recurrence [PMID:28583311](../papers/28583311.md)
- 410-gene version of MSK-IMPACT applied to a subset of 295 metastatic [EGC](../cancer_types/EGC.md) patients in the MSKCC prospective sequencing cohort [PMID:29122777](../papers/29122777.md)
...
- 175 out of 195 cholangiocarcinoma patients in the [chol_msk_2018](../datasets/chol_msk_2018.md) cohort were sequenced with the 410-gene IMPACT410 panel; median coverage 759×; standard DNA input 250 ng (50 ng minimum) [PMID:29848569](../papers/29848569.md)
- Applied to 127 of 197 advanced endometrial cancer tumors in the MSK prospective cohort at average ~735× coverage; used alongside [IMPACT341](../methods/IMPACT341.md) to sequence all 189 patients [PMID:30068706](../papers/30068706.md)
...
- Used alongside [IMPACT341](../methods/IMPACT341.md) and [IMPACT468](../methods/IMPACT468.md) in 26,743 MSK-IMPACT pan-cancer cohort; [CDK12](../genes/CDK12.md) is included in all three panel versions [PMID:32317181](../papers/32317181.md)
- Used to sequence 190 of 604 surgically resected stage I–III [LUAD](../cancer_types/LUAD.md) patients (1.06 Mb coverage) in a histologic-subtype genomic landscape study at MSKCC [PMID:32791233](../papers/32791233.md)
...
- IMPACT410 sequenced 9,674 of the 54,331 tumors in the 50k-sample MSK-IMPACT pan-cancer hotspot-discovery cohort. [PMID:41895280](../papers/41895280.md)
- IMPACT410 sequenced 200 of the 1,254 biliary tract cancer samples in this MSK cohort. [PMID:42360806](../papers/42360806.md)

## Notes

- The 410-gene panel is the middle generation of MSK-IMPACT, intermediate between [IMPACT341](../methods/IMPACT341.md) and [IMPACT468](../methods/IMPACT468.md) [PMID:37078708](../papers/37078708.md).

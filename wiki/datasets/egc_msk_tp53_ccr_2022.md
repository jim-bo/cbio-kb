...
- A 4-tier [TP53](../genes/TP53.md) pathway severity classification ([MDM2](../genes/MDM2.md) amplification → TP53 truncating bi-allelic → other TP53 pathway mutation → TP53 pathway wild-type) stratified pathologic response rates (p=0.004, q=0.07) [PMID:35377946](../papers/35377946.md).

...
- **Assays**: [[[whole-exome-seq](../methods/whole-exome-seq.md)|whole-exome sequencing]] (Agilent SureSelect All Exon 50Mb, Illumina HiSeq 2000, ~82× mean coverage) on 140 tumor-normal pairs + 5 tumor-only; [[[targeted-dna-seq](../methods/targeted-dna-seq.md)|targeted SPET capture]] using NuGEN Ovation Cancer Panel (344 genes) on 19 pRCCs; [[[rna-seq](../methods/rna-seq.md)]] on 159 tumors (TruSeq, HiSeq 2000, ~68M PE reads/sample); SNP-based copy-number profiling ([[[affymetrix-snp6](../methods/affymetrix-snp6.md)|Illumina HumanOmni2.5-8]] arrays); orthogonal validation by [[[sanger-sequencing](../methods/sanger-sequencing.md)]] (96% indel validation rate), [[[sequenom-genotyping](../methods/sequenom-genotyping.md)|mass-spectrometry genotyping]] (92% SNV validation rate) and [[[fish](../methods/fish.md)|FISH]] for amplifications and translocations.
- Reads aligned with [[[bwa](../methods/bwa.md)|BWA]] to GRCh37/hg19; mutational signatures derived using the Genentech/Huber pipeline.

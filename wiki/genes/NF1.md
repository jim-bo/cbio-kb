...
NF1 encodes neurofibromin, a RAS GAP tumor suppressor. Loss activates RAS signaling and is recurrent across diverse cancer types including lung adenocarcinoma, [MPNST](../cancer_types/MPNST.md), anaplastic thyroid carcinoma, rhabdomyosarcoma, endometrial carcinoma, melanoma, and hepatocellular carcinoma.
...
- Mutated in 2% (3/145) of esophageal adenocarcinomas; MAPK-pathway mutations are uncommon in [EAC](../cancer_types/EAC.md), contrasting with colorectal cancer where [BRAF](../genes/BRAF.md) mutations are frequent [PMID:23525077](../papers/23525077.md)
...
- Single frameshift mutation identified in the sinonasal adenoid cystic carcinoma cohort; observed as a minor single-case hit [PMID:39760648](../papers/39760648.md)
...
- NF1 added to the significantly mutated gene list in MSI gastric tumors after inclusion of indels [PMID:25079317](../papers/25079317.md)
...
- MAPK-pathway alteration enriched in PA-like [LGG](../cancer_types/LGG.md) (52%) and LGm6-GBM (32%) subtypes in the TCGA/CGGA diffuse glioma cohort [PMID:26824661](../papers/26824661.md)
- NF1 truncating mutations in 3 BRAF/RAS-WT ATCs; all co-occurred with [PTEN](../genes/PTEN.md) truncation (P = 2×10⁻³), suggesting NF1-PTEN co-inactivation as an alternative oncogenic axis in BRAF/RAS-wild-type anaplastic thyroid carcinoma [PMID:26878173](../papers/26878173.md)
...
- Homozygous copy-number deletions in NF1 were manually reviewed and confirmed in melanoma patients treated with [nivolumab](../drugs/nivolumab.md) as part of copy-number analysis from the Riaz et al. cohort [PMID:29033130](../papers/29033130.md)
...
- Two LP/PVs (one pLoF, one truncating intronic splice-region variant) in German pediatric cancer predisposition cohort; burden OR=9.8, p=.020 single-cohort, confirmed in joint analysis; one carrier (LPP_20) co-carried [CHEK2](../genes/CHEK2.md) LP/PV and lacked typical NF1 clinical features; no CNV analysis performed so carrier frequency may be underestimated. [PMID:40857049](../papers/40857049.md)
...
- NF1 (with [RASA1](../genes/RASA1.md)) is a RAS-pathway negative regulator; NF1 loss is mutually exclusive with [EGFR](../genes/EGFR.md) amplification in glioma and other cancers, and is mutually exclusive with KRAS/BRAF mutation in the RTK-RAS pathway across the TCGA pan-cancer oncogenic signaling analysis [PMID:29625050](../papers/29625050.md)
...
- NF1 loss-of-function mutations >2-fold enriched after endocrine therapy in HR+HER2- breast cancer (p=4e-4); typically acquired or selected under therapy (not detected in matched primaries); CRISPR knockout in MCF7 increased MAPK signaling and induced [fulvestrant](../drugs/fulvestrant.md) resistance reversible by ERK inhibition [PMID:30205045](../papers/30205045.md)
- Germline pathogenic NF1 alleles tied to neurofibromatosis type 1 predisposition in glioma patients; somatic NF1 and [PTPN11](../genes/PTPN11.md) alterations preferentially enriched in recurrent lower-grade IDH-WT tumors (P<0.05). [PMID:31263031](../papers/31263031.md)
- NF1 altered in 9% of neuroblastoma PDX models (nonsense/frameshift); NF1 inactivation classifier (AUROC 0.77) flags additional pathway-inactive models beyond gene-level mutation; RAS-pathway activation also seen via NF1 T2335fs in Fusion− [RMS](../cancer_types/RMS.md) model Rh-12 [PMID:31693904](../papers/31693904.md).
...
- NF1 mutations in [LUAD](../cancer_types/LUAD.md) (CPTAC n=110) reduced cognate protein and phosphosite abundance; RBM10/NF1 mutations both showed this pattern suggesting post-transcriptional regulation [PMID:32649874](../papers/32649874.md)
- Cited among known [LUAD](../cancer_types/LUAD.md) subclonal genes with higher alteration frequencies in micropapillary/solid (MIP/SOL) vs less invasive histologic subtypes of resected stage I-III [LUAD](../cancer_types/LUAD.md) (n=604, MSK-IMPACT). [PMID:32791233](../papers/32791233.md)
- MAPK-pathway alteration with selectively expanded VAF in post-treatment ctDNA under [alpelisib](../drugs/alpelisib.md) + aromatase inhibitor therapy in HR+ metastatic breast cancer (n=51, MSKCC NCT01870505), consistent with MAPK-pathway bypass resistance. [PMID:32864625](../papers/32864625.md)
...
- Loss-of-function in 23% (N=155) of 696 melanomas ([mel_mskimpact_2020](../datasets/mel_mskimpact_2020.md)); highest median TMB of any driver group (43 mut/Mb); longest TTF on PD-1 monotherapy (22 months, p<0.0001 vs. [BRAF](../genes/BRAF.md) V600 7.5 mo); drug-connectivity signatures nominate MAPK inhibitors; commonly co-altered with RTKs, [BRAF](../genes/BRAF.md) Class 3, or [CBL](../genes/CBL.md) [PMID:33509808](../papers/33509808.md)
- Loss-of-function alterations in [GBM](../cancer_types/GBM.md) ([gbm_cptac_2021](../datasets/gbm_cptac_2021.md)) track with decreased NF1 RNA/protein and upregulated [IRF8](../genes/IRF8.md) (microglial motility TF); drug-connectivity analysis (LINCS L1000 and P100) converges on MAPK inhibitors as top signature-reversing compounds for NF1-altered [GBM](../cancer_types/GBM.md) [PMID:33577785](../papers/33577785.md)
...
- NF1 singleton/rare MAPK pathway alteration in 2/119 [LGSOC](../cancer_types/LGSOC.md) patients (low-grade serous ovarian carcinoma) on MSK-IMPACT panel; contributes to the 60% overall MAPK pathway alteration rate associated with improved OS (multivariate HR 2.5, p=0.019) [PMID:35443055](../papers/35443055.md)
...
- [MPNST](../cancer_types/MPNST.md) — NF1 inactivation enriched in RT-MPNST (67%) vs sporadic [MPNST](../cancer_types/MPNST.md) (36%) [PMID:37350195](../papers/37350195.md).
...
- NF1 loss activates RAS/MAPK signaling; MEK inhibitors rationale applies but no specific trial data reported in this corpus for ATC or [RMS](../cancer_types/RMS.md).
- NF1 mutations in carcinosarcomas from Black EC patients highlight a therapeutic gap where fewer actionable alterations overlap with current trial designs [PMID:37651310](../papers/37651310.md).

## Open questions

- Whether NF1 loss functionally drives leptomeningeal tropism or is a marker of aggressive disease is not resolved [PMID:37591896](../papers/37591896.md).

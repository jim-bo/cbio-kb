...
- [urcc_mskcc_2016](../datasets/urcc_mskcc_2016.md) — 62 high-grade primary unclassified RCC tumors from MSKCC, MSK-IMPACT 230-gene targeted sequencing, RNA-seq, OncoScan SNP arrays, FISH, and IHC [PMID:27713405](../papers/27713405.md).

See also cohorts listed under subtype pages: [CCRCC](CCRCC.md), [PRCC](PRCC.md), [CHRCC](CHRCC.md), [TRCC](TRCC.md).
...
- [Renal Clear Cell Carcinoma (CCRCC)](CCRCC.md) — most common RCC subtype; VHL/3p loss-driven.
- [Renal Non-Clear Cell Carcinoma (NCCRCC)](NCCRCC.md) — umbrella for non-clear-cell subtypes.
  - [Papillary Renal Cell Carcinoma (PRCC)](PRCC.md)
  - [Chromophobe Renal Cell Carcinoma (CHRCC)](CHRCC.md)
  - [Translocation-Associated Renal Cell Carcinoma (TRCC)](TRCC.md)
  - [Unclassified Renal Cell Carcinoma (URCC)](URCC.md)

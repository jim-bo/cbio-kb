...
TSC2 (TSC Complex Subunit 2), encoding tuberin, forms a GTPase-activating protein complex with [TSC1](../genes/TSC1.md) (hamartin) to inhibit [RHEB](../genes/RHEB.md) and consequently mTORC1 signaling. Loss of TSC2 leads to constitutive mTOR activation, driving cellular growth. Germline mutations cause tuberous sclerosis complex; somatic mutations are enriched in the metastatic breast cancer setting, particularly following endocrine therapy, suggesting a role in treatment resistance.

## Alterations observed in the corpus

- TSC2 combined with [TSC1](../genes/TSC1.md): together mutated in 6.3% of HR+/HER2− metastatic breast cancer (mBC) vs 0.7% of HR+/HER2− early breast cancer (eBC; p=0.0004) in 216 mBC patients from French prospective trials (SAFIR01, SAFIR02, SHIVA, MOSCATO); all cases in prior-endocrine-therapy-treated patients. Authors hypothesize outlier response to mTOR inhibitor [everolimus](../drugs/everolimus.md). [PMID:28027327](../papers/28027327.md)
...
- Inactivating/truncating mutations in ~10.6% of advanced [HCC](../cancer_types/HCC.md) (MSK-IMPACT cohort); together with [TSC1](../genes/TSC1.md) defines mTOR negative-regulator loss subtype; one TSC2 E95*-mutant patient achieved disease stabilization with minor tumor shrinkage on [everolimus](../drugs/everolimus.md) after [sorafenib](../drugs/sorafenib.md) progression [PMID:30373752](../papers/30373752.md)
- Somatic alterations in 25% (20/80) of metastatic panNET patients; dominant mTOR-pathway driver; one germline R1200W carrier missed by phenotype-based clinical TSC criteria; acquired splice mutation in one patient at [everolimus](../drugs/everolimus.md) progression; 16 patients with TSC2 somatic alterations at OncoKB Level 2b ([panet_msk_2018](../datasets/panet_msk_2018.md)) [PMID:30687805](../papers/30687805.md)
...
- Loss-of-function in 30% of PEComa alongside [TSC1](../genes/TSC1.md); combined TSC1/TSC2 actionable (Level 3B mTOR inhibition) in 37% of PEComa in 2,138-sample MSK-IMPACT sarcoma cohort [PMID:35705560](../papers/35705560.md)
...
- TSC1/2-mutant HR+/HER2− mBC is hypothesized to be an outlier responder to [everolimus](../drugs/everolimus.md) (mTOR inhibitor, FDA-approved in HR+/HER2− mBC); current evidence is enrichment data, not prospective biomarker trial. [PMID:28027327](../papers/28027327.md)

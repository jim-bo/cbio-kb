...
CDK5 (Cyclin-Dependent Kinase 5) is an atypical CDK that does not require cyclins for activation but instead binds the neuronal activators p35 and p39. Unlike classical CDKs, CDK5 is primarily involved in neuronal migration, synaptogenesis, and axonal guidance. In pediatric brain tumors, CDK5 shows elevated kinase activity in ganglioglioma and a ganglioglioma-rich [LGG](../cancer_types/LGG.md) subgroup, phosphorylating substrates linked to synaptogenesis and glioma-neuron synaptic signaling.
...
- CDK5/GSK3B co-activation in ganglioglioma is mutually exclusive with the CDK1/CDK2 program in HGG, consistent with distinct lineage-specific signaling programs across pediatric brain tumor types [PMID:33242424](../papers/33242424.md)
...
- The functional role of CDK5/GSK3B co-activation in ganglioglioma tumorigenesis vs. its known role in normal neuronal differentiation is unresolved; CDK5 substrates identified (ADD2, SYN1, STMN1) are also present in normal neurons, making therapeutic targeting complex [PMID:33242424](../papers/33242424.md)

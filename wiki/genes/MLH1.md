...
- Promoter hypermethylation in 66% of dMMR/MSI-H gynecologic cancer cohort (n=35) treated with [nivolumab](../drugs/nivolumab.md); mechanism of dMMR (epigenetic vs. genetic) was not associated with differential response [PMID:38653864](../papers/38653864.md)
- In glioblastoma treated with [temozolomide](../drugs/temozolomide.md), alterations in mismatch repair genes including MLH1 are associated with a hypermutator phenotype when [MGMT](../genes/MGMT.md) is methylated [PMID:18772890](../papers/18772890.md).
- Somatic mutations and protein expression loss by IHC detected in a subset of treatment-refractory corticotroph pituitary neuroendocrine tumors (PitNETs); 5 refractory corticotroph tumors had MMR gene mutations confirmed by IHC [PMID:38758238](../papers/38758238.md)
- Truncating mutation identified in one non-GNH hypermutator diffuse pleural mesothelioma case (MSI-high) [PMID:38630790](../papers/38630790.md)
...
- Mismatch repair defect identified in hypermutated [HNSC](../cancer_types/HNSC.md) tumors, alongside [MSH2](../genes/MSH2.md), [MSH6](../genes/MSH6.md), and [POLD1](../genes/POLD1.md) [PMID:27442865](../papers/27442865.md)
...
- MLH1 promoter hypermethylation found in 17/65 (26%) MSI cancer cell lines in the CCLE; MLH1 hypermethylation is the dominant mechanism of MMR silencing in MSI lines without truncating [MSH2](../genes/MSH2.md) mutations. [PMID:31068700](../papers/31068700.md)
...
- MMR gene altered in sarcoma clinical sequencing cohort (n=2,138); collectively MLH1, [MSH2](../genes/MSH2.md), [MSH6](../genes/MSH6.md), [PMS2](../genes/PMS2.md) altered in sarcomas [PMID:35705560](../papers/35705560.md)
...
- Gynecologic cancers (endometrial, ovarian): MLH1 promoter hypermethylation is the dominant mechanism of MMR deficiency, accounting for 66% of dMMR cases in a [nivolumab](../drugs/nivolumab.md) phase 2 trial [PMID:38653864](../papers/38653864.md)
- [Glioblastoma (GB)](../cancer_types/GB.md) — MLH1 is part of the mismatch repair pathway whose compromise, in the presence of [MGMT](../genes/MGMT.md) methylation and [temozolomide](../drugs/temozolomide.md) treatment, leads to hypermutation [PMID:18772890](../papers/18772890.md).
- Prostate cancer: deleterious MLH1 alterations enriched in MSI-H/dMMR subset (2.8% of 2,251 patients); rare in TMB-H/MSS tumors [PMID:38949888](../papers/38949888.md)
- Pituitary neuroendocrine tumors: MLH1 mutations with protein loss in aggressive, treatment-refractory corticotroph PitNETs [PMID:38758238](../papers/38758238.md)
- Diffuse pleural mesothelioma: rare hypermutator phenotype associated with MLH1 truncating mutation [PMID:38630790](../papers/38630790.md)

## Co-occurrence and mutual exclusivity

- Co-mutated with [MSH2](../genes/MSH2.md), [MSH6](../genes/MSH6.md), [PMS2](../genes/PMS2.md) in MMR-deficient tumors; individual gene contributions vary by cancer type [PMID:38653864](../papers/38653864.md) [PMID:38949888](../papers/38949888.md)

## Therapeutic relevance

- dMMR/MSI-H status conferred by MLH1 loss predicts response to [nivolumab](../drugs/nivolumab.md) (anti-PD-1) in gynecologic cancers; durable responses observed regardless of whether dMMR was genetic or epigenetic in origin [PMID:38653864](../papers/38653864.md)
- MLH1-deficient treatment-refractory PitNETs may respond to [pembrolizumab](../drugs/pembrolizumab.md); dramatic responses reported in this context [PMID:38758238](../papers/38758238.md)
- MSI-H/dMMR prostate cancer responds to immune checkpoint blockade; MLH1 alterations identify patients most likely to respond [PMID:38949888](../papers/38949888.md)

## Open questions

- Whether epigenetic (hypermethylation-driven) vs. genetic MLH1 loss predicts differential response to specific PD-1 inhibitors remains debated across studies [PMID:38653864](../papers/38653864.md)

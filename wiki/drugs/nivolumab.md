...
- In a pan-cancer ICI cohort (n=1,662), nivolumab was among the anti-PD-1 agents used; high TMB (top 20% within histology) was associated with HR 0.52 (p=1.6×10⁻⁶) for [OS](../cancer_types/OS.md) in a multivariable Cox model adjusting for cancer type, age, and year of ICI start [PMID:30643254](../papers/30643254.md).

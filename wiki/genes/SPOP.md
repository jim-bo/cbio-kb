...
- SPOP mRNA expression correlates positively with [KLF5](../genes/KLF5.md) mRNA in both EOPC and TCGA prostate cancer cohorts (p < 1×10⁻⁴, ρ = 0.19), independently of SPOP mutation status; KLF5 ChIP-seq confirms SPOP as a direct KLF5 transcriptional target [PMID:30537516](../papers/30537516.md).
...
- Single hotspot call in [CSCC](../cancer_types/CSCC.md); classified as requiring additional evidence before formal driver nomination in the UCSF CSCC meta-analysis [PMID:34272401](../papers/34272401.md)

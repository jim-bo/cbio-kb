...
- 161 putative driver genes spanning 11 recurrently altered pathways; 28% of [HCC](../cancer_types/HCC.md) harbored at least one alteration potentially targetable by an FDA-approved drug; 86% by a drug in phase I–III trials. [PMID:25822088](../papers/25822088.md)
- Etiology-specific mutation enrichments: alcohol-related [HCC](../cancer_types/HCC.md) enriched for [CTNNB1](../genes/CTNNB1.md), [TERT](../genes/TERT.md), [CDKN2A](../genes/CDKN2A.md), [SMARCA2](../genes/SMARCA2.md), [HGF](../genes/HGF.md); HBV-related HCC enriched for [TP53](../genes/TP53.md) mutation. [PMID:25822088](../papers/25822088.md)

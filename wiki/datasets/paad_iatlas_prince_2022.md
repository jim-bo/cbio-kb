...
- Pre-treatment circulating T cell diversity (especially CD4 subsets) correlated with survival for nivo/chemo, while cross-presenting dendritic cells plus circulating/tumor CD4 T cell activity correlated with survival for sotiga/chemo; the triple-combination arm showed no clear predictive biomarker and signs of possible immune over-activation [PMID:35662283](../papers/35662283.md).

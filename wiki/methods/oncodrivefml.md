...
- OncodriveFML is particularly useful for detecting tumor suppressor genes with scattered inactivating mutations, and for cancer types with high TMB (e.g., UV-driven CSCC) where statistical background models must account for elevated mutation rates.

...
- Pan-cancer aneuploidy study found [IDH1](../genes/IDH1.md) mutation defines the LGG subgroup that clusters separately from [GBM](../cancer_types/GBM.md) by aneuploidy pattern, characterized by 1p loss and 19q gain; LGG clusters in the neural-lineage arm-level group with GBM and melanoma [PMID:29622463](../papers/29622463.md).
...
- IDH1 defines methylation cluster 1 in LGG (330/351 samples IDH1-mutant); IDH1-driven gliomas show lower [STAT1](../genes/STAT1.md) and reduced CXCL10/immune infiltrate; ATRX- or TP53-mutant LGG tumors have more macrophages and fewer CD8 T-cells (ANOVA P<2e-8) [PMID:29625049](../papers/29625049.md)

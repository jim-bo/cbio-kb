...
- **AML (Acute Myeloid Leukemia):** CBFB–MYH11 (inv16) defines the favorable-risk core-binding-factor AML subtype; mutually exclusive of [NPM1](../genes/NPM1.md), [DNMT3A](../genes/DNMT3A.md), and other transcription-factor mutations [PMID:23634996](../papers/23634996.md)

## Co-occurrence and mutual exclusivity

- Mutually exclusive of [NPM1](../genes/NPM1.md), [DNMT3A](../genes/DNMT3A.md), [PML](../genes/PML.md)–[RARA](../genes/RARA.md), and [RUNX1](../genes/RUNX1.md)–[RUNX1T1](../genes/RUNX1T1.md) as part of the Dendrix++ mutual-exclusivity set A in AML [PMID:23634996](../papers/23634996.md)
...
- The cooperating mutations in CBFB–MYH11 AML beyond [KIT](../genes/KIT.md) mutations (which are known to co-occur) were not individually enumerated in this dataset [PMID:23634996](../papers/23634996.md)

...
targets:
  - PARP1
  - PARP2
drug_class: PARP inhibitor (PARPi, trapping)
...
- High expression of [TRMT10A](../genes/TRMT10A.md) (a BRCA1-recruitment scaffold phosphorylated by [ATM](../genes/ATM.md) at Ser28) is associated with higher [olaparib](../drugs/olaparib.md) IC50 in PCa cell lines, placing TRMT10A-mediated HR upregulation as a resistance mechanism applicable across the PARPi class including talazoparib; [USP10](../genes/USP10.md) inhibition with [spautin-1](../drugs/spautin-1.md) degrades TRMT10A and restores PARPi sensitivity [PMID:41071892](../papers/41071892.md).

## Cancer types (linked)

- [PRAD](../cancer_types/PRAD.md) — mCRPC context for PARP inhibitor class discussion; TRMT10A/USP10 axis identified as resistance determinant.

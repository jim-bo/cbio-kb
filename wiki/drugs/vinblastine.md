...
name: vinblastine
targets: [tubulin]
drug_class: vinca alkaloid / microtubule inhibitor
...
Vinblastine is a vinca alkaloid that inhibits tubulin polymerization, disrupting mitotic spindle assembly and arresting cells in metaphase. It is a component of the MVAC ([methotrexate](../drugs/methotrexate.md), vinblastine, [doxorubicin](../drugs/doxorubicin.md), [cisplatin](../drugs/cisplatin.md)) regimen, one of the standard cisplatin-based neoadjuvant chemotherapy (NAC) backbones used in muscle-invasive bladder cancer ([BLCA](../cancer_types/BLCA.md)).

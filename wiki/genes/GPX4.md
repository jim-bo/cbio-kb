...
GPX4 (Glutathione Peroxidase 4) is the primary intracellular enzyme responsible for neutralizing lipid peroxides, making it the central negative regulator of ferroptosis — an iron-dependent, lipid-peroxidation-driven form of regulated cell death. In hepatocellular carcinoma ([HCC](../cancer_types/HCC.md)), GPX4 is upregulated by cholesterol metabolites (27-hydroxycholesterol), enabling tumor cells to resist sorafenib-induced lipid peroxidation, and is stabilized by the FASN/HIF1α axis via SLC7A11-mediated glutathione supply.
...
- Whether GPX4 expression level predicts [sorafenib](../drugs/sorafenib.md) resistance in HCC patients has not been prospectively validated.
- The relative contribution of the cholesterol/27-OHC pathway vs. the FASN/HIF1α axis to GPX4 upregulation in clinical HCC specimens is unknown.

...
- [MEN1](../genes/MEN1.md) and [DAXX](../genes/DAXX.md)/[ATRX](../genes/ATRX.md) alterations were associated with improved 1-year OS in this metastatic cohort ([MEN1](../genes/MEN1.md): 98% vs 82%, P=.01; DAXX/ATRX: 97% vs 83%, P<.01), contrasting with prior reports in resected disease. [BRAF](../genes/BRAF.md) alterations had significantly worse 1-year OS (75% vs 95%, P<.01). [PMID:30687805](../papers/30687805.md)

...
- Amplified in 45% of [GBM](../cancer_types/GBM.md) cases; also harbors novel missense mutations in the extracellular domain; component of the RTK/RAS/PI3K pathway (altered in 88% of samples) [PMID:18772890](../papers/18772890.md).
- Pathogenic EGFR alterations detected in plasma ctDNA (vs tissue only) were associated with worse prognosis in advanced [NSCLC](../cancer_types/NSCLC.md) [PMID:36357680](../papers/36357680.md).
- EGFR alterations were associated with worse metastasis-free survival in [LUAD](../cancer_types/LUAD.md) (p=0.002) and mutually exclusive with [SMARCA4](../genes/SMARCA4.md), [STK11](../genes/STK11.md), [KEAP1](../genes/KEAP1.md), and [KRAS](../genes/KRAS.md) alterations [PMID:37084736](../papers/37084736.md).
- Adrenal gland metastases in [LUAD](../cancer_types/LUAD.md) had the highest proportion of EGFR activating mutations (133/202, 66%) [PMID:37084736](../papers/37084736.md).
- TP53/EGFR co-alteration with [KEAP1](../genes/KEAP1.md) (q<0.001) and [STK11](../genes/STK11.md) (q<0.001) was significant only in ever-metastatic [LUAD](../cancer_types/LUAD.md) primaries [PMID:37084736](../papers/37084736.md).
...
- EGFR exon 19 deletions (N=8), L858R (N=1), and G719C/L861Q (N=1) identified in patients who subsequently acquired [BRAF](../genes/BRAF.md) fusions as a resistance mechanism to EGFR TKIs; [BRAF](../genes/BRAF.md) fusions are a recurrent (2–4%) acquired resistance event after EGFR-directed therapy [PMID:38922339](../papers/38922339.md).
...
- EGFR targeted by cetuximab/panitumumab combination therapy in CRC; EGFR mutations detected at resistance to KRASG12C inhibition in some patients [PMID:36355783](../papers/36355783.md)
...
- [GBM](../cancer_types/GBM.md) — amplified in 45% of cases; key component of the RTK/RAS/PI3K pathway [PMID:18772890](../papers/18772890.md).
- [LUAD](../cancer_types/LUAD.md) / [LUSC](../cancer_types/LUSC.md) — prognostic via ctDNA detection and organotropism; worse [MFS](../cancer_types/MFS.md) [PMID:36357680](../papers/36357680.md) [PMID:37084736](../papers/37084736.md).
- [NSCLC](../cancer_types/NSCLC.md) — non-canonical drivers enriched in leptomeningeal disease [PMID:37591896](../papers/37591896.md); acquired resistance mutations (T790M, C797S, and others) detected in CSF ctDNA from patients with CNS metastases [PMID:39289779](../papers/39289779.md); [BRAF](../genes/BRAF.md) fusions as acquired resistance [PMID:38922339](../papers/38922339.md).
...
- [CHDM](../cancer_types/CHDM.md) — EGFR/ERBB2 pathway enriched by KEGG analysis; TAK-285 (EGFR/ERBB2 kinase inhibitor) preferentially active in chordoma PDTOs vs pan-sarcoma (p=0.034) [PMID:39305899](../papers/39305899.md).

## Co-occurrence and mutual exclusivity

- Mutually exclusive with [SMARCA4](../genes/SMARCA4.md), [STK11](../genes/STK11.md), [KEAP1](../genes/KEAP1.md), [KRAS](../genes/KRAS.md) in [LUAD](../cancer_types/LUAD.md) [PMID:37084736](../papers/37084736.md).
- Co-altered with [TP53](../genes/TP53.md) in ever-metastatic [LUAD](../cancer_types/LUAD.md), further combined with KEAP1/STK11 [PMID:37084736](../papers/37084736.md).
...
- Whether non-canonical EGFR drivers cause leptomeningeal tropism or merely reflect [osimertinib](../drugs/osimertinib.md) partial resistance is unresolved [PMID:37591896](../papers/37591896.md).
- Whether ctDNA-only subclonal resistance alterations should directly alter EGFR-directed treatment selection [PMID:36357680](../papers/36357680.md).

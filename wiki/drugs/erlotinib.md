...
name: erlotinib
targets: [EGFR]
drug_class: 1st-generation EGFR TKI
canonical_source: 
unverified: true
...
First-generation reversible [EGFR](../genes/EGFR.md) tyrosine kinase inhibitor.
...
- Failed as a frontline HCC agent in comparison vs [sorafenib](../drugs/sorafenib.md): median OS 8.0–8.8 months vs 9.9–10.0 months for sorafenib (HR ~1.12–1.15) [PMID:30061739](../papers/30061739.md)
...
- Non-canonical [EGFR](../genes/EGFR.md) drivers (L861Q, G719A/S, A755G, N771_H773dup) persist despite TKI exposure and associate with leptomeningeal tropism [PMID:37591896](../papers/37591896.md).

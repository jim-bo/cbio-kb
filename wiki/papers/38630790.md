...
- **[SETDB1](../genes/SETDB1.md) mutations:** Present in 8/10 GNH cases and 0 non-GNH cases (q=0.0035); validated in the 105-patient cohort where all 4 GNH cases harbored [SETDB1](../genes/SETDB1.md) mutations. SETDB1 mutations were subclonal relative to [TP53](../genes/TP53.md) mutations based on variant allele fractions.

...
Endometrial stromal sarcoma (ESS) is a rare uterine mesenchymal malignancy arising from the stromal cells of the endometrium. In OncoTree, ESS sits under [Uterine Sarcoma (USARC)](../cancer_types/USARC.md) and serves as the parent node for two molecularly and clinically distinct subtypes: [High-Grade Endometrial Stromal Sarcoma (HGESS)](../cancer_types/HGESS.md) and [Low-Grade Endometrial Stromal Sarcoma (LGESS)](../cancer_types/LGESS.md). ESS is defined histologically by infiltrative growth of cells resembling normal proliferative-phase endometrial stroma, and is distinguished from the more aggressive undifferentiated uterine sarcoma by retained stromal morphology.

## Cohorts in the corpus

- [usarc_msk_2020](../datasets/usarc_msk_2020.md) — prospective MSK-IMPACT sequencing of 107 uterine sarcoma patients at MSKCC; includes n=4 [LGESS](../cancer_types/LGESS.md) and n=7 [HGESS](../cancer_types/HGESS.md) (within the high-grade non-LMS subgroup of n=22). [PMID:32299819](../papers/32299819.md)

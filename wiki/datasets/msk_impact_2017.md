...
- da Silva et al. used three previously published [MBC](../cancer_types/MBC.md) cases from msk_impact_2017 as part of a 60-sample study of [TERT](../genes/TERT.md) promoter mutations and gene amplification in metaplastic breast cancer; [TERT](../genes/TERT.md) alterations were found in 17% (10/60) of MBCs and were mutually exclusive with [TP53](../genes/TP53.md) mutations (p<0.001) [PMID:33863915](../papers/33863915.md)
...
- Pan-cancer [PIK3R1](../genes/PIK3R1.md) driver alteration frequencies across 15 solid tumor types; most frequent in endometrial cancer (~25%); MSK-IMPACT prostate sub-cohort used to assess FDG-PET avidity linked to [PIK3R1](../genes/PIK3R1.md) alterations [PMID:35670774](../papers/35670774.md)
- Used as the propensity-score-matched Western comparator (n=2,820 per arm after PSM across 15 tumor types, 266 shared genes) in the [pan_origimed_2020](../datasets/pan_origimed_2020.md) pan-cancer landscape study; only 12 tumor-type:gene pairs differed significantly (FDR<0.05), with the largest differences in [LUAD](../cancer_types/LUAD.md) [EGFR](../genes/EGFR.md) enrichment and [KEAP1](../genes/KEAP1.md) depletion in the Chinese cohort [PMID:35871175](../papers/35871175.md)

...
- [PMID:30742119](../papers/30742119.md) — Zhao et al. 2019, *Nature Medicine*: [PTEN](../genes/PTEN.md) mutations and MAPK alterations predict anti-PD-1 response in recurrent [GBM](../cancer_types/GBM.md); TCGA IDH1-wildtype GBM used as background reference cohort.

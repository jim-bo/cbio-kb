...
canonical_source: 
unverified: 
assays: [spatial-transcriptomics, targeted-panel]
panels: []
tags: [pdac, kras-alleles, surgical-resection, spatial-transcriptomics]
...
- [PMID:39214094](../papers/39214094.md) — McIntyre et al., Cancer Cell 2024. [KRAS](../genes/KRAS.md)^G12R^ enrichment in early-stage PDAC with distinct clinical outcomes and NF-κB-biased transcriptional program.

## Notable findings derived from this cohort

- [KRAS](../genes/KRAS.md) altered in 90%, [TP53](../genes/TP53.md) 71%, [CDKN2A](../genes/CDKN2A.md) 24%, [SMAD4](../genes/SMAD4.md) 17%; [KRAS](../genes/KRAS.md) allele distribution G12D 36.5% / G12V 32.5% / G12R 13.9% / other 8.1% / WT 9.1% [PMID:39214094](../papers/39214094.md).
- KRAS^G12R^ enriched in stage I disease (23% vs 11%), more often node-negative (47% vs 26% for G12D), and associated with improved [OS](../cancer_types/OS.md) and reduced distant recurrence [PMID:39214094](../papers/39214094.md).

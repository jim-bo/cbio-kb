...
PPARA (peroxisome proliferator-activated receptor alpha) encodes a nuclear receptor transcription factor that is a master regulator of fatty acid oxidation (FAO) in the liver. In [HCC](../cancer_types/HCC.md), PPARα activity is strongly linked to the Wnt/beta-catenin subtype of tumors, which exhibit FAO addiction. PPARα-driven FAO defines a therapeutically relevant subset of HCC patients who may benefit from FAO pathway inhibition strategies.
...
- Whether PPARα agonists or antagonists are net pro- or anti-tumorigenic in HCC is context-dependent (subtype and upstream Wnt/beta-catenin status); clinical validation of FAO-addiction stratification is pending.

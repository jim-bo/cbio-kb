...
- VIPER-style regulon analysis applied to 23 candidate transcription factor regulators in 408 [BLCA](../cancer_types/BLCA.md) RNA-seq samples; identified [GATA3](../genes/GATA3.md), [FOXA1](../genes/FOXA1.md), [PPARG](../genes/PPARG.md) as luminal drivers and [TP63](../genes/TP63.md), [EGFR](../genes/EGFR.md) as basal-squamous discriminators; validated in independent Sjödahl 308-sample cohort [PMID:28988769](../papers/28988769.md)

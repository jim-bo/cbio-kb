...
CREBBP encodes a histone acetyltransferase and transcriptional coactivator. In the cbio-kb corpus it appears as a relapse-associated epigenetic regulator in MLL-rearranged acute lymphoblastic leukemia [PMID:25730765](../papers/25730765.md).

## Alterations observed in the corpus

- Point mutations identified in relapse samples of infant MLL-rearranged ALL, consistent with a role in treatment resistance [PMID:25730765](../papers/25730765.md).
- Mutations in epigenetic regulators including CREBBP were frequent (45%) in older children with MLL-R leukemia but rare in infants [PMID:25730765](../papers/25730765.md).
...
- Mutated in [SCLC](../cancer_types/SCLC.md) WES/WGS study (CLCGP, 29 tumors) [PMID:22941188](../papers/22941188.md)
...
- CREBBP was identified in the Pan-Lung analysis as part of the EP300/CREBBP HAT-domain hotspot region (additional significantly mutated gene); CREBBP focal deletions were found in lung SqCC [PMID:27158780](../papers/27158780.md).
- CREBBP — chromatin modifier enriched among unmet medical need (UMD) LUAD patients, particularly in never/former-light smokers; co-occurs with KMT2D, KMT2C, and SETD2 as a cluster of epigenetic alterations in this subset [PMID:28336552](../papers/28336552.md)
...
- [BLLKMT2A](../cancer_types/BLLKMT2A.md): CREBBP mutations observed at relapse in infant MLL-R ALL [PMID:25730765](../papers/25730765.md).
- [MNG](../cancer_types/MNG.md): Subthreshold recurrent inactivating mutations enriched in MG3/MG4 meningioma groups; may contribute to epigenetic dysregulation driving aggressive behavior [PMID:34433969](../papers/34433969.md).
- [PAAD](../cancer_types/PAAD.md): CREBBP alterations specific to the other-MAPK-mutant PDAC subtype (P = 1.3 × 10⁻⁵ vs KRAS-mutant) in the 2,336-patient [pdac_msk_2024](../datasets/pdac_msk_2024.md) cohort [PMID:39753968](../papers/39753968.md).
...
- Whether CREBBP relapse mutations are selected by therapy or pre-existing sub-clones [PMID:25730765](../papers/25730765.md).

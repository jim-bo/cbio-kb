...
- SDHB germline mutations co-occur with somatic [ATRX](../genes/ATRX.md) mutations in 3 tumors; [ATRX](../genes/ATRX.md) co-mutation marks alternative lengthening of telomeres and aggressive disease. [PMID:28162975](../papers/28162975.md)
- SDHB germline status associates with the hypermethylated DNA methylation subtype and with worse aggressive-disease-free survival (ADFS) and metastatic-free survival ([MFS](../cancer_types/MFS.md)). [PMID:28162975](../papers/28162975.md)
- Germline pathogenic variants present in all 79 pheochromocytoma/paraganglioma patients in this cohort (41 missense, 21 nonsense, 6 frameshift, 7 large deletions, 4 donor splice-site); every tumor showed somatic 1p36.13 LOH, SDHB-IHC deficiency, and clustered as hypermethylated C1A (SDHx) subtype. [PMID:40097403](../papers/40097403.md)
...
- ATRX-loss tumors (enriched in SDHB-germline cases) may be sensitive to [ATR](../genes/ATR.md) inhibitors (hypothesis only, not tested). [PMID:28162975](../papers/28162975.md)

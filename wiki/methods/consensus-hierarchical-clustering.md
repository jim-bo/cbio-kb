...
- Used to define three [ILC](../cancer_types/ILC.md) transcriptional subtypes (reactive-like, immune-related, proliferative) from 1,277 SAM-differentiating genes (q=0) in n=106 LumA ILC, with survival differences validated in METABRIC [PMID:26451490](../papers/26451490.md)

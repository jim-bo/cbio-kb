...
- Amplification in 17% of RT-[OS](../cancer_types/OS.md) vs 7% of sporadic [OS](../cancer_types/OS.md); enriched in the radiation-associated setting [PMID:37350195](../papers/37350195.md).
- FGFR1 is a driver event in a subset of fusion-negative rhabdomyosarcoma (FN-RMS) alongside [NF1](../genes/NF1.md) [PMID:37730754](../papers/37730754.md).
...
- MAPK-pathway alteration (with [FGFR2](../genes/FGFR2.md), [BRAF](../genes/BRAF.md), [NF1](../genes/NF1.md), NTRK1/2) enriched in PA-like [LGG](../cancer_types/LGG.md) (52%) and LGm6-GBM (32%) in a pan-glioma TCGA methylation/genomic study (n=1122); FGFR1 alterations associated with pilocytic-astrocytoma-like IDH-wildtype LGG subtype with favorable prognosis [PMID:26824661](../papers/26824661.md)
...
- Recurrent focal amplification in [ESCC](../cancer_types/ESCC.md) (alongside [TERT](../genes/TERT.md), [MDM2](../genes/MDM2.md), [NKX2-1](../genes/NKX2-1.md)) in the TCGA esophageal carcinoma multi-platform characterization [PMID:28052061](../papers/28052061.md).
- Somatic mutation identified in pheochromocytoma/paraganglioma (PCC/PGL) by cancer-relevant gene scan in the TCGA [PCPG](../cancer_types/PCPG.md) multi-platform study; grouped in the kinase signaling pathway axis alongside NF1, [HRAS](../genes/HRAS.md), [RET](../genes/RET.md), BRAF, and [NGFR](../genes/NGFR.md) [PMID:28162975](../papers/28162975.md).
...
- Focal 8p12 amplification with [ZNF703](../genes/ZNF703.md) defines IntClust6 (5.5% of ER+ breast cancer); 100% of IntClust6 cases carry this amplification vs 2-21% of other IntClust groups; identified as a targetable copy-number driver in late-recurring ER+/HER2- disease [PMID:30867590](../papers/30867590.md)
...
- FGFR1 alterations are among the oncogenic drivers whose phospho-SHP2 ([PTPN11](../genes/PTPN11.md) pY542) level explains [ponatinib](../drugs/ponatinib.md) sensitivity in AML/CML cell lines in the expanded CCLE multi-omic dataset [PMID:31068700](../papers/31068700.md)
- Cited as an established endocrine-therapy resistance mechanism in ER+/HER2- metastatic breast cancer; trial context for [buparlisib](../drugs/buparlisib.md) + [letrozole](../drugs/letrozole.md) in endocrine-refractory disease [PMID:31552290](../papers/31552290.md)
...
- Copy-number gains in 4/18 (22.2%) sensitive and 4/41 (9.8%) resistant HR+/HER2- [MBC](../cancer_types/MBC.md) biopsies — not enriched in CDK4/6i resistance [PMID:32404308](../papers/32404308.md)
- One arm B (anti-AR + CDK4/6 inhibitor) TNBC patient with FGFR1 amplification responded to [anlotinib](../drugs/anlotinib.md) after progression on anti-AR + anti-CDK4/6 therapy in a biomarker-guided umbrella trial for metastatic TNBC. [PMID:32719455](../papers/32719455.md)
- Co-amplified in the 8p11.23 amplicon with [NSD3](../genes/NSD3.md) in LSCC; proteomic data argues against FGFR1 as the primary oncogene in this amplicon, consistent with the historical failure of FGFR1-targeted therapy in LSCC [PMID:34358469](../papers/34358469.md)
...
- FGFR1/2/3/4 together accounted for 27 events across HGG, rhabdomyosarcoma, and other sarcomas in the MAPPYACTS pediatric WES cohort (n=787 relapsed/refractory patients). [PMID:35292802](../papers/35292802.md)
...
- FGFR1 mutations were identified as clonal alterations shared between the [LUAD](../cancer_types/LUAD.md) and [SCLC](../cancer_types/SCLC.md) components of an admixed SCLC/adenocarcinoma tumor (MSK773) in an MSK SCLC PDX/CDX biobank study. [PMID:35440124](../papers/35440124.md)

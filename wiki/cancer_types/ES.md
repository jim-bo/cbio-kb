...
- WGS of 112 Ewing sarcoma tumors (extended to 299 patients) identified STAG2 (17%), [CDKN2A](../genes/CDKN2A.md) deletion (12%), [TP53](../genes/TP53.md) (7%), and epigenetic regulators EZH2/BCOR/ZMYM3 (2.7% each) as recurrently mutated; STAG2+TP53 co-mutation defined a high-risk subtype with markedly inferior survival [PMID:25223734](../papers/25223734.md)
...
- [EWSR1](../genes/EWSR1.md)::[BEND2](../genes/BEND2.md) in-frame fusion sarcoma of the bladder initially diagnosed as extraskeletal Ewing sarcoma based on [CD99](../genes/CD99.md) positivity and EWSR1 FISH; RNA-seq identified BEND2 (not an ETS family gene) as partner — reclassifying to EWSR1-non-ETS undifferentiated sarcoma per WHO 2020 [PMID:28199314](../papers/28199314.md)
...
- Ewing sarcoma (ES) was enrolled in the MAPPYACTS trial (sarcomas 37% of 787 patients); EWSR1 fusions were covered in the sarcoma oncomap; 17% ORR with matched therapy (38% for ready-for-routine-use alterations) [PMID:35292802](../papers/35292802.md)

...
- Pan-NSCLC WES of 660 [LUAD](../cancer_types/LUAD.md) and 484 LUSC tumour/normal pairs ([nsclc_tcga_broad_2016](../datasets/nsclc_tcga_broad_2016.md)); LUSC had median somatic mutation rate 9.7/Mb and 20 SMGs; novel LUSC driver [RASA1](../genes/RASA1.md); TP53, CDKN2A, and [PIK3CA](../genes/PIK3CA.md) were significantly more frequently mutated in LUSC than LUAD (p<0.01); LUSC genetic landscape more closely resembled [HNSC](../cancer_types/HNSC.md) and [BLCA](../cancer_types/BLCA.md) than LUAD; 53% of LUSCs had ≥5 predicted neoepitopes [PMID:27158780](../papers/27158780.md)
...
- Pan-cancer fusion study (9,624 TCGA samples) identified [FGFR3](../genes/FGFR3.md)–[TACC3](../genes/TACC3.md) in 1.2% of LUSC samples; FGFR3 is a druggable target across 15 cancer types [PMID:29617662](../papers/29617662.md)
...
- CPTAC proteogenomic study of 108 treatment-naive LUSC tumors identified five NMF subtypes (Basal-Inclusive, EMT-Enriched, Classical, Inflamed-Secretory, Proliferative-Primitive); [NSD3](../genes/NSD3.md) proteomically nominated over [FGFR1](../genes/FGFR1.md) as the 8p11.23 amplicon driver; CDK4/6-pathway loss (CDKN2A or [RB1](../genes/RB1.md)) was universal; TP63-low tumors overexpressed survivin ([BIRC5](../genes/BIRC5.md)); dataset [lusc_cptac_2021](../datasets/lusc_cptac_2021.md) [PMID:34358469](../papers/34358469.md)
- Wu et al. pan-cancer Asian cohort ([pan_origimed_2020](../datasets/pan_origimed_2020.md), n=10,194): LUSC included within the NSCLC umbrella (20% of cohort); TP53 (58% pan-cohort) and PIK3CA (11%) dominant across lung squamous histology; 11q13.3 amplification relevant to squamous subtypes [PMID:35871175](../papers/35871175.md)

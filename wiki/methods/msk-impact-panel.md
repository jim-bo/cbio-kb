...
- MC3 capture-kit mask excluded 170 CDS-altering calls in MSK-IMPACT's 410-gene panel that fall outside the Broad capture BED, including [TERT](../genes/TERT.md) promoter hits, [CIC](../genes/CIC.md) truncations, and [CRLF2](../genes/CRLF2.md) splice alterations [PMID:29596782](../papers/29596782.md)
...
- MSK-IMPACT 468-gene panel ([IMPACT468](../methods/IMPACT468.md)) applied at ~500-fold coverage to 22 patient-derived bladder cancer organoid lines and matched parental tumors; enables subclonal variant detection and includes [TERT](../genes/TERT.md) promoter capture [PMID:29625057](../papers/29625057.md).
- Used to sequence 195 cholangiocarcinoma patients in the [chol_msk_2018](../datasets/chol_msk_2018.md) cohort; 20 patients sequenced with 341-gene panel ([IMPACT341](../methods/IMPACT341.md)) and 175 with 410-gene panel ([IMPACT410](../methods/IMPACT410.md)); median coverage 759×; 47.6% of patients had actionable alterations at OncoKB level 3B or higher [PMID:29848569](../papers/29848569.md)
...
- MSK-IMPACT targeted NGS (341-, 410-, or 468-gene panel) applied to 42 PDX/CDX and 26 clinical [SCLC](../cancer_types/SCLC.md) samples; [TP53](../genes/TP53.md) alterations in 92% of clinical and 90% of PDX samples; [RB1](../genes/RB1.md) alterations in 81% of clinical and 76% of PDX samples [PMID:35440124](../papers/35440124.md).
...
- Primary sequencing assay in [lgsoc_mapk_msk_2022](../datasets/lgsoc_mapk_msk_2022.md): 119 LGSC patients sequenced at four panel versions (IMPACT341/410/468/505) at median 588× depth; identified MAPK pathway alterations in 60% and all 12 pathogenic germline mutations [PMID:35443055](../papers/35443055.md)
- Used for orthogonal validation in [mixed_kunga_msk_2022](../datasets/mixed_kunga_msk_2022.md): MSK-IMPACT (468-gene panel) applied to 114 pediatric/AYA solid tumor patients; cWGTS recovered 174/221 (79%) MSK-IMPACT-called somatic mutations (discordant calls attributed to intratumor heterogeneity) [PMID:35585047](../papers/35585047.md)

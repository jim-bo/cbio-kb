...
- Acquired early in IGHV-mutated CLL but late in IGHV-unmutated CLL by [PhylogicNDT](../methods/phylogicndt.md) temporal ordering (q<0.1) in the 1,148-patient CLL map [PMID:35927489](../papers/35927489.md).
- V600E mutations in ~33% of histiocytosis patients profiled in the Make-an-IMPACT direct-to-patient program; BRAF fusions identified including MS4A6A-BRAF, DOCK8-BRAF, and HLA-A-BRAF partners [PMID:36862133](../papers/36862133.md).
- One histiocytosis case carried co-occurring [KRAS](../genes/KRAS.md) G12D and BRAF D594H [PMID:36862133](../papers/36862133.md).
- BRAF alterations were positively associated with [SETD2](../genes/SETD2.md) driver mutations in [LUAD](../cancer_types/LUAD.md) (q<0.05) in the MSK-CHORD cohort [PMID:39506116](../papers/39506116.md).
- BRAF p.V600E was detected in CSF ctDNA from metastatic melanoma patients; BRAF fusions (including [KIAA1549](../genes/KIAA1549.md)::BRAF) were detected in glioma CSF samples; BRAF fusions also appeared as off-target resistance alterations in [EGFR](../genes/EGFR.md)-mutant lung cancer CSF ctDNA in the [csf_msk_2024](../datasets/csf_msk_2024.md) cohort (1,007 CSF samples, 711 patients) [PMID:39289779](../papers/39289779.md).
- BRAF V600E in 21.3% of anaplastic thyroid carcinoma (ATC) vs. 50.9% of papillary thyroid cancer (PTC); clonal/early subclonal timing; mutually exclusive with RAS mutations (multi-omic landscape study, n=87 specimens) [PMID:38412093](../papers/38412093.md).
- BRAF oncogenic fusions across 52 histologies (241 fusion-positive tumors from 212 patients); 82 unique 5' partners including [KIAA1549](../genes/KIAA1549.md) (25%), [SND1](../genes/SND1.md) (10%), [AGK](../genes/AGK.md) (6%); de novo prevalence <1% in 69,337 patients; dominant in pilocytic astrocytoma (56% prevalence) [PMID:38922339](../papers/38922339.md).
...
- Identified as somatically mutated in TCGA integrated genomic analysis of high-grade serous ovarian carcinoma ([HGSOC](../cancer_types/HGSOC.md)) [PMID:21720365](../papers/21720365.md)
...
- Mutation in ~2% of high-grade bladder cancers; cited as a validated drug target (analogous to melanoma) within the mutually exclusive MAPK-pathway alteration set (35% combined) [PMID:23897969](../papers/23897969.md)
...
- V600E found in 2 atypical sinonasal glands arising in seromucinous hamartoma (ASGSH precursor lesions); these precursor mutations were distinct from mutations in the matched AdCC components [PMID:39760648](../papers/39760648.md)
...
- RAS/RAF/MAPK pathway component; BRAF mutations <5% in [HCC](../cancer_types/HCC.md) but the pathway is universally activated in advanced [HCC](../cancer_types/HCC.md); cited as resistance analogy (BRAF-mutant melanoma/vemurafenib) motivating combination regimens [PMID:25369299](../papers/25369299.md)
- Listed among somatic alterations in the [HCC](../cancer_types/HCC.md) molecular landscape (WES, n=1,289); part of the RAF kinase pathway surveyed in the review [PMID:30061739](../papers/30061739.md)
...
- V600E in 3–7% of intrahepatic CCA and near 0% in extrahepatic CCA; actionable with [dabrafenib](../drugs/dabrafenib.md) + [trametinib](../drugs/trametinib.md) (ROAR phase II ORR ~47% in 43 CCA patients) [PMID:41008893](../papers/41008893.md)
...
- MAPK-pathway alteration enriched in PA-like IDH-wildtype [LGG](../cancer_types/LGG.md) (52%) and LGm6-GBM (32%) in a 1,122-tumour TCGA pan-glioma cohort; BRAF alterations nominate candidate targeted therapies for this favourable-prognosis IDH-wildtype [LGG](../cancer_types/LGG.md) subset [PMID:26824661](../papers/26824661.md)
...
- BRAF: lower frequency in young lung cancer compared to older patients; [MET](../genes/MET.md) exon 14 skipping also age-skewed [PMID:40958859](../papers/40958859.md)
...
- BRAF altered in 8% of metastatic panNET (80-patient MSK-IMPACT cohort); V600E plus non-V600 variants (K601E, T599K, T310I, G596D+E451K compound); enriched in post-treatment samples; significantly worse 1-year [OS](../cancer_types/OS.md) (75% vs 95%, P<.01); paired patient on [vemurafenib](../drugs/vemurafenib.md) acquired [NRAS](../genes/NRAS.md) Q61R at progression [PMID:30687805](../papers/30687805.md)
...
- BRAF mutations enriched in MSI-H/hypermutated colon tumors in proteogenomic cohort (n=110); classic colorectal cancer SMG alongside [KRAS](../genes/KRAS.md) and [POLE](../genes/POLE.md) [PMID:31031003](../papers/31031003.md)
...
- Targetable driver mutations and amplifications recurrent in [NSCLC](../cancer_types/NSCLC.md) detected by MSK-ACCESS; BRAF included in 10-gene orthogonal-truth cohort for MSK-ACCESS analytical validation [PMID:34145282](../papers/34145282.md)
...
- Within histiocytosis, BRAF alterations are part of a mutually informative kinase-driver set with [MAP2K1](../genes/MAP2K1.md), [KRAS](../genes/KRAS.md), [NRAS](../genes/NRAS.md), [CSF1R](../genes/CSF1R.md), [ALK](../genes/ALK.md), and [NTRK1](../genes/NTRK1.md) [PMID:36862133](../papers/36862133.md).

## Therapeutic relevance

- Eight histiocytosis patients with BRAF alterations were treated with [vemurafenib](../drugs/vemurafenib.md) or [dabrafenib](../drugs/dabrafenib.md) through the Make-an-IMPACT program, contributing to the 17/18 (94%) clinical benefit rate observed with matched targeted therapy [PMID:36862133](../papers/36862133.md).

## Open questions

- Why BRAF acquisition timing flips between M-CLL (early) and U-CLL (late) is not mechanistically resolved [PMID:35927489](../papers/35927489.md).

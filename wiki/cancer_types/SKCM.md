...
- Riaz et al. profiled paired pre- and on-therapy biopsies from 68 advanced melanoma patients on anti-PD-1 ([nivolumab](../drugs/nivolumab.md), CA209-038 trial), demonstrating that pre-therapy TMB predicts OS in ipilimumab-naive but not ipilimumab-progressed patients, and that genomic contraction (selective depletion of neoantigenic clones on-therapy) in responders provides evidence of immunoediting under PD-1 blockade [PMID:29033130](../papers/29033130.md)
